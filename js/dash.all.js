    ...
    if (window.DOMParser) {
      ...
      try {
        (b = c.parseFromString(a, "text/xml")),
          d &&
            b.getElementsByTagNameNS(d, "parsererror").length &&
            (b = void 0);
      } catch (e) {}
    } else
...
function ObjectIron(a) {
  var b;
  for (b = [], i = 0, len = a.length; i < len; i += 1)
...
(ISOBox.parse = function (a) {
    ...
    switch (a) {
      ...
      case 24:
        var c = this._raw.getUint16(this._cursor.offset - this._raw.byteOffset),
          d = this._raw.getUint8(
            this._cursor.offset - this._raw.byteOffset + 2
          );
        b = (c << 8) + d;
        break;
      case 32:
      ...
      case 64:
        var c = this._raw.getUint32(this._cursor.offset - this._raw.byteOffset),
          d = this._raw.getUint32(
            this._cursor.offset - this._raw.byteOffset + 4
          );
        b = c * Math.pow(2, 32) + d;
    }
    return (this._cursor.offset += a >> 3), b;
  ...
  (ISOBox.prototype._parseBox = function () {
    ...
    switch (
      ...
      1 == this.size && (this.largesize = this._readUint(64)),
      "uuid" == this.type && (this.usertype = this._readString(16)),
      this.size)
    ) {
      case 0:
        this._raw = new DataView(
          this._raw.buffer,
          this._offset,
          this._raw.byteLength - this._cursor.offset
        );
        break;
      case 1:
  ...
  (ISOBox.prototype._boxParsers.emsg = function () {
    this._parseFullBox(),
      ...
      (this.message_data = new DataView(
        this._raw.buffer,
        this._cursor.offset,
        this._raw.byteLength - (this._cursor.offset - this._offset)
      ));
  }),
  (ISOBox.prototype._boxParsers.free = ISOBox.prototype._boxParsers.skip =
    function () {
  ...
  (ISOBox.prototype._boxParsers.ftyp = ISOBox.prototype._boxParsers.styp =
    function () {
      for (
  ...
  (ISOBox.prototype._boxParsers.sidx = function () {
    ...
    for (var a = 0; a < this.reference_count; a++) {
      var b = {},
        c = this._readUint(32);
      (b.reference_type = (c >> 31) & 1),
        (b.referenced_size = 2147483647 & c),
        (b.subsegment_duration = this._readUint(32));
      var d = this._readUint(32);
      (b.starts_with_SAP = (d >> 31) & 1),
        (b.SAP_type = (d >> 28) & 7),
        (b.SAP_delta_time = 268435455 & d),
  ...
  (ISOBox.prototype._boxParsers.ssix = function () {
    ...
    for (var a = 0; a < this.subsegment_count; a++) {
      ...
      for (var c = 0; c < b.ranges_count; c++) {
        var d = {};
        (d.level = this._readUint(8)),
          (d.range_size = this._readUint(24)),
          b.ranges.push(d);
      }
  ...
  (ISOBox.prototype._boxParsers.tfdt = function () {
    this._parseFullBox(),
      (this.baseMediaDecodeTime = this._readUint(1 == this.version ? 64 : 32));
  }),
  (ISOBox.prototype._boxParsers.tfhd = function () {
    this._parseFullBox(),
      (this.track_ID = this._readUint(32)),
      1 & this.flags && (this.base_data_offset = this._readUint(64)),
      2 & this.flags && (this.sample_description_offset = this._readUint(32)),
      8 & this.flags && (this.default_sample_duration = this._readUint(32)),
      16 & this.flags && (this.default_sample_size = this._readUint(32)),
      32 & this.flags && (this.default_sample_flags = this._readUint(32));
  }),
  (ISOBox.prototype._boxParsers.trun = function () {
    this._parseFullBox(),
      (this.sample_count = this._readUint(32)),
      1 & this.flags && (this.data_offset = this._readInt(32)),
      4 & this.flags && (this.first_sample_flags = this._readUint(32)),
      (this.samples = []);
    for (var a = 0; a < this.sample_count; a++) {
      var b = {};
      256 & this.flags && (b.sample_duration = this._readUint(32)),
        512 & this.flags && (b.sample_size = this._readUint(32)),
        1024 & this.flags && (b.sample_flags = this._readUint(32)),
        2048 & this.flags &&
          (b.sample_composition_time_offset =
            0 == this.version ? this._readUint(32) : this._readInt(32)),
        this.samples.push(b);
    }
  });
var ISOBoxer = ISOBoxer || {};
(ISOBoxer.parseBuffer = function (a) {
  ...
  (ISOBoxer.Utils = {}),
  (ISOBoxer.Utils.dataViewToString = function (a, b) {
    if ("undefined" != typeof TextDecoder)
      return new TextDecoder(b || "utf-8").decode(a);
    for (var c = "", d = 0; d < a.byteLength; d++)
      c += String.fromCharCode(a.getUint8(d));
    return c;
  }),
...
(ISOFile.prototype.fetch = function (a) {
  ...
  (MediaPlayer = function (a) {
    ...
    var b,
      ...
      w = !1,
      x = !0,
      y = MediaPlayer.dependencies.BufferController.BUFFER_SIZE_REQUIRED,
      z = !0,
      A = [],
      B = 4,
      C = !1,
      ...
      E = function () {
        ...
        (u = !0),
          ...
          i.subscribe(
            MediaPlayer.dependencies.PlaybackController.eventList
              .ENAME_PLAYBACK_ERROR,
            g
          ),
          i.subscribe(
            MediaPlayer.dependencies.PlaybackController.eventList
              .ENAME_PLAYBACK_STARTED,
            g
          ),
          i.subscribe(
            MediaPlayer.dependencies.PlaybackController.eventList
              .ENAME_PLAYBACK_PAUSED,
            g
          ),
          i.setLiveDelayAttributes(B, C),
          b.mapValue("liveDelayFragmentCount", B),
          b.mapOutlet("liveDelayFragmentCount", "trackController"),
          g.initialize(v, q, r),
          n.checkInitialBitrate(),
          "string" == typeof f ? g.load(f) : g.loadWithManifest(f),
          g.setUTCTimingSources(A, z),
          (c = b.getObject("abrController")),
          (c.limitBitrateByPortal = x),
          b.mapValue("scheduleWhilePaused", w),
          b.mapOutlet("scheduleWhilePaused", "stream"),
          b.mapOutlet("scheduleWhilePaused", "scheduleController"),
          b.mapValue("numOfParallelRequestAllowed", p),
          b.mapOutlet("numOfParallelRequestAllowed", "scheduleController"),
          b.mapValue("bufferMax", y),
          b.mapOutlet("bufferMax", "bufferController"),
          h.initialize();
      },
      F = function () {
        D() && E.call(this);
      ...
      G = function () {
        var a =
          k.getReadOnlyMetricsFor("video") || k.getReadOnlyMetricsFor("audio");
        return j.getCurrentDVRInfo(a);
      },
      H = function () {
        var a = G.call(this);
        return a ? a.manifestInfo.DVRWindowSize : NaN;
      },
      I = function (a) {
        var b = G.call(this),
          c = b.range.start + a;
      ...
      L = function () {
        ...
        if (i.getIsDynamic()) {
          var b,
            c = G.call(this);
          if (null === c) return 0;
          (b = c.range.end - c.range.start),
            (a =
              b < c.manifestInfo.DVRWindowSize
                ? b
                : c.manifestInfo.DVRWindowSize);
        }
        return a;
      },
      M = function (a) {
        ...
        return null === d
          ? 0
          : ((b = d.manifestInfo.availableFrom.getTime() / 1e3),
            (c = a + (b + d.range.start)));
      },
      N = function () {
        return M.call(this, this.time());
      },
      O = function () {
        return M.call(this, this.duration());
      },
      P = function (a, b, c) {
        var d = new Date(1e3 * a),
          e = d.toLocaleDateString(b),
          f = d.toLocaleTimeString(b, { hour12: c });
        return f + " " + e;
      },
      Q = function (a) {
        a = Math.max(a, 0);
        ...
        return (
          (0 === b
            ...
            ? "0" + b.toString() + ":"
            : b.toString() + ":") +
          (10 > c ? "0" + c.toString() : c.toString()) +
          ":" +
          (10 > d ? "0" + d.toString() : d.toString())
        );
      },
      R = function (a, b, c) {
        b &&
          void 0 !== a &&
          null !== a &&
          (c ? h.setRules(a, b) : h.addRules(a, b));
      },
      S = function () {
      ...
      T = function () {
        if ((this.adapter.reset(), u && g)) {
          if (!t) {
            ...
            var a = {},
              b = this;
            (a[
              MediaPlayer.dependencies.StreamController.eventList.ENAME_TEARDOWN_COMPLETE
            ] = function () {
              c.reset(),
                h.reset(),
                i.reset(),
        ...
        } else D.call(this) && F.call(this);
      },
      U = dijon.System.prototype.getObject;
    (dijon.System.prototype.getObject = function (a) {
      ...
      b.mapValue("system", b),
      b.mapOutlet("system"),
      b.mapValue("eventBus", new MediaPlayer.utils.EventBus()),
      b.mapOutlet("eventBus");
    var V = new MediaPlayer.utils.Debug();
    return (
      b.mapValue("debug", V),
      b.mapOutlet("debug"),
      b.injectInto(V),
      ...
      b.injectInto(a),
      {
        ...
        setup: function () {
          (j = b.getObject("metricsExt")),
            (c = b.getObject("abrController")),
            (h = b.getObject("rulesController")),
            (k = b.getObject("metricsModel")),
            (n = b.getObject("DOMStorage")),
            (i = b.getObject("playbackController")),
            (d = b.getObject("mediaController")),
        ...
        setMaxAllowedRepresentationRatioFor: function (a, b) {
          c.setMaxAllowedRepresentationRatioFor(a, b);
        },
        getMaxAllowedRepresentationRatioFor: function (a) {
          return c.getMaxAllowedRepresentationRatioFor(a);
        },
        ...
        setLimitBitrateByPortal: function (a) {
          x = a;
        },
        ...
        getTracksForTypeFromManifest: function (a, b, c) {
          return (
            (c = c || this.adapter.getStreamsInfo(b)[0]),
            c ? this.adapter.getAllMediaInfoForType(b, c, a) : []
          );
        },
        ...
        setInitialRepresentationRatioFor: function (a, b) {
          c.setInitialRepresentationRatioFor(a, b);
        },
        getInitialRepresentationRatioFor: function (a) {
          return c.getInitialRepresentationRatioFor(a);
        },
        getAutoSwitchQuality: function () {
          return (
            this.getAutoSwitchQualityFor("video") ||
            this.getAutoSwitchQualityFor("audio")
          );
        },
        setAutoSwitchQuality: function (a) {
          this.setAutoSwitchQualityFor("audio", a),
            this.setAutoSwitchQualityFor("video", a);
        },
        getAutoSwitchQualityFor: function (a) {
          return c.getAutoSwitchBitrate(a);
        },
        setAutoSwitchQualityFor: function (a, b) {
          c.setAutoSwitchBitrate(a, b);
        },
        setSchedulingRules: function (a) {
          R.call(this, h.SCHEDULING_RULE, a, !0);
        },
        addSchedulingRules: function (a) {
          R.call(this, h.SCHEDULING_RULE, a, !1);
        },
        setABRRules: function (a) {
          R.call(this, h.ABR_RULE, a, !0);
        },
        addABRRules: function (a) {
          R.call(this, h.ABR_RULE, a, !1);
        },
        ...
        retrieveManifest: function (a, c) {
          !(function (a) {
            ...
            (f[
              ...
              a.error ? c(null, a.error) : c(a.data.manifest),
                d.unsubscribe(
        ...
        addUTCTimingSource: function (a, b) {
          ...
          (c.schemeIdUri = a), (c.value = b), A.push(c);
        },
        removeUTCTimingSource: function (a, b) {
          A.forEach(function (c, d) {
            c.schemeIdUri === a && c.value === b && A.splice(d, 1);
          });
        },
        ...
        restoreDefaultUTCTimingSources: function () {
          this.addUTCTimingSource(
            MediaPlayer.UTCTimingSources["default"].scheme,
            MediaPlayer.UTCTimingSources["default"].value
          );
        },
        ...
        attachSource: function (a, b, c) {
          ...
          "string" == typeof a
            ? (this.uriQueryFragModel.reset(),
              (f = this.uriQueryFragModel.parseURI(a)))
            : (f = a),
            (q = b),
            (r = c),
            T.call(this);
  ...
  (MediaPlayer.di.Context = function () {
    ...
    var a = function () {
      ...
      MediaPlayer.models.ProtectionModel_21Jan2015.detect(a)
        ? this.system.mapClass(
            "protectionModel",
            MediaPlayer.models.ProtectionModel_21Jan2015
          )
        : MediaPlayer.models.ProtectionModel_3Feb2014.detect(a)
        ? this.system.mapClass(
            "protectionModel",
            MediaPlayer.models.ProtectionModel_3Feb2014
          )
        : MediaPlayer.models.ProtectionModel_01b.detect(a)
        ? this.system.mapClass(
            "protectionModel",
            MediaPlayer.models.ProtectionModel_01b
          )
        : (this.debug.log(
            "No supported version of EME detected on this user agent!"
          ),
    ...
    return {
      ...
      setup: function () {
        (this.system.autoMapOutlets = !0),
          ...
          this.system.mapSingleton(
            "uriQueryFragModel",
            MediaPlayer.models.URIQueryAndFragmentModel
          ),
          this.system.mapSingleton(
            "ksPlayReady",
            MediaPlayer.dependencies.protection.KeySystem_PlayReady
          ),
          this.system.mapSingleton(
            "ksWidevine",
            MediaPlayer.dependencies.protection.KeySystem_Widevine
          ),
          this.system.mapSingleton(
            "ksClearKey",
            MediaPlayer.dependencies.protection.KeySystem_ClearKey
          ),
          this.system.mapSingleton(
            "serverPlayReady",
            MediaPlayer.dependencies.protection.servers.PlayReady
          ),
          this.system.mapSingleton(
            "serverWidevine",
            MediaPlayer.dependencies.protection.servers.Widevine
          ),
          this.system.mapSingleton(
            "serverClearKey",
            MediaPlayer.dependencies.protection.servers.ClearKey
          ),
          this.system.mapSingleton(
            "serverDRMToday",
          ...
          this.system.mapSingleton(
            "requestModifierExt",
            MediaPlayer.dependencies.RequestModifierExtensions
          ),
          this.system.mapSingleton(
            "textSourceBuffer",
            MediaPlayer.dependencies.TextSourceBuffer
          ),
          this.system.mapSingleton(
            "mediaSourceExt",
          ...
          this.system.mapSingleton(
            "playbackController",
            MediaPlayer.dependencies.PlaybackController
          ),
          a.call(this),
          this.system.mapSingleton(
            "liveEdgeFinder",
          ...
          this.system.mapClass(
            "throughputRule",
            MediaPlayer.rules.ThroughputRule
          ),
          this.system.mapSingleton(
            "abrRulesCollection",
            MediaPlayer.rules.ABRRulesCollection
          ),
          this.system.mapSingleton(
            "rulesController",
            MediaPlayer.rules.RulesController
          ),
          this.system.mapClass(
            "bufferLevelRule",
            MediaPlayer.rules.BufferLevelRule
          ),
          this.system.mapClass(
            "pendingRequestsRule",
            MediaPlayer.rules.PendingRequestsRule
          ),
          this.system.mapClass(
            "playbackTimeRule",
            MediaPlayer.rules.PlaybackTimeRule
          ),
          this.system.mapClass(
            "sameTimeRequestRule",
            MediaPlayer.rules.SameTimeRequestRule
          ),
          this.system.mapClass(
            "abandonRequestRule",
            MediaPlayer.rules.AbandonRequestsRule
          ),
          this.system.mapSingleton(
            "scheduleRulesCollection",
            MediaPlayer.rules.ScheduleRulesCollection
          ),
          this.system.mapClass(
            "liveEdgeBinarySearchRule",
            MediaPlayer.rules.LiveEdgeBinarySearchRule
          ),
          this.system.mapClass(
            "liveEdgeWithTimeSynchronizationRule",
            MediaPlayer.rules.LiveEdgeWithTimeSynchronizationRule
          ),
          this.system.mapSingleton(
            "synchronizationRulesCollection",
            MediaPlayer.rules.SynchronizationRulesCollection
          ),
          this.system.mapClass(
            "xlinkController",
            MediaPlayer.dependencies.XlinkController
          ),
          this.system.mapClass(
            "xlinkLoader",
            MediaPlayer.dependencies.XlinkLoader
          ),
          this.system.mapClass(
            "streamProcessor",
            MediaPlayer.dependencies.StreamProcessor
          ),
          this.system.mapClass(
            "eventController",
            MediaPlayer.dependencies.EventController
          ),
          this.system.mapClass(
            "textController",
          ...
          this.system.mapClass(
            "fragmentModel",
            MediaPlayer.dependencies.FragmentModel
          ),
          this.system.mapSingleton(
            "streamController",
          ...
          this.system.mapSingleton(
            "mediaController",
            MediaPlayer.dependencies.MediaController
          ),
          this.system.mapClass("stream", MediaPlayer.dependencies.Stream),
          this.system.mapClass(
            "scheduleController",
            MediaPlayer.dependencies.ScheduleController
          ),
          this.system.mapSingleton(
            "timeSyncController",
          ...
          this.system.mapSingleton(
            "metricsCollectionController",
            MediaPlayer.dependencies.MetricsCollectionController
          ),
          this.system.mapClass(
            "metricsController",
            MediaPlayer.dependencies.MetricsController
          ),
          this.system.mapClass(
            "rangeController",
            MediaPlayer.dependencies.RangeController
          ),
          this.system.mapClass(
            "reportingController",
            MediaPlayer.dependencies.ReportingController
          ),
          this.system.mapClass(
            "metricsHandlersController",
            MediaPlayer.dependencies.MetricsHandlersController
          ),
          this.system.mapSingleton(
            "reportingFactory",
            MediaPlayer.metrics.ReportingFactory
          ),
          this.system.mapClass(
            "dvbReporting",
            MediaPlayer.metrics.reporting.DVBReporting
          ),
          this.system.mapSingleton(
            "metricsHandlerFactory",
            MediaPlayer.metrics.MetricsHandlerFactory
          ),
          this.system.mapClass(
            "bufferLevelHandler",
            MediaPlayer.metrics.handlers.BufferLevel
          ),
          this.system.mapClass(
            "dVBErrorsHandler",
            MediaPlayer.metrics.handlers.DVBErrors
          ),
          this.system.mapClass(
            "httpListHandler",
            MediaPlayer.metrics.handlers.HttpList
          ),
          this.system.mapClass(
            "playListHandler",
            MediaPlayer.metrics.handlers.PlayList
          ),
          this.system.mapClass(
            "genericMetricHandler",
            MediaPlayer.metrics.handlers.GenericMetricHandler
          ),
          this.system.mapSingleton(
            "metricSerialiser",
            MediaPlayer.metrics.utils.MetricSerialiser
          ),
          this.system.mapSingleton(
            "handlerHelpers",
            MediaPlayer.metrics.utils.HandlerHelpers
          ),
          this.system.mapSingleton(
            "notifier",
            MediaPlayer.dependencies.Notifier
          );
      },
    };
  }),
    ...
    return {
      ...
      setup: function () {
        Dash.di.DashContext.prototype.setup.call(this),
          ...
          this.system.mapSingleton(
            "timelineConverter",
            Dash.dependencies.TimelineConverter
          ),
    ...
    var a = [],
      ...
      f = function (a, b) {
        var c = new MediaPlayer.vo.TrackInfo(),
          d =
            b.adaptation.period.mpd.manifest.Period_asArray[
              b.adaptation.period.index
            ].AdaptationSet_asArray[b.adaptation.index],
          e = this.manifestExt.getRepresentationFor(b.index, d);
        return (
          (c.id = b.id),
          (c.quality = b.index),
          (c.bandwidth = this.manifestExt.getBandwidth(e)),
          (c.DVRWindow = b.segmentAvailabilityRange),
          (c.fragmentDuration =
            b.segmentDuration ||
          ...
          (c.useCalculatedLiveEdgeTime = b.useCalculatedLiveEdgeTime),
          (c.mediaInfo = g.call(this, a, b.adaptation)),
          c
        );
      },
      g = function (a, b) {
        var c,
          d = new MediaPlayer.vo.MediaInfo(),
          e = this,
          f =
            b.period.mpd.manifest.Period_asArray[b.period.index]
              .AdaptationSet_asArray[b.index];
        return (
          (d.id = b.id),
          (d.index = b.index),
          (d.type = b.type),
          (d.streamInfo = h.call(this, a, b.period)),
          (d.representationCount = this.manifestExt.getRepresentationCount(f)),
          (d.lang = this.manifestExt.getLanguageForAdaptation(f)),
          (c = this.manifestExt.getViewpointForAdaptation(f)),
          (d.viewpoint = c ? c.value : void 0),
          (d.accessibility = this.manifestExt
            .getAccessibilityForAdaptation(f)
            .map(function (a) {
              return a.value;
            })),
          (d.audioChannelConfiguration = this.manifestExt
            .getAudioChannelConfigurationForAdaptation(f)
            .map(function (a) {
              return a.value;
            })),
          (d.roles = this.manifestExt
            .getRolesForAdaptation(f)
            .map(function (a) {
              return a.value;
            })),
          (d.codec = this.manifestExt.getCodec(f)),
          (d.mimeType = this.manifestExt.getMimeType(f)),
          (d.contentProtection = this.manifestExt.getContentProtectionData(f)),
          (d.bitrateList = this.manifestExt.getBitrateListForAdaptation(f)),
          d.contentProtection &&
            d.contentProtection.forEach(function (a) {
              a.KID = e.manifestExt.getKID(a);
            }),
          (d.isText = this.manifestExt.getIsTextTrack(d.mimeType)),
          d
        );
      },
      h = function (a, b) {
        ...
        return (
          ...
          (c.manifestInfo = i.call(this, a, b.mpd)),
          (c.isLast =
            1 === a.Period_asArray.length ||
            Math.abs(c.start + c.duration - c.manifestInfo.duration) < d),
          c
        );
      },
      i = function (a, b) {
        ...
        return (
          (c.DVRWindowSize = b.timeShiftBufferDepth),
          (c.loadedTime = b.manifest.loadedTime),
          (c.availableFrom = b.availabilityStartTime),
          (c.minBufferTime = b.manifest.minBufferTime),
          (c.maxFragmentDuration = b.maxSegmentDuration),
          (c.duration = this.manifestExt.getDuration(a)),
          (c.isDynamic = this.manifestExt.getIsDynamic(a)),
          c
        );
      },
      j = function (a, c, d) {
        ...
        return j
          ? ((f = this.manifestExt.getIndexForAdaptation(j, a, c.index)),
            (b[i] = b[i] || this.manifestExt.getAdaptationsForPeriod(a, h)),
            g.call(this, a, b[i][f]))
          : null;
      },
      k = function (a, c, d) {
        ...
        for (var n = 0, o = l.length; o > n; n += 1)
          (f = l[n]),
            (i = this.manifestExt.getIndexForAdaptation(f, a, c.index)),
            (h = g.call(this, a, b[k][i])),
            h && m.push(h);
        return m;
      },
      l = function (c) {
        ...
        if (!c) return null;
        for (
          d = this.manifestExt.getMpd(c),
            a = this.manifestExt.getRegularPeriods(c, d),
            d.checkTime = this.manifestExt.getCheckTime(c, a[0]),
            b = {},
            e = a.length,
            f = 0;
          e > f;
      ...
      t = function (a, b) {
        ...
        (c = h.id),
          (f = c
            ? this.manifestExt.getAdaptationForId(c, a, g.index)
            : this.manifestExt.getAdaptationForIndex(h.index, a, g.index)),
          b.representationController.updateData(f, i, j);
      },
      u = function (a, b, c) {
      ...
      x = function (a, b, f) {
        var g = [];
        return (
          b instanceof MediaPlayer.vo.StreamInfo
            ? (g = this.manifestExt.getEventsForPeriod(a, e(b)))
            : b instanceof MediaPlayer.vo.MediaInfo
            ? (g = this.manifestExt.getEventStreamForAdaptationSet(a, d(b)))
            : b instanceof MediaPlayer.vo.TrackInfo &&
              (g = this.manifestExt.getEventStreamForRepresentation(
                a,
                c(b, f.representationController)
              )),
          g
        );
      };
  ...
  (Dash.create = function (a, b, c) {
    ...
    var d,
      e = a.id || a.name || "video element";
    if (
      ((c = c || new Dash.di.DashContext()),
      (b =
        b ||
    ...
    return (
      ...
      d.startup(),
      d.attachView(a),
      d.setAutoPlay(a.autoplay),
      d.attachSource(b.src),
      d
        .getDebug()
        .log(
          "Converted " + e + " to dash.js player and added content: " + b.src
        ),
      d
    );
  }),
  ...
  (Dash.supportedManifestMimeTypes = { mimeType: "application/dash+xml" }),
  (Dash.dependencies.DashHandler = function () {
    ...
    var a,
      ...
      h = function (a, b, c) {
        for (var d, e, f, h, i, j, k = b.length, l = "%0", m = l.length; ; ) {
          ...
          if (((f = a.indexOf(l, d + k)), f > d && e > f))
            switch (
              ((h = a.charAt(e - 1)),
              (i = parseInt(a.substring(f + m, e - 1), 10)),
              h)
            ) {
              case "d":
              case "i":
      ...
      l = function (a, b) {
        var c,
          d =
            b.adaptation.period.mpd.manifest.Period_asArray[
              b.adaptation.period.index
            ].AdaptationSet_asArray[b.adaptation.index].Representation_asArray[
              b.index
            ].BaseURL;
      ...
      m = function (a, c) {
        ...
        return (
          ...
          (g.mediaType = c),
          (g.type = MediaPlayer.vo.metrics.HTTPRequest.INIT_SEGMENT_TYPE),
          (g.url = l(a.initialization, a)),
          (g.range = a.range),
          (e = d.start),
          (g.availabilityStartTime =
            f.timelineConverter.calcAvailabilityStartTimeFromPresentationTime(
              e,
              a.adaptation.period.mpd,
              b
            )),
          (g.availabilityEndTime =
            f.timelineConverter.calcAvailabilityEndTimeFromPresentationTime(
              e + d.duration,
              d.mpd,
              b
            )),
          (g.quality = a.index),
          (g.mediaInfo = f.streamProcessor.getMediaInfo()),
          g
        );
      },
      n = function (a) {
      ...
      o = function (a) {
        ...
        return (
          0 > d
            ? (h = !1)
            : b || d < a.availableSegmentsNumber
            ? ((e = B(d, a)),
              e &&
                ((f = e.presentationStartTime - g.start),
                (c = a.adaptation.period.duration),
                this.log(a.segmentInfoType + ": " + f + " / " + c),
      ...
      p = function (a, c) {
        ...
        return (
          (e = a.segmentDuration),
          isNaN(e) && (e = a.adaptation.period.duration),
          (f = a.adaptation.period.start + c * e),
          (g = f + e),
          (d = new Dash.vo.Segment()),
          (d.representation = a),
          (d.duration = e),
          (d.presentationStartTime = f),
          (d.mediaStartTime =
            h.timelineConverter.calcMediaTimeFromPresentationTime(
              d.presentationStartTime,
              a
            )),
          (d.availabilityStartTime =
            h.timelineConverter.calcAvailabilityStartTimeFromPresentationTime(
              d.presentationStartTime,
              a.adaptation.period.mpd,
              b
            )),
          (d.availabilityEndTime =
            h.timelineConverter.calcAvailabilityEndTimeFromPresentationTime(
              g,
              a.adaptation.period.mpd,
              b
            )),
          (d.wallStartTime = h.timelineConverter.calcWallTimeForSegment(d, b)),
          (d.replacementNumber = k(d, c)),
          (d.availabilityIdx = c),
          d
        );
      },
      q = function (c) {
        var d,
          ...
          r = this,
          s =
            c.adaptation.period.mpd.manifest.Period_asArray[
              c.adaptation.period.index
            ].AdaptationSet_asArray[c.adaptation.index].Representation_asArray[
              c.index
            ].SegmentTemplate,
          v = s.SegmentTimeline,
        ...
        for (
          q = c.timescale,
            ...
            l
              ? ((o = l.start), (p = l.end))
              : (n = r.timelineConverter.calcMediaTimeFromPresentationTime(
                  a || 0,
                  c
                )),
            f = 0,
          ...
          if (
            ((e = d[f]),
            (i = 0),
            e.hasOwnProperty("r") && (i = e.r),
            e.hasOwnProperty("t") && ((z = e.t), (A = z / q)),
            0 > i)
          ) {
            if (((k = d[f + 1]), k && k.hasOwnProperty("t"))) j = k.t / q;
            else {
              var E = c.segmentAvailabilityRange
                ? c.segmentAvailabilityRange.end
                : this.timelineConverter.calcSegmentAvailabilityRange(c, b).end;
              (j = r.timelineConverter.calcMediaTimeFromPresentationTime(E, c)),
                (c.segmentDuration = e.d / q);
            }
      ...
      r = function (a) {
        var c,
          ...
          j = this,
          k =
            a.adaptation.period.mpd.manifest.Period_asArray[
              a.adaptation.period.index
            ].AdaptationSet_asArray[a.adaptation.index].Representation_asArray[
              a.index
            ].SegmentTemplate,
          l = a.segmentDuration,
        ...
        for (
          g = a.startNumber,
            c = isNaN(l) && !b ? { start: g, end: g } : s.call(j, a),
            e = c.start,
            f = c.end,
            d = e;
          f >= d;
          ...
          (n = p.call(j, a, d)),
            (n.replacementTime = (g + d - 1) * a.segmentDuration),
            (o = k.media),
            (o = h(o, "Number", n.replacementNumber)),
            (o = h(o, "Time", n.replacementTime)),
            (n.media = o),
            i.push(n),
            (n = null);
        return (
          isNaN(l)
            ...
            : (a.availableSegmentsNumber = Math.ceil((m.end - m.start) / l)),
          i
        );
      },
      s = function (a) {
        var c,
          ...
          f = this,
          g = a.segmentDuration,
          h = a.adaptation.period.mpd.manifest.minBufferTime,
          i = a.segmentAvailabilityRange,
          j = {
            start:
              f.timelineConverter.calcPeriodRelativeTimeFromMpdRelativeTime(
                a,
                i.start
              ),
            end: f.timelineConverter.calcPeriodRelativeTimeFromMpdRelativeTime(
              a,
              i.end
            ),
          };
        a.segments, Math.max(2 * h, 10 * g);
        return (
          j || (j = f.timelineConverter.calcSegmentAvailabilityRange(a, b)),
          (j.start = Math.max(j.start, 0)),
          (c = Math.floor(j.start / g)),
          (d = Math.floor(j.end / g)),
          (e = { start: c, end: d })
        );
      },
      t = function () {
        ...
        return b && !this.timelineConverter.isTimeSyncCompleted()
          ? (f = { start: i, end: j })
          : (!b && a) || 0 > d
          ? null
          : ((c = Math.max(d - g, i)),
      ...
      u = function (a, c, d, e, f, g, i) {
        ...
        return (
          (j = n.timelineConverter.calcPresentationTimeFromMediaTime(o, a)),
          (l = j + p),
          (m = new Dash.vo.Segment()),
          (m.representation = a),
          (m.duration = p),
          (m.mediaStartTime = o),
          (m.presentationStartTime = j),
          (m.availabilityStartTime =
            a.adaptation.period.mpd.manifest.loadedTime),
          (m.availabilityEndTime =
            n.timelineConverter.calcAvailabilityEndTimeFromPresentationTime(
              l,
              a.adaptation.period.mpd,
              b
            )),
          (m.wallStartTime = n.timelineConverter.calcWallTimeForSegment(m, b)),
          (m.replacementTime = c),
          (m.replacementNumber = k(m, i)),
          (f = h(f, "Number", m.replacementNumber)),
          (f = h(f, "Time", m.replacementTime)),
          (m.media = f),
          (m.mediaRange = g),
          (m.availabilityIdx = i),
          m
      ...
      v = function (a) {
        ...
        for (
          h = a.startNumber,
            e = s.call(i, a),
            f = Math.max(e.start, 0),
            g = Math.min(e.end, k.SegmentURL_asArray.length - 1),
            b = f;
          g >= b;
          b += 1
        )
          (d = k.SegmentURL_asArray[b]),
            (c = p.call(i, a, b)),
            (c.replacementTime = (h + b - 1) * a.segmentDuration),
            (c.media = d.media ? d.media : l),
            (c.mediaRange = d.mediaRange),
            (c.index = d.index),
      ...
      w = function (a) {
        var b,
          ...
          d = a.segmentInfoType;
        return (
          "SegmentBase" !== d && "BaseURL" !== d && C.call(c, a)
            ? ("SegmentTimeline" === d
                ? (b = q.call(c, a))
                : "SegmentTemplate" === d
                ? (b = r.call(c, a))
                : "SegmentList" === d && (b = v.call(c, a)),
              x.call(c, a, b))
            : (b = a.segments),
          b
        );
      ...
      x = function (a, c) {
        ...
        (a.segments = c),
          (d = c.length - 1),
          b &&
            isNaN(this.timelineConverter.getExpectedLiveEdge()) &&
            ((g = c[d]),
            (e = g.presentationStartTime),
            (f = this.metricsModel.getMetricsFor("stream")),
            this.timelineConverter.setExpectedLiveEdge(e),
            this.metricsModel.updateManifestUpdateInfo(
              this.metricsExt.getCurrentManifestUpdate(f),
      ...
      z = function (a, e) {
        var f,
          ...
          h = a.initialization,
          i =
            "BaseURL" !== a.segmentInfoType &&
            "SegmentBase" !== a.segmentInfoType;
        return (
          a.segmentDuration || a.segments || y.call(g, a),
          (a.segmentAvailabilityRange = null),
          (a.segmentAvailabilityRange =
            g.timelineConverter.calcSegmentAvailabilityRange(a, b)),
          a.segmentAvailabilityRange.end < a.segmentAvailabilityRange.start &&
          !a.useCalculatedLiveEdgeTime
            ? ((f = new MediaPlayer.vo.Error(
                Dash.dependencies.DashHandler.SEGMENTS_UNAVAILABLE_ERROR_CODE,
                "no segments are available yet",
                {
                  availabilityDelay:
                    a.segmentAvailabilityRange.start -
                    a.segmentAvailabilityRange.end,
                }
              )),
              void g.notify(
                Dash.dependencies.DashHandler.eventList
                  .ENAME_REPRESENTATION_UPDATED,
                { representation: a },
                f
              ))
            : (e || (d = -1),
              a.segmentDuration && y.call(g, a),
              h || g.baseURLExt.loadInitialization(a),
              i || g.baseURLExt.loadSegments(a, c, a.indexRange),
              void (
                h &&
                i &&
                g.notify(
      ...
      B = function (a, b) {
        ...
        var c,
          d,
          e = b.segments.length;
        if (e > a && ((c = b.segments[a]), c && c.availabilityIdx === a))
          return c;
        for (d = 0; e > d; d += 1)
      ...
      C = function (a) {
        ...
        return (
          f && 0 !== f.length
            ? ((c = f[0].availabilityIdx),
              (b = f[f.length - 1].availabilityIdx),
              (e = c > d || d > b))
            : (e = !0),
          e
        );
      ...
      D = function (a) {
        ...
        var b,
          ...
          f =
            ...
            ].AdaptationSet_asArray[e.adaptation.index].Representation_asArray[
              e.index
            ].bandwidth;
        return (
          (b = l(a.media, e)),
          (b = h(b, "Number", a.replacementNumber)),
          (b = h(b, "Time", a.replacementTime)),
          (b = h(b, "Bandwidth", f)),
          (b = j(b, e.id)),
          (b = i(b)),
          (d.mediaType = c),
          (d.type = MediaPlayer.vo.metrics.HTTPRequest.MEDIA_SEGMENT_TYPE),
          (d.url = b),
          (d.range = a.mediaRange),
          (d.startTime = a.presentationStartTime),
          (d.duration = a.duration),
          (d.timescale = e.timescale),
          (d.availabilityStartTime = a.availabilityStartTime),
          (d.availabilityEndTime = a.availabilityEndTime),
          (d.wallStartTime = a.wallStartTime),
          (d.quality = e.index),
          (d.index = a.availabilityIdx),
          (d.mediaInfo = this.streamProcessor.getMediaInfo()),
          d
        );
      },
      E = function (b, e, f) {
        ...
        return b
          ? ((a = e),
            n.log("Getting the request for time: " + e),
            (d = A.call(n, e, b, l)),
            w.call(n, b),
            0 > d && (d = A.call(n, e, b, l)),
            n.log("Index for time " + e + " is " + d),
            (i = m ? !1 : o.call(n, b)),
            i
              ? ((g = new MediaPlayer.vo.FragmentRequest()),
                ...
                (g.index = d),
                (g.mediaType = c),
                (g.mediaInfo = n.streamProcessor.getMediaInfo()),
                n.log("Signal complete."),
                n.log(g))
              : ((h = B(d, b)), (g = D.call(n, h))),
            k && (d = j),
            g)
          : null;
      },
        ...
        return b
          ? -1 === d
            ...
            : ((a = null),
              ...
              (g = o.call(i, b)),
              g
                ? ((e = new MediaPlayer.vo.FragmentRequest()),
                  (e.action = e.ACTION_COMPLETE),
                  (e.index = h),
                  (e.mediaType = c),
                  (e.mediaInfo = i.streamProcessor.getMediaInfo()),
                  i.log("Signal complete."))
                : (w.call(i, b), (f = B(h, b)), (e = D.call(i, f))),
              e)
          : null;
      },
      H = function (a) {
    ...
    return {
      ...
      setup: function () {
        (this[
          Dash.dependencies.BaseURLExtensions.eventList.ENAME_INITIALIZATION_LOADED
        ] = H),
          (this[
            Dash.dependencies.BaseURLExtensions.eventList.ENAME_SEGMENTS_LOADED
          ] = I);
      },
      initialize: function (a) {
        this.subscribe(
          Dash.dependencies.DashHandler.eventList.ENAME_REPRESENTATION_UPDATED,
          a.representationController
        ),
          (c = a.getType()),
          this.setMediaType(c),
          (b = a.isDynamic()),
      ...
      reset: function () {
        (e = 0),
          ...
          this.unsubscribe(
            Dash.dependencies.DashHandler.eventList
              .ENAME_REPRESENTATION_UPDATED,
            this.streamProcessor.representationController
          );
      },
      getInitRequest: n,
    ...
    var a = 31536e3,
          ...
          converter: function (a) {
            ...
            if (
              ((b = Date.UTC(
                ...
                parseInt(c[4], 10),
                parseInt(c[5], 10),
                (c[6] && parseInt(c[6], 10)) || 0,
                (c[7] && parseFloat(c[7]) * g) || 0
              )),
              c[9] && c[10])
            ) {
      ...
      q = function (a, b, c) {
        ...
        try {
          ...
          (h = new Date()),
            d.hasOwnProperty("BaseURL")
              ? ((d.BaseURL = d.BaseURL_asArray[0]),
                0 !== d.BaseURL.toString().indexOf("http") &&
                  (d.BaseURL = b + d.BaseURL))
              : (d.BaseURL = b),
            d.hasOwnProperty("Location") &&
              (d.Location = d.Location_asArray[0]),
            f.run(d),
            (i = new Date()),
            c.setMatchers(l),
            c.setIron(f),
  ...
  (Dash.dependencies.TimelineConverter = function () {
    ...
    var a = 0,
      ...
      d = function (b, c, d, e) {
        var f = NaN;
        return (f = e
          ? d && c.timeShiftBufferDepth != Number.POSITIVE_INFINITY
            ? new Date(
                c.availabilityStartTime.getTime() +
                  1e3 * (b + c.timeShiftBufferDepth)
              )
            : c.availabilityEndTime
          : d
          ? new Date(c.availabilityStartTime.getTime() + 1e3 * (b - a))
      ...
      g = function (b, c) {
        return (
          (b.getTime() - c.mpd.availabilityStartTime.getTime() + 1e3 * a) / 1e3
        );
      },
      h = function (a, b) {
      ...
      j = function (a, b) {
        ...
        return (
          b &&
            ((c =
              a.representation.adaptation.period.mpd
                .suggestedPresentationDelay),
        ...
        var d,
          ...
          j =
            ...
            (a.segments && a.segments.length
              ? a.segments[a.segments.length - 1].duration
              : 0);
        if (!c) return i;
        if (!b && a.segmentAvailabilityRange) return a.segmentAvailabilityRange;
        (d = a.adaptation.period.mpd.checkTime),
          (e = g(new Date(), a.adaptation.period)),
          (f = Math.max(
            e - a.adaptation.period.mpd.timeShiftBufferDepth,
            a.adaptation.period.start
          ));
        var k = isNaN(d) ? e : Math.min(d, e),
          l = a.adaptation.period.start + a.adaptation.period.duration;
        return (
          (h = (k >= l && l > k - j ? l : k) - j), (i = { start: f, end: h })
        );
      },
      l = function (a, b) {
      ...
      n = function (d) {
        b ||
          d.error ||
          ((a += d.data.liveEdge - (c + d.data.searchTime)), (b = !0));
      },
      o = function (c) {
    ...
    return {
      setup: function () {
        (this[
          MediaPlayer.dependencies.LiveEdgeFinder.eventList.ENAME_LIVE_EDGE_SEARCH_COMPLETED
        ] = n),
          (this[
  ...
  (Dash.dependencies.RepresentationController = function () {
    ...
    var a,
      ...
      f = function (c, f, g) {
        var h,
          j = this,
          k = null,
          m = j.streamProcessor.getStreamInfo(),
          n = j.abrController.getTopQualityIndexFor(g, m.id);
        if (
          ((d = !0),
          j.notify(
            Dash.dependencies.RepresentationController.eventList
              .ENAME_DATA_UPDATE_STARTED
          ),
          (e = l.call(j, f)),
          null === b
            ? ((k = j.abrController.getInitialBitrateFor(g, m)),
              (h = j.abrController.getQualityForBitrate(
                j.streamProcessor.getMediaInfo(),
                k
              )))
            : (h = j.abrController.getQualityFor(g, m)),
          h > n && (h = n),
          (a = i.call(j, h)),
          (b = c),
          "video" !== g && "audio" !== g && "fragmentedText" !== g)
        )
          return (
            (d = !1),
            void j.notify(
              Dash.dependencies.RepresentationController.eventList
                .ENAME_DATA_UPDATE_COMPLETED,
              { data: b, currentRepresentation: a }
            )
          );
        for (var o = 0; o < e.length; o += 1)
          j.indexHandler.updateRepresentation(e[o], !0);
      },
      g = function () {
        var a = new Date(),
          b = this.getCurrentRepresentation(),
          c = 1e3 * this.streamProcessor.playbackController.getTime();
      ...
      h = function () {
        var b = this.streamProcessor,
          c = this.timelineConverter.calcSegmentAvailabilityRange(
            a,
            b.isDynamic()
          );
        this.metricsModel.addDVRInfo(
          b.getType(),
          b.playbackController.getTime(),
          b.getStreamInfo().manifestInfo,
          c
        );
      },
      i = function (a) {
      ...
      k = function () {
        for (var a = 0, b = e.length; b > a; a += 1) {
          ...
          if (
            null === e[a].segmentAvailabilityRange ||
            null === e[a].initialization ||
            (("SegmentBase" === c || "BaseURL" === c) && !e[a].segments)
          )
            return !1;
        }
        return !0;
      ...
      l = function (a) {
        ...
        return (
          (c = e.manifestExt.getIndexForAdaptation(b, f, a.period.index)),
          (d = e.manifestExt.getRepresentationsForAdaptation(f, a))
        );
      },
      m = function (a) {
        for (var b, c = this, d = 0, f = e.length; f > d; d += 1)
          (b = e[d]),
            (b.segmentAvailabilityRange =
              c.timelineConverter.calcSegmentAvailabilityRange(b, a));
      },
      n = function (b) {
        var c = this,
          ...
          g = function () {
            if (!this.isUpdating()) {
              ...
              for (var a = 0; a < e.length; a += 1)
                c.indexHandler.updateRepresentation(e[a], !0);
            }
          };
        (d = !1),
          c.eventBus.dispatchEvent({
            type: MediaPlayer.events.AST_IN_FUTURE,
            data: { delay: f },
          }),
          setTimeout(g.bind(this), f);
      },
      o = function (c) {
        if (this.isUpdating()) {
          var e,
            ...
            p = l.metricsModel.getMetricsFor(
              this.getCurrentRepresentation().adaptation.type
            ),
          ...
          if (
            ...
            return (
              h.call(this),
              n.call(this, c.error.data.availabilityDelay),
              (f = new MediaPlayer.vo.Error(
                Dash.dependencies.RepresentationController.SEGMENTS_UPDATE_FAILED_ERROR_CODE,
          ...
          if (q) {
            for (var s = 0; s < q.trackInfo.length; s += 1)
              if (
                ((e = q.trackInfo[s]),
                e.index === m.index &&
                  e.mediaType === l.streamProcessor.getType())
              ) {
                r = !0;
                break;
              }
            r ||
              l.metricsModel.addManifestUpdateRepresentationInfo(
                q,
                m.id,
                m.index,
                m.adaptation.period.index,
                l.streamProcessor.getType(),
                m.presentationTimeOffset,
                m.startNumber,
                m.segmentInfoType
              );
          }
          k() &&
            ((d = !1),
            l.abrController.setPlaybackQuality(
              l.streamProcessor.getType(),
              l.streamProcessor.getStreamInfo(),
              j.call(this, a)
            ),
            l.metricsModel.updateManifestUpdateInfo(q, {
              latency:
                a.segmentAvailabilityRange.end -
                l.streamProcessor.playbackController.getTime(),
            }),
            (i = l.metricsExt.getCurrentRepresentationSwitch(p)),
            i || g.call(l),
            this.notify(
              Dash.dependencies.RepresentationController.eventList
                .ENAME_DATA_UPDATE_COMPLETED,
      ...
      q = function (b) {
        if (!b.error) {
          ...
          e.isLast &&
            ((d.mpd.checkTime = this.manifestExt.getCheckTime(c, d)),
            (d.duration =
              this.manifestExt.getEndTimeForLastPeriod(
      ...
      r = function () {
        this.streamProcessor.isDynamic() && h.call(this);
      },
      s = function (b) {
        var c = this;
        b.data.mediaType === c.streamProcessor.getType() &&
          c.streamProcessor.getStreamInfo().id === b.data.streamInfo.id &&
          ((a = c.getRepresentationForQuality(b.data.newQuality)),
          t.call(c, b.data.mediaType, a.bandwidth),
          g.call(c));
      },
      t = function (a, b) {
        ("video" === a || "audio" === a) &&
          this.DOMStorage.storeBitrate(
            MediaPlayer.utils.DOMStorage.STORAGE_TYPE_LOCAL,
            a,
            b / 1e3
          );
      };
    return {
      ...
      setup: function () {
        (this[
          MediaPlayer.dependencies.AbrController.eventList.ENAME_QUALITY_CHANGED
        ] = s),
          (this[
            Dash.dependencies.DashHandler.eventList.ENAME_REPRESENTATION_UPDATED
          ] = o),
          ...
          (this[
            MediaPlayer.dependencies.BufferController.eventList.ENAME_BUFFER_LEVEL_UPDATED
          ] = r);
      },
      initialize: function (a) {
  ...
  (Dash.dependencies.BaseURLExtensions = function () {
    ...
    var a = function (a, b) {
        for (
          var c,
            ...
            h = g.length,
            i = a.timescale,
            j = a.earliest_presentation_time,
            k = b.range.start + a.first_offset + a.size,
            l = [],
            m = 0;
          h > m;
          m += 1
        )
          (e = g[m].subsegment_duration),
            (f = g[m].referenced_size),
            (c = new Dash.vo.Segment()),
            (c.duration = e),
            (c.media = b.url),
            (c.startTime = j),
            (c.timescale = i),
      ...
      b = function (a) {
        ...
        return (
          ...
          e &&
            e.isComplete &&
            ((b = d ? d.offset : e.offset),
            (c = e.offset + e.size - 1),
            (f = b + "-" + c),
            this.log("Found the initialization.  Range: " + f)),
          f
        );
      },
      c = function (a, d) {
        ...
        h.log("Start searching for initialization."),
          (f.onload = function () {
            f.status < 200 ||
              f.status > 299 ||
              ((g = !1),
              (l.bytesLoaded = l.range.end),
              (j = h.boxParser.parse(f.response)),
              (i = b.call(h, j)),
              i
                ? ((a.range = i),
                  (a.initialization = k),
          ...
          (f.onloadend = f.onerror =
            function () {
              g &&
                ((g = !1),
                h.errHandler.downloadError("initialization", l.url, f),
                h.notify(
                  Dash.dependencies.BaseURLExtensions.eventList
                    .ENAME_INITIALIZATION_LOADED,
                  { representation: a }
          ...
          e.call(h, f, l),
          h.log("Perform init search: " + l.url);
      },
        ...
        (k.onload = function () {
          if (!(k.status < 200 || k.status > 299)) {
            ...
            if (
              ...
              (n = i.boxParser.parse(k.response)),
              (o = n.getBox("sidx")),
              o && o.isComplete)
            ) {
              var g,
              ...
              if (
                (null !== l &&
                  void 0 !== l &&
                  l.length > 0 &&
                  (g = 1 === l[0].reference_type),
                g)
              ) {
                i.log("Initiate multiple SIDX load."),
                  (p.range.end = p.range.start + o.size);
                var q,
                  r,
                  s,
                  t,
                ...
                for (q = 0, r = l.length; r > q; q += 1)
                  (s = x),
                    (t = x + l[q].referenced_size - 1),
                    (x += l[q].referenced_size),
                    (u = { start: s, end: t }),
                    d.call(i, b, null, u, p, y);
              } else
                i.log("Parsing segments from SIDX."),
                  (j = a.call(i, o, p)),
                  h.call(i, j, b, c);
            } else {
              if (o)
                (p.range.start = o.offset || p.range.start),
                  (p.range.end = p.range.start + (o.size || e));
              else {
                if (f < p.bytesLoaded) return void h.call(i, null, b, c);
                var z = n.getLastBox();
                z && z.size
                  ? ((p.range.start = z.offset + z.size),
                    (p.range.end = p.range.start + e))
                  : (p.range.end += e);
              }
          ...
          (k.onloadend = k.onerror =
            function () {
              m &&
                ((m = !1),
                i.errHandler.downloadError("SIDX", p.url, k),
                h.call(i, null, b, c));
            }),
          e.call(i, k, p),
          i.log("Perform SIDX load: " + p.url);
      },
      e = function (a, b) {
        a.open("GET", this.requestModifierExt.modifyRequestURL(b.url)),
          (a.responseType = "arraybuffer"),
          a.setRequestHeader(
            "Range",
            "bytes=" + b.range.start + "-" + b.range.end
          ),
          (a = this.requestModifierExt.modifyRequestHeader(a)),
          a.send(null);
      },
      f = function (a, b, c) {
        var d = this;
        a
          ? d.notify(
              ...
              { segments: a, representation: b, mediaType: c }
            )
          : d.notify(
              Dash.dependencies.BaseURLExtensions.eventList
                .ENAME_SEGMENTS_LOADED,
              { segments: null, representation: b, mediaType: c },
    ...
    return {
      ...
      loadSegments: function (a, b, c) {
        ...
        (c = e ? { start: parseFloat(e[0]), end: parseFloat(e[1]) } : null),
          d.call(this, a, b, c, null, f.bind(this));
      },
  ...
  (Dash.dependencies.DashManifestExtensions.prototype = {
    ...
    getIsTypeOf: function (a, b) {
      ...
      if (
        ...
        a.Representation_asArray[0].hasOwnProperty("codecs") &&
        "stpp" == a.Representation_asArray[0].codecs
      )
        return "fragmentedText" == b;
      if (f) {
        if (f.length > 1) return "muxed" == b;
        f[0] && f[0].contentType === b && ((h = !0), (i = !0));
      }
      if (
        (a.hasOwnProperty("mimeType") && ((h = g.test(a.mimeType)), (i = !0)),
        !i)
      )
        for (c = 0, d = a.Representation_asArray.length; !i && d > c; )
          (e = a.Representation_asArray[c]),
            e.hasOwnProperty("mimeType") &&
              ((h = g.test(e.mimeType)), (i = !0)),
            (c += 1);
      return h;
    },
    ...
    getLanguageForAdaptation: function (a) {
      var b = "";
      return (
        a.hasOwnProperty("lang") && (b = a.lang.replace(/[^A-Za-z0-9-]/g, "")),
        b
      );
    },
    ...
    getAccessibilityForAdaptation: function (a) {
      return a.hasOwnProperty("Accessibility_asArray")
        ? a.Accessibility_asArray
        : [];
    },
    getAudioChannelConfigurationForAdaptation: function (a) {
      return a.hasOwnProperty("AudioChannelConfiguration_asArray")
    ...
    getDuration: function (a) {
      var b;
      return (b = a.hasOwnProperty("mediaPresentationDuration")
    ...
    getRefreshDelay: function (a) {
      ...
      return (
        a.hasOwnProperty("minimumUpdatePeriod") &&
          (b = Math.max(parseFloat(a.minimumUpdatePeriod), c)),
        b
      );
    },
    ...
    getBitrateListForAdaptation: function (a) {
      if (!a || !a.Representation_asArray || !a.Representation_asArray.length)
        return null;
      for (
        var b = this.processAdaptation(a),
          c = b.Representation_asArray,
          d = c.length,
          e = [],
          f = 0;
        d > f;
    ...
    getRepresentationsForAdaptation: function (a, b) {
      for (
        var c,
          ...
          g,
          h = this,
          i = h.processAdaptation(
            a.Period_asArray[b.period.index].AdaptationSet_asArray[b.index]
          ),
          j = [],
          k = 0;
        ...
        (f = i.Representation_asArray[k]),
          (c = new Dash.vo.Representation()),
          (c.index = k),
          (c.adaptation = b),
          f.hasOwnProperty("id") && (c.id = f.id),
          f.hasOwnProperty("bandwidth") && (c.bandwidth = f.bandwidth),
          f.hasOwnProperty("maxPlayoutRate") &&
            (c.maxPlayoutRate = f.maxPlayoutRate),
          f.hasOwnProperty("SegmentBase")
            ? ((e = f.SegmentBase), (c.segmentInfoType = "SegmentBase"))
            : f.hasOwnProperty("SegmentList")
            ? ((e = f.SegmentList),
              (c.segmentInfoType = "SegmentList"),
              (c.useCalculatedLiveEdgeTime = !0))
            : f.hasOwnProperty("SegmentTemplate")
            ? ((e = f.SegmentTemplate),
              e.hasOwnProperty("SegmentTimeline")
                ? ((c.segmentInfoType = "SegmentTimeline"),
                  (g =
                    e.SegmentTimeline.S_asArray[
                      e.SegmentTimeline.S_asArray.length - 1
                    ]),
                  (!g.hasOwnProperty("r") || g.r >= 0) &&
                    (c.useCalculatedLiveEdgeTime = !0))
                : (c.segmentInfoType = "SegmentTemplate"),
              e.hasOwnProperty("initialization") &&
                (c.initialization = e.initialization
                  ...
                  .join(f.id)))
            : ((e = f.BaseURL), (c.segmentInfoType = "BaseURL")),
          e.hasOwnProperty("Initialization")
            ? ((d = e.Initialization),
              d.hasOwnProperty("sourceURL")
                ? (c.initialization = d.sourceURL)
                : d.hasOwnProperty("range") &&
                  ((c.initialization = f.BaseURL), (c.range = d.range)))
            : f.hasOwnProperty("mimeType") &&
              h.getIsTextTrack(f.mimeType) &&
              ((c.initialization = f.BaseURL), (c.range = 0)),
          e.hasOwnProperty("timescale") && (c.timescale = e.timescale),
          e.hasOwnProperty("duration") &&
            (c.segmentDuration = e.duration / c.timescale),
          e.hasOwnProperty("startNumber") && (c.startNumber = e.startNumber),
          e.hasOwnProperty("indexRange") && (c.indexRange = e.indexRange),
          e.hasOwnProperty("presentationTimeOffset") &&
            (c.presentationTimeOffset = e.presentationTimeOffset / c.timescale),
          (c.MSETimeOffset = h.timelineConverter.calcMSETimeOffset(c)),
          j.push(c);
      return j;
    },
    getAdaptationsForPeriod: function (a, b) {
      for (
        var c, d, e = a.Period_asArray[b.index], f = [], g = 0;
        g < e.AdaptationSet_asArray.length;
        g += 1
      )
        (d = e.AdaptationSet_asArray[g]),
          (c = new Dash.vo.AdaptationSet()),
          d.hasOwnProperty("id") && (c.id = d.id),
          (c.index = g),
          (c.period = b),
          this.getIsMuxed(d)
            ? (c.type = "muxed")
            ...
            : this.getIsVideo(d)
            ? (c.type = "video")
            : this.getIsFragmentedText(d)
            ? (c.type = "fragmentedText")
            : (c.type = "text"),
          f.push(c);
      return f;
    },
    getRegularPeriods: function (a, b) {
      var c,
        ...
        j = null,
        k = null;
      for (c = 0, d = a.Period_asArray.length; d > c; c += 1)
        (i = a.Period_asArray[c]),
          i.hasOwnProperty("start")
            ? ((k = new Dash.vo.Period()), (k.start = i.start))
            : null !== h && i.hasOwnProperty("duration") && null !== j
            ? ((k = new Dash.vo.Period()),
              (k.start = j.start + j.duration),
              (k.duration = i.duration))
            : 0 !== c || g || ((k = new Dash.vo.Period()), (k.start = 0)),
          null !== j && isNaN(j.duration) && (j.duration = k.start - j.start),
          null !== k && (k.id = this.getPeriodId(i)),
          null !== k &&
            i.hasOwnProperty("duration") &&
            (k.duration = i.duration),
          null !== k &&
            ((k.index = c), (k.mpd = b), f.push(k), (h = i), (j = k)),
          (i = null),
          (k = null);
      return 0 === f.length
        ? f
        : (null !== j &&
            isNaN(j.duration) &&
            (j.duration = e.getEndTimeForLastPeriod(a, j) - j.start),
          f);
    },
    ...
    getMpd: function (a) {
      ...
      return (
        (b.manifest = a),
        a.hasOwnProperty("availabilityStartTime")
          ? (b.availabilityStartTime = new Date(
        ...
        a.hasOwnProperty("timeShiftBufferDepth") &&
          (b.timeShiftBufferDepth = a.timeShiftBufferDepth),
        a.hasOwnProperty("maxSegmentDuration") &&
    ...
    getCheckTime: function (a, b) {
      ...
      return (
        a.hasOwnProperty("minimumUpdatePeriod") &&
          ((c = d.getFetchTime(a, b)), (e = c + a.minimumUpdatePeriod)),
        e
      );
    },
    getEndTimeForLastPeriod: function (a, b) {
      var c,
        d = this.getCheckTime(a, b);
      ...
      if (d)
        for (var f = 0; f < d.length; f += 1) {
          ...
          if (
            ((g.period = b),
            (g.timescale = 1),
            !d[f].hasOwnProperty("schemeIdUri"))
          )
            throw "Invalid EventStream. SchemeIdUri has to be set";
          (g.schemeIdUri = d[f].schemeIdUri),
            d[f].hasOwnProperty("timescale") && (g.timescale = d[f].timescale),
            d[f].hasOwnProperty("value") && (g.value = d[f].value);
          for (var h = 0; h < d[f].Event_asArray.length; h += 1) {
            var i = new Dash.vo.Event();
            (i.presentationTime = 0),
              (i.eventStream = g),
              d[f].Event_asArray[h].hasOwnProperty("presentationTime") &&
                (i.presentationTime = d[f].Event_asArray[h].presentationTime),
              d[f].Event_asArray[h].hasOwnProperty("duration") &&
                (i.duration = d[f].Event_asArray[h].duration),
              d[f].Event_asArray[h].hasOwnProperty("id") &&
                (i.id = d[f].Event_asArray[h].id),
              e.push(i);
          }
        }
      return e;
    ...
    getEventStreams: function (a, b) {
      ...
      for (var d = 0; d < a.length; d++) {
        ...
        if (
          ((e.timescale = 1),
          (e.representation = b),
          !a[d].hasOwnProperty("schemeIdUri"))
        )
          throw "Invalid EventStream. SchemeIdUri has to be set";
        (e.schemeIdUri = a[d].schemeIdUri),
          a[d].hasOwnProperty("timescale") && (e.timescale = a[d].timescale),
          a[d].hasOwnProperty("value") && (e.value = a[d].value),
          c.push(e);
      }
      return c;
    },
    ...
    getEventStreamForRepresentation: function (a, b) {
      var c =
        a.Period_asArray[b.adaptation.period.index].AdaptationSet_asArray[
          b.adaptation.index
        ].Representation_asArray[b.index].InbandEventStream_asArray;
      ...
      return (
        (c || d) &&
          ...
          e.forEach(function (a) {
            ...
            a.hasOwnProperty("schemeIdUri") &&
              ((b.schemeIdUri = a.schemeIdUri),
              a.hasOwnProperty("value") &&
                ((b.value = a.value.toString()), f.push(b)));
          }),
        f
      );
    },
    getMetricsRangeStartTime: function (a, b, c) {
      var d,
        e,
        f = this.getMpd(a),
        g = 0;
      return (
        b
          ? (g = f.availabilityStartTime.getTime() / 1e3)
          : ((d = this.getRegularPeriods(a, f)), d.length && (g = d[0].start)),
        (e = g),
        c && c.hasOwnProperty("starttime") && (e += c.starttime),
        e
      );
    },
    getMetrics: function (a) {
      ...
      return (
        a.Metrics_asArray &&
          a.Metrics_asArray.forEach(function (d) {
            var e = new Dash.vo.Metrics(),
              f = b.getIsDynamic(a);
            d.hasOwnProperty("metrics") &&
              ((e.metrics = d.metrics),
              d.Range_asArray &&
                d.Range_asArray.forEach(function (c) {
                  var d = new Dash.vo.Range();
                  (d.starttime = b.getMetricsRangeStartTime(a, f, c)),
                    c.hasOwnProperty("duration")
                      ? (d.duration = c.duration)
                      : (d.duration = b.getDuration(a)),
                    (d.useWallClockTime = f),
                    e.Range.push(d);
                }),
              d.Reporting_asArray &&
                (d.Reporting_asArray.forEach(function (a) {
                  var b,
                    c = new Dash.vo.Reporting();
                  if (a.hasOwnProperty("schemeIdUri")) {
                    c.schemeIdUri = a.schemeIdUri;
  ...
  (Dash.dependencies.DashMetricsExtensions = function () {
    ...
    var a = 200,
      b = function (a, b) {
        ...
        for (d = a.AdaptationSet_asArray, g = 0; g < d.length; g += 1)
          for (
            c = d[g], f = c.Representation_asArray, h = 0;
            h < f.length;
            h += 1
          )
      ...
      e = function (a, b) {
        ...
        for (e = a.AdaptationSet_asArray, g = 0; g < e.length; g += 1)
          if (((c = e[g]), (f = c.Representation_asArray), d.call(this, c, b)))
            return f.length;
        return -1;
      },
      f = function (a, b) {
        ...
        return (d = c.call(e, g, a)), null === d ? null : d.bandwidth;
      },
      g = function (a, c) {
        var d,
          e = this,
        ...
        return (d = b.call(e, g, a));
      },
      h = function (a, b) {
        var c,
          d = this,
          f = d.manifestModel.getValue(),
          g = f.Period_asArray[b];
        return (c = e.call(this, g, a));
      },
      i = function (a, b) {
      ...
      o = function (b, c) {
        ...
        if (null === e) return -1;
        var g = 0;
        for (d = e.length - 1; d >= 0 && f.length < c; d--) {
          var h = e[d];
          if (
            h.responsecode &&
            h.type == MediaPlayer.vo.metrics.HTTPRequest.MEDIA_SEGMENT_TYPE
          ) {
            g++;
            var i = h.interval,
              j = h.tresponse - h.trequest,
              k = a > j && a > i;
            k || f.push(j);
          }
        }
        if (0 === f.length) return g > 5 ? a : -1;
        var l = 0;
        for (d = 0; d < f.length; d++) l += f[d];
        return l / f.length;
      },
      p = function (a, b) {
        var c,
        ...
        if (null === e) return -1;
        var g = 0;
        for (d = e.length - 1; d >= 0 && f.length < b; d--) {
          var h = e[d];
          if (
            h.responsecode &&
            h.type == MediaPlayer.vo.metrics.HTTPRequest.MEDIA_SEGMENT_TYPE
        ...
        if (0 === f.length) return g > 5 ? c : -1;
        var l = 0;
        for (d = 0; d < f.length; d++) l += f[d];
        return (1e3 * l) / f.length;
      },
      q = function (a) {
      ...
      v = function (a, b) {
        var c,
          ...
          f = {};
        if (null === a) return null;
        for (c = q(a), e = c.length - 1; e >= 0; e -= 1)
          if (
            ((d = c[e]), d.type === MediaPlayer.vo.metrics.HTTPRequest.MPD_TYPE)
          ) {
            f = x(d._responseHeaders);
            break;
          }
      ...
      w = function (a, b) {
        ...
        var c,
          d = n(a);
        return null === d || null === d._responseHeaders
          ? null
          : ((c = x(d._responseHeaders)), void 0 === c[b] ? null : c[b]);
      },
      x = function (a) {
        var b = {};
        if (!a) return b;
    ...
    return {
      ...
      manifestExt: void 0,
      system: void 0,
      getBandwidthForRepresentation: f,
      getIndexForRepresentation: g,
      getMaxIndexForBufferType: h,
      getMaxAllowedIndexForBufferType: i,
      getCurrentRepresentationSwitch: j,
      getCurrentBufferLevel: k,
      getCurrentHttpRequest: n,
      getRecentThroughput: p,
      getRecentLatency: o,
      getHttpRequests: q,
      getCurrentDroppedFrames: r,
      getCurrentSchedulingInfo: s,
      getCurrentDVRInfo: u,
      getCurrentManifestUpdate: t,
      getLatestFragmentRequestHeaderValueByID: w,
      getLatestMPDRequestHeaderValueByID: v,
      getRequestsQueue: l,
      getLatestPlayList: m,
    };
  }),
  ...
  (Dash.dependencies.FragmentExtensions = function () {
    ...
    var a = function (a) {
        ...
        for (
          d = n.sample_count,
            f = m.baseMediaDecodeTime,
            j = (l.base_data_offset || 0) + (n.data_offset || 0),
            g = [],
            i = 0;
          d > i;
          i++
          ...
          (h = n.samples[i]),
            ...
            (e =
              void 0 !== h.sample_size ? h.sample_size : l.default_sample_size),
            (c =
              void 0 !== h.sample_composition_time_offset
                ? h.sample_composition_time_offset
                : 0),
            g.push({
              dts: f,
              cts: f + c,
  ...
  (Dash.vo.AdaptationSet.prototype = { constructor: Dash.vo.AdaptationSet }),
  ...
  (Dash.vo.Event.prototype = { constructor: Dash.vo.Event }),
  ...
  (Dash.vo.EventStream.prototype = { constructor: Dash.vo.EventStream }),
  (Dash.vo.Metrics = function () {
    "use strict";
    (this.metrics = ""), (this.Range = []), (this.Reporting = []);
  }),
  (Dash.vo.Metrics.prototype = { constructor: Dash.vo.Metrics }),
  ...
  (Dash.vo.Mpd.prototype = { constructor: Dash.vo.Mpd }),
  ...
  (Dash.vo.Period.prototype = { constructor: Dash.vo.Period }),
  (Dash.vo.Period.DEFAULT_ID = "defaultId"),
  (Dash.vo.Range = function () {
    "use strict";
    (this.starttime = 0), (this.duration = 1 / 0), (this.useWallClockTime = !1);
  }),
  (Dash.vo.Range.prototype = { constructor: Dash.vo.Range }),
  (Dash.vo.Reporting = function () {
    "use strict";
    (this.schemeIdUri = ""), (this.value = "");
  }),
  (Dash.vo.Reporting.prototype = { constructor: Dash.vo.Reporting }),
  ...
  (Dash.vo.UTCTiming.prototype = { constructor: Dash.vo.UTCTiming }),
    ...
    return {
      ...
      manifestError: function (b, c, d) {
        this.eventBus.dispatchEvent({
          type: a,
          error: "manifestError",
          event: { message: b, id: c, manifest: d },
        });
      },
  ...
  (MediaPlayer.dependencies.FragmentLoader = function () {
    ...
    var a = MediaPlayer.dependencies.FragmentLoader.RETRY_ATTEMPTS,
      ...
      d = function (a, e) {
        var f = new XMLHttpRequest(),
          ...
          m = function (b, c) {
            ...
            var d,
              e,
              h = new Date();
            b.firstByteDate || (b.firstByteDate = b.requestStartDate),
              (b.requestEndDate = h),
              (d = b.firstByteDate.getTime() - b.requestStartDate.getTime()),
              (e = b.requestEndDate.getTime() - b.firstByteDate.getTime()),
              l.log(
                (c ? "loaded " : "failed ") +
                  b.mediaType +
                  ":" +
        ...
        c.push(f),
          (a.requestStartDate = new Date()),
          (j = a.requestStartDate),
          f.open("GET", l.requestModifierExt.modifyRequestURL(a.url), !0),
          (f.responseType = "arraybuffer"),
          (f = l.requestModifierExt.modifyRequestHeader(f)),
          a.range && f.setRequestHeader("Range", "bytes=" + a.range),
          (f.onprogress = function (b) {
            var c = new Date();
            h &&
              ((h = !1),
              (!b.lengthComputable ||
                (b.lengthComputable && b.total !== b.loaded)) &&
                (a.firstByteDate = c)),
              b.lengthComputable &&
                ((a.bytesLoaded = b.loaded), (a.bytesTotal = b.total)),
              g.push({
                s: j,
                d: c.getTime() - j.getTime(),
                b: [b.loaded ? b.loaded - k : 0],
              }),
              (j = c),
              (k = b.loaded),
              l.notify(
                MediaPlayer.dependencies.FragmentLoader.eventList
                  .ENAME_LOADING_PROGRESS,
                { request: a }
              );
          }),
          (f.onload = function () {
            f.status < 200 ||
              ...
              l.notify(
                MediaPlayer.dependencies.FragmentLoader.eventList
                  .ENAME_LOADING_COMPLETED,
                { request: a, response: f.response }
              ));
          }),
          (f.onloadend = f.onerror =
            function () {
                ...
                i &&
                  ...
                  e > 0
                    ...
                    : (l.log(
                      ...
                      l.errHandler.downloadError("content", a.url, f),
                      l.notify(
                        MediaPlayer.dependencies.FragmentLoader.eventList
                          .ENAME_LOADING_COMPLETED,
                        { request: a, bytes: null },
        ...
        c.open("HEAD", a.url, !0),
          (c.onload = function () {
            c.status < 200 ||
              ...
              b.notify(
                MediaPlayer.dependencies.FragmentLoader.eventList
                  .ENAME_CHECK_FOR_EXISTENCE_COMPLETED,
                { request: a, exists: !0 }
              ));
          }),
          (c.onloadend = c.onerror =
            function () {
              d ||
                b.notify(
                  MediaPlayer.dependencies.FragmentLoader.eventList
  ...
  (MediaPlayer.dependencies.LiveEdgeFinder = function () {
    ...
    var a,
        ...
        (d = a.value),
          this.notify(
            MediaPlayer.dependencies.LiveEdgeFinder.eventList
              .ENAME_LIVE_EDGE_SEARCH_COMPLETED,
            { liveEdge: d, searchTime: b },
            null === d
              ? new MediaPlayer.vo.Error(
                  MediaPlayer.dependencies.LiveEdgeFinder.LIVE_EDGE_NOT_FOUND_ERROR_CODE,
                  "live edge has not been found",
                  null
                )
              : null
          );
      ...
      g = function (d) {
        var g = this;
        !g.streamProcessor.isDynamic() ||
          b ||
          d.error ||
          ((a = g.synchronizationRulesCollection.getRules(e)),
          (b = !0),
          (c = new Date().getTime()),
          g.rulesController.applyRules(
            a,
            g.streamProcessor,
            f.bind(g),
            null,
    ...
    return {
      ...
      unsubscribe: void 0,
      setup: function () {
        (this[MediaPlayer.dependencies.Stream.eventList.ENAME_STREAM_UPDATED] =
          g),
          (this[
            MediaPlayer.dependencies.TimeSyncController.eventList.ENAME_TIME_SYNCHRONIZATION_COMPLETED
          ] = h);
      ...
      c = function (a) {
        ...
        return (
          -1 !== a.indexOf("/") &&
            ...
            (b = a.substring(0, a.lastIndexOf("/") + 1))),
          b
        );
      },
      d = function (a, e) {
        ...
        (g = function () {
          ...
          l.status < 200 ||
            ...
            l.responseURL &&
              l.responseURL !== a &&
              ((k = c(l.responseURL)), (d = l.responseURL)),
            r.metricsModel.addHttpRequest(
              "stream",
              null,
            ...
            (f = r.parser.parse(l.responseText, k, r.xlinkController)),
            f
              ? ((f.url = d || a),
                (f.loadedTime = e),
                r.metricsModel.addManifestUpdate(
                  "stream",
                  f.type,
                  m,
                  e,
              ...
              : ((b = "Failed loading manifest: " + a + ", parsing failed"),
                r.notify(
                  MediaPlayer.dependencies.ManifestLoader.eventList
                    .ENAME_MANIFEST_LOADED,
                  { manifest: null },
          ...
          (h = function () {
            n &&
              ...
              e > 0
                ...
                : (r.log(
                    "Failed loading manifest: " + a + " no retry attempts left"
                  ),
                  r.errHandler.downloadError("manifest", a, l),
                  r.notify(
                    MediaPlayer.dependencies.ManifestLoader.eventList
                      .ENAME_MANIFEST_LOADED,
                    null,
          ...
          (i = function (a) {
            ...
            j &&
              ...
              (!a.lengthComputable ||
                ...
                (l.firstByteDate = b)),
              a.lengthComputable &&
                ((l.bytesLoaded = a.loaded), (l.bytesTotal = a.total)),
              q.push({
                s: o,
                d: b.getTime() - o.getTime(),
                b: [a.loaded ? a.loaded - p : 0],
              }),
              (o = b),
              (p = a.loaded);
          });
        try {
          (l.onload = g),
            ...
            (l.onerror = h),
            (l.onprogress = i),
            l.open("GET", r.requestModifierExt.modifyRequestURL(a), !0),
            l.send();
        } catch (s) {
          l.onerror();
        }
    ...
    return {
      ...
      setup: function () {
        (e = e.bind(this)),
          ...
          this.xlinkController.subscribe(
  ...
  (MediaPlayer.dependencies.ManifestUpdater = function () {
    ...
    var a,
      ...
      g = function () {
        f.call(this),
          isNaN(b) ||
            (this.log("Refresh manifest in " + b + " seconds."),
            (c = setTimeout(
              i.bind(this),
              Math.min(1e3 * b, Math.pow(2, 31) - 1),
              this
            )));
      },
      h = function (a) {
        var c,
          e,
          f = new Date();
        this.manifestModel.setValue(a),
          this.log(
            "Manifest has been refreshed at " + f + "[" + f.getTime() + "] "
          ),
          (c = this.manifestExt.getRefreshDelay(a)),
          (e = (new Date().getTime() - a.loadedTime.getTime()) / 1e3),
          (b = Math.max(c - e, 0)),
          this.notify(
            MediaPlayer.dependencies.ManifestUpdater.eventList
              .ENAME_MANIFEST_UPDATED,
            { manifest: a }
          ),
          d || g.call(this);
      },
    ...
    return {
      ...
      setup: function () {
        (this[
          MediaPlayer.dependencies.StreamController.eventList.ENAME_STREAMS_COMPOSED
        ] = m),
          (this[
            MediaPlayer.dependencies.ManifestLoader.eventList.ENAME_MANIFEST_LOADED
          ] = j),
          (this[
            MediaPlayer.dependencies.PlaybackController.eventList.ENAME_PLAYBACK_STARTED
          ] = k),
          (this[
            MediaPlayer.dependencies.PlaybackController.eventList.ENAME_PLAYBACK_PAUSED
          ] = l);
      },
  ...
  (MediaPlayer.dependencies.Notifier = function () {
    ...
    return {
      ...
      setup: function () {
        (a = this.system),
          a.mapValue("notify", this.notify),
          a.mapValue("subscribe", this.subscribe),
          a.mapValue("unsubscribe", this.unsubscribe);
      },
      notify: function () {
    ...
    var a,
      ...
      m = function (a, b, c) {
        ...
        if (
          ((d = a.codec),
          f.log(g + " codec: " + d),
          a.contentProtection && !f.capabilities.supportsEncryptedMedia())
        )
          f.errHandler.capabilityError("encryptedmedia");
        else if (!f.capabilities.supportsCodec(f.videoModel.getElement(), d))
          return (
            (e = g + "Codec (" + d + ") is not supported."),
            f.errHandler.manifestError(e, "codec", c),
            f.log(e),
            !1
          );
        return !0;
      ...
      n = function (a) {
        ...
        if (b) {
          ...
          "fragmentedText" !== f.type
            ...
            : (b.setIndexHandlerTime(d), b.updateMediaInfo(g, f));
        }
      },
      o = function (a, b, d, e) {
        var g = this,
        ...
        if (
          (h.initialize(l.call(g, a), g.fragmentController, d, g, j),
          g.abrController.updateTopQualityIndex(a),
          e
            ? (h.setBuffer(e.buffer),
              (c[e.replaceIdx] = h),
              h.setIndexHandlerTime(e.currentTime))
            : c.push(h),
          "text" === a.type || "fragmentedText" === a.type)
        ) {
          for (var k, m = 0; m < i.length; m++)
            i[m].index === a.index && (k = m), h.updateMediaInfo(b, i[m]);
      ...
      p = function (a, b) {
        ...
        for (var i = 0, j = g.length; j > i; i += 1)
          (h = g[i]),
            m.call(d, h, b, e) &&
              d.mediaController.isMultiTrackSupportedByType(h.type) &&
              d.mediaController.addTrack(h, f);
        0 !== this.mediaController.getTracksFor(a, f).length &&
          (this.mediaController.checkInitialMediaSettings(f),
          (c = this.mediaController.getCurrentTrackFor(a, f)),
          o.call(this, c, e, b));
      },
      q = function (a) {
        var b,
        ...
        if (
          ((j = d.system.getObject("eventController")),
          (b = d.adapter.getEventsFor(g, f)),
          j.addInlineEvents(b),
          (h = !0),
          p.call(d, "video", a),
          p.call(d, "audio", a),
          p.call(d, "text", a),
          p.call(d, "fragmentedText", a),
          p.call(d, "muxed", a),
          t.call(d),
          (e = !0),
          (h = !1),
          ...
          d.liveEdgeFinder.initialize(c[0]),
            d.liveEdgeFinder.subscribe(
              MediaPlayer.dependencies.LiveEdgeFinder.eventList
                .ENAME_LIVE_EDGE_SEARCH_COMPLETED,
      ...
      r = function () {
        var b = this,
          ...
          l = k
            ? new MediaPlayer.vo.Error(
                MediaPlayer.dependencies.Stream.DATA_UPDATE_FAILED_ERROR_CODE,
                "Data update failed",
                null
              )
            : null,
      ...
      u = function () {
        ...
        this.notify(
          MediaPlayer.dependencies.Stream.eventList
            .ENAME_STREAM_BUFFERING_COMPLETED,
          { streamInfo: f }
        );
      },
      v = function (a) {
      ...
      x = function () {
        ...
        for (e; f > e; e += 1)
          (b = c[e]),
            (a = b.getType()),
            ("audio" === a || "video" === a || "fragmentedText" === a) &&
              d.push(b);
        return d;
      },
      y = function (a) {
        ...
        for (
          d = !1,
            f = a,
            k.log("Manifest updated... set new data on buffers."),
            j && ((e = k.adapter.getEventsFor(m, f)), j.addInlineEvents(e)),
            h = !0,
            i = !1,
            n;
          l > n;
          ...
          (g = c[n]),
            (b = k.adapter.getMediaInfoForType(m, f, g.getType())),
            this.abrController.updateTopQualityIndex(b),
            g.updateMediaInfo(m, b);
        (h = !1), r.call(k);
      };
    return {
      system: void 0,
      ...
      setup: function () {
        (this[
          MediaPlayer.dependencies.BufferController.eventList.ENAME_BUFFERING_COMPLETED
        ] = u),
          (this[
            Dash.dependencies.RepresentationController.eventList.ENAME_DATA_UPDATE_COMPLETED
          ] = v),
          (this[
            MediaPlayer.dependencies.MediaController.eventList.CURRENT_TRACK_CHANGED
          ] = n);
      },
      initialize: function (c, d) {
        (f = c),
          ...
          a &&
            ...
            a.addEventListener(
              MediaPlayer.dependencies.ProtectionController.events.KEY_ADDED,
              b
            ),
            a.addEventListener(
              MediaPlayer.dependencies.ProtectionController.events
      ...
      reset: function (f) {
        ...
        j && j.reset(),
          ...
          (h = !1),
          (i = !1),
          this.fragmentController && this.fragmentController.reset(),
          (this.fragmentController = void 0),
          this.liveEdgeFinder.abortSearch(),
          this.liveEdgeFinder.unsubscribe(
            MediaPlayer.dependencies.LiveEdgeFinder.eventList
              .ENAME_LIVE_EDGE_SEARCH_COMPLETED,
  ...
  (MediaPlayer.dependencies.StreamProcessor = function () {
    ...
    var a,
      ...
      g = function (a) {
        var b = this,
          c =
            "video" === a || "audio" === a || "fragmentedText" === a
              ? "bufferController"
              : "textController";
    ...
    return {
      ...
      initialize: function (c, f, h, i, j) {
        ...
        (b = i),
          (d = c),
          (e = j),
          (a = b.getStreamInfo().manifestInfo.isDynamic),
          (l.bufferController = v),
          (l.scheduleController = n),
          (l.representationController = m),
          (l.fragmentController = f),
          (l.fragmentLoader = u),
          m.subscribe(
            Dash.dependencies.RepresentationController.eventList
              .ENAME_DATA_UPDATE_COMPLETED,
          ...
          "video" === d || "audio" === d || "fragmentedText" === d
            ? (p.subscribe(
                MediaPlayer.dependencies.AbrController.eventList
                  .ENAME_QUALITY_CHANGED,
                v
              ),
              p.subscribe(
                MediaPlayer.dependencies.AbrController.eventList
              ...
              v.subscribe(
                MediaPlayer.dependencies.BufferController.eventList
                  .ENAME_BUFFER_CLEARED,
                n
              ),
              v.subscribe(
                MediaPlayer.dependencies.BufferController.eventList
                  .ENAME_BUFFER_LEVEL_UPDATED,
                n
              ),
              v.subscribe(
                MediaPlayer.dependencies.BufferController.eventList
              ...
              v.subscribe(
                MediaPlayer.dependencies.BufferController.eventList
                  .ENAME_INIT_REQUESTED,
                n
              ),
              v.subscribe(
                MediaPlayer.dependencies.BufferController.eventList
                  .ENAME_BUFFERING_COMPLETED,
                b
              ),
              v.subscribe(
                MediaPlayer.dependencies.BufferController.eventList
              ...
              v.subscribe(
                MediaPlayer.dependencies.BufferController.eventList
                  .ENAME_BYTES_APPENDED,
                s
              ),
              s.subscribe(
                MediaPlayer.dependencies.PlaybackController.eventList
                  .ENAME_PLAYBACK_PROGRESS,
                v
              ),
              s.subscribe(
                MediaPlayer.dependencies.PlaybackController.eventList
              ...
              s.subscribe(
                MediaPlayer.dependencies.PlaybackController.eventList
                  .ENAME_PLAYBACK_SEEKING,
                n.scheduleRulesCollection.playbackTimeRule
              ),
              s.subscribe(
                MediaPlayer.dependencies.PlaybackController.eventList
                  .ENAME_PLAYBACK_SEEKING,
                p.abrRulesCollection.insufficientBufferRule
              ),
              a &&
                s.subscribe(
                  MediaPlayer.dependencies.PlaybackController.eventList
                    .ENAME_WALLCLOCK_TIME_UPDATED,
                  m
                ),
              s.subscribe(
                MediaPlayer.dependencies.PlaybackController.eventList
          ...
          q.initialize(this),
          q.setCurrentTime(s.getInitialTime(this.getStreamInfo())),
          v.initialize(d, h, l),
          n.initialize(d, this),
          p.initialize(d, this),
          (k = this.getFragmentModel()),
          k.setLoader(u),
          k.subscribe(
            MediaPlayer.dependencies.FragmentModel.eventList
              .ENAME_FRAGMENT_LOADING_STARTED,
            f
          ),
          k.subscribe(
            MediaPlayer.dependencies.FragmentModel.eventList
      ...
      updateMediaInfo: function (a, b) {
        b === c || (b && c && b.type !== c.type) || (c = b),
          -1 === f.indexOf(b) && f.push(b),
          this.adapter.updateData(a, this);
      },
      ...
      getCurrentRepresentationInfo: function () {
        return this.adapter.getCurrentRepresentationInfo(
          this.manifestModel.getValue(),
          this.representationController
        );
      },
      getRepresentationInfoForQuality: function (a) {
        return this.adapter.getRepresentationInfoForQuality(
          this.manifestModel.getValue(),
          this.representationController,
          a
        );
      ...
      createBuffer: function () {
        return (
          this.bufferController.getBuffer() ||
          this.bufferController.createBuffer(c)
        );
      },
      isDynamic: function () {
        return a;
      ...
      reset: function (f) {
        ...
        m.unsubscribe(
          ...
          l.unsubscribe(
            MediaPlayer.dependencies.FragmentController.eventList
              .ENAME_STREAM_COMPLETED,
            j.scheduleRulesCollection.bufferLevelRule
          ),
          h.unsubscribe(
            MediaPlayer.dependencies.BufferController.eventList
              .ENAME_BUFFER_LEVEL_STATE_CHANGED,
          ...
          n.unsubscribe(
            MediaPlayer.dependencies.PlaybackController.eventList
              .ENAME_PLAYBACK_SEEKING,
            j.scheduleRulesCollection.playbackTimeRule
          ),
          n.unsubscribe(
            MediaPlayer.dependencies.PlaybackController.eventList
              .ENAME_PLAYBACK_SEEKING,
            m.abrRulesCollection.insufficientBufferRule
          ),
          q.unsubscribe(
            Dash.dependencies.BaseURLExtensions.eventList
              .ENAME_INITIALIZATION_LOADED,
  ...
  (MediaPlayer.utils.TTMLParser = function () {
    ...
    var a,
      ...
      o = { wrap: "white-space: normal;", noWrap: "white-space: nowrap;" },
      p = {
      ...
      s = function (b) {
        ...
        if (
          ((c = b.split(":")),
          (g = parseFloat(c[0]) * d + parseFloat(c[1]) * e + parseFloat(c[2])),
          c[3])
        ) {
      ...
      u = function (a, b) {
        var c = Object.keys(a)
          .filter(function (c) {
            return (
              ("xmlns" === c.split(":")[0] || "xmlns" === c.split(":")[1]) &&
              a[c] === b
            );
          })
          .map(function (a) {
      ...
      v = function (a, b) {
        for (var c in a)
          if (a.hasOwnProperty(c)) {
            if (
              ("object" == typeof a[c] || a[c] instanceof Object) &&
              !Array.isArray(a[c])
            )
              v(a[c], b);
      ...
      B = function (a, b) {
        for (var c = 0; c < a.length; c++)
          for (var d = 0; d < b.length; d++)
            a[c] &&
              a[c].split(":")[0].indexOf(b[d].split(":")[0]) > -1 &&
              a.splice(c, 1);
        return a.concat(b);
      },
      C = function (b, c) {
        ...
        if ("line-padding" in b) {
          var j = parseFloat(
            b["line-padding"].slice(
              b["line-padding"].indexOf(":") + 1,
              b["line-padding"].indexOf("c")
            )
          );
          "id" in b && (i[b.id] = j);
          var k = j * c[0] + "px;";
        ...
        if ("line-heigt" in b)
          if ("normal" === b["line-height"]) d.push("line-heigth: normal;");
            ...
            var s = parseFloat(
              b["line-heigt"].slice(
                b["line-heigt"].indexOf(":") + 1,
                b["line-heigt"].indexOf("%")
              )
            );
            "id" in b && (h[b.id] = s);
            var t = (s / 100) * c[1] + "px;";
        ...
        "font-family" in b &&
          (b["font-family"] in l
            ? d.push(l[b["font-family"]])
            : d.push("font-family:" + b["font-family"] + ";")),
          "text-align" in b &&
            b["text-align"] in m &&
            (d.push(m[b["text-align"]][0]), d.push(m[b["text-align"]][1])),
          "multi-row-align" in b &&
            (y("text-align", d) &&
              "auto" != b["multi-row-align"] &&
              A("text-align", d),
            b["multi-row-align"] in n && d.push(n[b["multi-row-align"]]));
        var u;
        return (
          "background-color" in b &&
            (b["background-color"].indexOf("#") > -1 &&
            b["background-color"].length - 1 === 8
              ? ((u = x(b["background-color"])),
                d.push("background-color: " + u))
              : d.push("background-color:" + b["background-color"] + ";")),
          "color" in b &&
            (b.color.indexOf("#") > -1 && b.color.length - 1 === 8
              ? ((u = x(b.color)), d.push("color: " + u))
              : d.push("color:" + b.color + ";")),
          "wrap-option" in b &&
            (b["wrap-option"] in o
              ? d.push(o[b["wrap-option"]])
              : d.push("white-space:" + b["wrap-option"])),
          "unicode-bidi" in b &&
            (b["unicode-bidi"] in p
              ? d.push(p[b["unicode-bidi"]])
              : d.push("unicode-bidi:" + b["unicode-bidi"])),
          "font-style" in b && d.push("font-style:" + b["font-style"] + ";"),
          "font-weight" in b && d.push("font-weight:" + b["font-weight"] + ";"),
          "direction" in b && d.push("direction:" + b.direction + ";"),
          "text-decoration" in b &&
            d.push("text-decoration:" + b["text-decoration"] + ";"),
          a.tt.hasOwnProperty("xml:space") &&
            "preserve" === a.tt["xml:space"] &&
            d.push("white-space: pre;"),
          d
        );
      },
      D = function (a, b) {
      ...
      F = function (a, b) {
        ...
        if (
          ("display-align" in a && c.push(q[a["display-align"]]),
          "writing-mode" in a && c.push(r[a["writing-mode"]]),
          "style" in a)
        ) {
          var h = E(a.style, b);
          c = c.concat(h);
        ...
        return (
          "padding" in a && c.push("padding:" + a.padding + ";"),
          "overflow" in a && c.push("overflow:" + a.overflow + ";"),
          "show-background" in a &&
            c.push("show-background:" + a["show-background"] + ";"),
          "id" in a && c.push("regionID:" + a.id + ";"),
          c
        );
      },
      G = function (a, b) {
      ...
      I = function () {
        var b = [32, 15];
        return a.tt.hasOwnProperty("ttp:cellResolution")
          ? a.tt["ttp:cellResolution"].split(" ").map(parseFloat)
          : b;
      },
      J = function (a, b) {
        for (
          var c = z("padding-left", b),
            d = z("padding-right", b),
            e = c.concat(" " + d),
            f = "",
            g = "",
            h = "",
            i = Array.prototype.slice.call(a.children),
            j = a.getElementsByClassName("lineBreak")[0],
            k = i.indexOf(j),
            l = [];
          -1 != k;

        )
          l.push(k), (k = i.indexOf(j, k + 1));
        var m = "</span>",
          n = "<br>",
          o =
            '<span class="spanPadding" style="-webkit-box-decoration-break: clone; ';
        if (l.length)
          l.forEach(function (a, b) {
            if (0 === b) {
              for (var c = "", d = 0; a > d; d++)
                (f += i[d].outerHTML),
                  0 === d && (c = e.concat(i[d].style.cssText));
              f = o + c + '">' + f;
            }
            for (var j = "", k = a + 1; k < i.length; k++)
              (g += i[k].outerHTML),
                k === i.length - 1 && (j += e.concat(i[k].style.cssText));
            (g = o + j + '">' + g),
              f && g && b === l.length - 1
                ? (h += f + m + n + g + m)
                : f && g && b !== l.length - 1
            ...
            if (!a.hasOwnProperty("metadata"))
              if (a.hasOwnProperty("span")) {
                ...
                if (a.span.hasOwnProperty("style")) {
                  ...
                  (e.className = "spanPadding " + a.span.style),
                  ...
                  if (!d.hasOwnProperty("metadata"))
                    if (a.hasOwnProperty("#text")) {
                      ...
                      (g.className = e.className),
                        (g.style.cssText = e.style.cssText),
                        (e = g);
                    }
                }),
                  c.appendChild(e);
      ...
      L = function (a, b, c) {
        ...
        return (
          h && (d = H(h, c)),
          g ? ((e = f.concat(H(g, c))), (f = d ? B(d, e) : e)) : d && (f = d),
          N(f, j),
          f
        );
      },
      M = function (b, c) {
        var d,
          ...
          l = "";
        return (
          i && ((d = E(i, c)), (l = "paragraph " + i)),
          j &&
            ((e = E(j, c)),
            d ? ((e = B(d, e)), (l += " " + j)) : (l = "paragraph " + j)),
          h
            ? ((f = E(h, c)),
              d && e
                ? ((g = B(e, f)), (l += " " + h))
      ...
      N = function (a, b) {
        for (var c in b)
          b.hasOwnProperty(c) && (y(c, a) || a.push(c + ":" + b[c]));
      },
      O = function (d) {
        var e,
          f = this,
          j = new X2JS([], "", !1);
        if (((a = j.xml_str2json(d)), !a))
          throw "TTML document could not be parsed";
        f.videoModel.getTTMLRenderingDiv() && (e = "html");
        var l = u(a, "http://www.w3.org/ns/ttml");
        if (
          (l && v(a, l),
          (c = a.tt.head.layout.region_asArray),
          (b = a.tt.head.styling.style_asArray),
          !t())
        ) {
        ...
        var n = I(),
          ...
          q = [o / n[0], p / n[1]];
        k["font-size"] = q[1] + "px;";
        for (var r = [], w = 0; w < c.length; w++)
          r.push(F(JSON.parse(JSON.stringify(c[w])), q));
        var x = u(a.tt, "http://www.w3.org/ns/ttml#parameter");
        a.tt.hasOwnProperty(x + ":frameRate") &&
          (a.tt.frameRate = parseInt(a.tt[x + ":frameRate"], 10));
        var B = [],
        ...
        return (
          C.forEach(function (b) {
            ...
            c.forEach(function (c) {
              if (c.hasOwnProperty("begin") && c.hasOwnProperty("end"))
                (f = s(c.begin)), (j = s(c.end));
              else {
                if (
                  !c.span.hasOwnProperty("begin") ||
                  !c.span.hasOwnProperty("end")
                )
                  throw (d = "TTML document has incorrect timing value");
                (k = s(c.span.begin)), (l = s(c.span.end));
              }
              if (void 0 !== c["smpte:backgroundImage"])
                for (
                  var m = a.tt.head.metadata.image_asArray, t = 0;
                  t < m.length;
                  t += 1
                )
                  "#" + m[t]["xml:id"] == c["smpte:backgroundImage"] &&
                    B.push({
                      start: k || f,
                      end: l || j,
                      id: m[t]["xml:id"],
                ...
                var u = "";
                if (
                  ((c.hasOwnProperty("id") || c.hasOwnProperty("xml:id")) &&
                    (u = c["xml:id"] || c.id),
                  (isNaN(f) || isNaN(j)) && (isNaN(k) || isNaN(l)))
                )
                  throw (d = "TTML document has incorrect timing value");
                var v = L(c, b.div, q),
                  w = M(c, q),
                ...
                var D = c.__children,
                  E = K(D, q);
                (E.className = "cueDirUniWrapper"),
                  y("unicode-bidi", w) &&
                    ((E.style.cssText += z("unicode-bidi", w)),
                    A("unicode-bidi", w)),
                  y("direction", w) &&
                    ((E.style.cssText += z("direction", w)), A("direction", w)),
                  y("padding-left", w) &&
                    y("padding-right", w) &&
                    (E.innerHTML = J(E, w)),
                  y("padding-left", w) &&
                    y("padding-right", w) &&
                    (A("padding-left", w), A("padding-right", w));
                var F = "";
                if (y("regionID", v)) {
                  var G = z("regionID", v);
                  F = G.slice(G.indexOf(":") + 1, G.length - 1);
                }
                w && (C.style.cssText = w.join(" ") + "display:flex;"),
                  v && (v = v.join(" ")),
                  C.appendChild(E);
                ...
                H.appendChild(C),
                  ...
                  (H.style.cssText =
                    ...
                    v),
                  0 === Object.keys(g).length && (g.defaultFontSize = "100"),
                  B.push({
                    start: k || f,
                    end: l || j,
                    type: "html",
  ...
  (MediaPlayer.dependencies.TextSourceBuffer = function () {
    var a = !1,
      ...
      c = function () {
        for (
          var b = this.videoModel.getElement(),
            c = b.textTracks,
            d = c.length,
            e = this,
            f = 0;
          ...
          if (((a = "showing" !== g.mode), "showing" === g.mode)) {
            e.textTrackExtensions.getCurrentTrackIdx() !== f &&
              (e.textTrackExtensions.setCurrentTrackIdx(f),
              e.isFragmented &&
                (e.mediaController.isCurrentTrack(e.allTracks[f]) ||
                  (e.textTrackExtensions.deleteTrackCues(
                    e.textTrackExtensions.getCurrentTextTrack()
                  ),
                  e.fragmentModel.cancelPendingRequests(),
                  e.fragmentModel.abortRequests(),
                  e.mediaController.setTrack(e.allTracks[f]))));
            break;
          }
        }
    ...
    return {
      ...
      initialize: function (a, b) {
        (this.sp = b.streamProcessor),
          (this.mediaInfos = this.sp.getMediaInfoArr()),
          (this.textTrackExtensions = this.system.getObject(
            "textTrackExtensions"
          )),
          (this.isFragmented = !this.manifestExt.getIsTextTrack(a)),
          this.isFragmented &&
            ((this.fragmentModel = this.sp.getFragmentModel()),
            (this.buffered = this.system.getObject("customTimeRanges")),
            (this.initializationSegmentReceived = !1),
            (this.timescale = 9e4),
            (this.allTracks = this.mediaController.getTracksFor(
              "fragmentedText",
        ...
        function d(a, b) {
          var c = new MediaPlayer.vo.TextTrackInfo(),
            ...
            f = function () {
              var a = !1;
              return (
                b.codec && b.codec.search("stpp") >= 0 && (a = !0),
                b.mimeType && b.mimeType.search("ttml") >= 0 && (a = !0),
                a
              );
            };
          (c.captionData = a),
            ...
            (c.defaultTrack = i.getIsDefault(b)),
            (c.isFragmented = i.isFragmented),
            (c.kind = e()),
            i.textTrackExtensions.addTextTrack(c, i.mediaInfos.length);
        }
        var e,
          f,
          g,
        ...
        if ("fragmentedText" === k) {
          ...
          if (this.initializationSegmentReceived)
            for (f = m.getSamplesInfo(a), g = 0; g < f.length; g++) {
              this.firstSubtitleStart ||
                (this.firstSubtitleStart = f[0].cts - c.start * this.timescale),
                (f[g].cts -= this.firstSubtitleStart),
                this.buffered.add(
                  f[g].cts / this.timescale,
                  (f[g].cts + f[g].duration) / this.timescale
                ),
                (h = window.UTF8.decode(
                  new Uint8Array(a.slice(f[g].offset, f[g].offset + f[g].size))
                )),
                (b = null !== b ? b : i.getParser(l));
              try {
                (e = b.parse(h)),
                  this.textTrackExtensions.addCaptions(
                    this.firstSubtitleStart / this.timescale,
                    e
                  );
              } catch (n) {}
            }
            ...
            for (
              this.initializationSegmentReceived = !0, g = 0;
              g < this.mediaInfos.length;
              g++
            )
              d(null, this.mediaInfos[g]);
      ...
      getParser: function (a) {
        ...
        return (
          "text/vtt" === a
            ? (b = this.system.getObject("vttParser"))
            : ("application/ttml+xml" === a || "application/mp4" === a) &&
              (b = this.system.getObject("ttmlParser")),
          b
        );
      },
  ...
  (MediaPlayer.dependencies.TimeSyncController = function () {
    ...
    var a,
      ...
      k = function (a) {
        ...
        return (
          (b = Date.UTC(
            ...
            parseInt(h[4], 10),
            parseInt(h[5], 10),
            h[6] && (parseInt(h[6], 10) || 0),
            (h[7] && parseFloat(h[7]) * f) || 0
          )),
          h[9] &&
            h[10] &&
            ((c = parseInt(h[9], 10) * e + parseInt(h[10], 10)),
            (b += ("+" === h[8] ? -1 : 1) * c * d * f)),
          new Date(b).getTime()
        );
      },
      ...
      q = function (a, c, d, e, f) {
        ...
        (c = l.shift()),
          ...
          (h = function () {
            var b, c;
            200 === j.status &&
              ((b = f ? j.getResponseHeader("Date") : j.response),
              (c = a(b)),
              isNaN(c) || (d(c), (i = !0)));
          }),
          j.open(k, c),
      ...
      t = function () {
        ...
        isNaN(d)
          ? u.call(this, !0)
          : (i(d - new Date().getTime()), u.call(this, !1, d / 1e3, c));
      },
      u = function (a, b, c) {
        f(!1),
          this.notify(
            MediaPlayer.dependencies.TimeSyncController.eventList
              .ENAME_TIME_SYNCHRONIZATION_COMPLETED,
            { time: b, offset: c },
            a
              ? new MediaPlayer.vo.Error(
                  MediaPlayer.dependencies.TimeSyncController.TIME_SYNC_FAILED_ERROR_CODE
                )
              : null
          );
      },
      v = function (b, c) {
        ...
        f(!0),
          g
            ? s.hasOwnProperty(g.schemeIdUri)
              ? s[g.schemeIdUri](
                  g.value,
                  function (a) {
                    var b = new Date().getTime(),
                      c = a - b;
                    i(c),
                      d.log("Local time:      " + new Date(b)),
                      d.log("Server time:     " + new Date(a)),
                      d.log("Difference (ms): " + c),
                      h.call(d, a, c);
                  },
                  function () {
                    v.call(d, b, e + 1);
    ...
    var a = /(?:\r\n|\r|\n)/gm,
      ...
      f = function (a) {
        var c = a.split(b),
          e = c[1].split(d);
        return (
          e.shift(), (c[1] = e[0]), e.shift(), { cuePoints: c, styles: g(e) }
        );
      },
      g = function (a) {
        var b = {};
        return (
          a.forEach(function (a) {
            if (a.split(/:/).length > 1) {
              var c = a.split(/:/)[1];
              c && -1 != c.search(/%/) && (c = parseInt(c.replace(/%/, ""))),
        ...
        for (var k = 0; g > k; k++) {
          ...
          if (l.length > 0 && "WEBVTT" !== l && l.match(b)) {
            var m = f(l),
              ...
              q = e(n[0].replace(c, "")),
              r = e(n[1].replace(c, ""));
            !isNaN(q) && !isNaN(r) && q >= i && r > q
              ? "" !== p
                ? ((i = q), j.push({ start: q, end: r, data: p, styles: o }))
      ...
      d = function (a, c, e, f) {
              ...
              ? ((c.resolvedContent = j),
                l.notify(
                  MediaPlayer.dependencies.XlinkLoader.eventList
                    .ENAME_XLINKELEMENT_LOADED,
                  { element: c, resolveObject: e }
                ))
              : ((c.resolvedContent = null),
                l.notify(
                  MediaPlayer.dependencies.XlinkLoader.eventList
                    .ENAME_XLINKELEMENT_LOADED,
                  { element: c, resolveObject: e },
                  new MediaPlayer.vo.Error(
                    null,
                    "Failed loading Xlink element: " + a,
                    null
                  )
                )));
        }),
          (g = function () {
            var g = "Failed loading XLink content: " + a;
            n &&
              ((n = !1),
              l.metricsModel.addHttpRequest(
                "stream",
              ...
              f > 0
                ? (l.log(g + ", retry in " + b + "ms attempts: " + f),
                  f--,
                  setTimeout(function () {
                    d.call(l, a, c, e, f);
                  }, b))
                : (l.log(g + ", no retry attempts left"),
                  l.errHandler.downloadError("xlink", a, k),
                  (c.resolved = !0),
                  (c.resolvedContent = null),
                  l.notify(
                    MediaPlayer.dependencies.XlinkLoader.eventList
          ...
          (i = function (a) {
            ...
            m &&
              ...
              (!a.lengthComputable ||
                ...
                (k.firstByteDate = b)),
              a.lengthComputable &&
                ((k.bytesLoaded = a.loaded), (k.bytesTotal = a.total)),
              p.push({
                s: q,
                d: b.getTime() - q.getTime(),
                b: [a.loaded ? a.loaded - r : 0],
              }),
              (q = b),
              (r = a.loaded);
          });
        try {
          (k.onload = h),
            ...
            (k.onerror = g),
            (k.onprogress = i),
            k.open("GET", l.requestModifierExt.modifyRequestURL(a), !0),
            k.send();
        } catch (s) {
          l.log("Error"), k.onerror();
        }
      };
    return {
      errHandler: void 0,
  ...
  (MediaPlayer.dependencies.AbrController = function () {
    ...
    var a,
      ...
      o = function (a) {
        ...
        if (!f.hasOwnProperty(a))
          if (g.hasOwnProperty(a)) {
            var c = this.manifestModel.getValue(),
              d = this.manifestExt.getAdaptationForType(c, 0, a).Representation;
            Array.isArray(d)
              ? (f[a] = d[Math.round(d.length * g[a]) - 1].bandwidth)
              : (f[a] = 0);
          } else
            f[a] =
              "video" === a
                ? MediaPlayer.dependencies.AbrController.DEFAULT_VIDEO_BITRATE
                : MediaPlayer.dependencies.AbrController.DEFAULT_AUDIO_BITRATE;
        return (b = f[a]);
      },
      p = function (a, b) {
        f[a] = b;
      ...
      q = function (a) {
        return g.hasOwnProperty(a) ? g[a] : null;
      },
      r = function (a, b) {
        g[a] = b;
      },
      s = function (a) {
        return f.hasOwnProperty("max") && f.max.hasOwnProperty(a)
          ? f.max[a]
          : NaN;
      },
      t = function (a, b) {
      ...
      u = function (a) {
        return g.hasOwnProperty("max") && g.max.hasOwnProperty(a)
          ? g.max[a]
          : 1;
      },
      v = function (a, b) {
        (g.max = g.max || {}), (g.max[a] = b);
      },
      w = function (a, b) {
        var d;
        return (
          (c[b] = c[b] || {}),
          c[b].hasOwnProperty(a) || (c[b][a] = 0),
          (d = x.call(this, c[b][a], a)),
          (d = y.call(this, d, a, c[b][a])),
          (d = A.call(this, d, a))
        );
      },
      x = function (a, b) {
        var c = s(b);
        if (isNaN(c) || !h[b]) return a;
        var d = this.getQualityForBitrate(h[b].getMediaInfo(), c);
        return Math.min(a, d);
      },
      y = function (a, b, c) {
        var d = u(b);
        return isNaN(d) || d >= 1 ? a : Math.min(a, Math.round(c * d));
      },
      z = function (c) {
        var d = this,
        ...
        if (
          ...
          var f = d.abrRulesCollection.getRules(
            ...
            j = function (b) {
              function c(b) {
                a = setTimeout(function () {
                  d.setAbandonmentStateFor(
                    b,
                    MediaPlayer.dependencies.AbrController.ALLOW_LOAD
                  );
              ...
              if (
                ...
                var f = i.getRequests({
                    state:
                      MediaPlayer.dependencies.FragmentModel.states.LOADING,
                  }),
                  h = b.value,
                  j = d.getQualityFor(
                    e,
                    d.streamController.getActiveStreamInfo()
                  );
                j > h &&
                  (i.abortRequests(),
                  d.setAbandonmentStateFor(
                    e,
                    MediaPlayer.dependencies.AbrController.ABANDON_LOAD
                  ),
                  d.setPlaybackQuality(
                    e,
                    d.streamController.getActiveStreamInfo(),
                    h
                  ),
                  g.replaceCanceledRequests(f),
                  c(e));
              }
            };
      ...
      A = function (a, b) {
        if ("video" !== b || !this.limitBitrateByPortal || !h[b]) return a;
        var c = h[b].videoModel.getElement(),
          d = c.clientWidth,
          e = c.clientHeight,
          f = this.manifestModel.getValue(),
          g = this.manifestExt.getAdaptationForType(f, 0, b).Representation,
          i = a;
        if (d > 0 && e > 0) {
          for (
            ;
            i > 0 && d < g[i].width && d - g[i - 1].width < g[i].width - d;

          )
            i -= 1;
          g.length - 2 >= i &&
            g[i].width === g[i + 1].width &&
            (i = Math.min(a, i + 1));
        }
        return i;
      };
    return {
      ...
      setup: function () {
        this[
          MediaPlayer.dependencies.FragmentLoader.eventList.ENAME_LOADING_PROGRESS
        ] = z;
      },
      initialize: function (a, b) {
        (h[a] = b),
          (i[a] = i[a] || {}),
          (i[a].state = MediaPlayer.dependencies.AbrController.ALLOW_LOAD);
      },
      getAutoSwitchBitrate: function (a) {
        return b[a];
      },
      setAutoSwitchBitrate: function (a, c) {
        b[a] = c;
      },
      getPlaybackQuality: function (a) {
        ...
        (c = j.call(this, h, n)),
          (f = l(h, n)),
          b[h] &&
            ((e = g.abrRulesCollection.getRules(
              MediaPlayer.rules.ABRRulesCollection.prototype
                .QUALITY_SWITCH_RULES
            )),
            g.rulesController.applyRules(e, a, o.bind(g), c, function (a, b) {
              return (
                (a =
                  a === MediaPlayer.rules.SwitchRequest.prototype.NO_CHANGE
                    ? 0
                    : a),
                Math.max(a, b)
              );
      ...
      setPlaybackQuality: function (a, b, c) {
        ...
        c !== e &&
          ...
          this.notify(
            MediaPlayer.dependencies.AbrController.eventList
              .ENAME_QUALITY_CHANGED,
            { mediaType: a, streamInfo: b, oldQuality: e, newQuality: c }
          ));
      },
      ...
      getInitialRepresentationRatioFor: function (a, b) {
        q(a, b);
      },
      setMaxAllowedRepresentationRatioFor: function (a, b) {
        v(a, b);
      },
      getMaxAllowedRepresentationRatioFor: function (a, b) {
        u(a, b);
      },
      setMaxAllowedBitrateFor: function (a, b) {
        t(a, b);
      ...
      getQualityForBitrate: function (a, b) {
        var c,
          d = this.getBitrateList(a);
        if (!d || 0 === d.length) return -1;
        for (var e = d.length - 1; e >= 0; e--)
          if (((c = d[e]), 1e3 * b >= c.bitrate)) return e;
        return 0;
      },
      getBitrateList: function (a) {
        if (!a || !a.bitrateList) return null;
        for (
          var b, c = a.bitrateList, d = a.type, e = [], f = 0, g = c.length;
          g > f;
          f += 1
        )
          (b = new MediaPlayer.vo.BitrateInfo()),
            (b.mediaType = d),
            (b.qualityIndex = f),
            (b.bitrate = c[f]),
            e.push(b);
      ...
      isPlayingAtTopQuality: function (a) {
        ...
        return (b =
          e === w.call(this, "audio", d) && f === w.call(this, "video", d));
      },
      getTopQualityIndexFor: w,
      reset: function () {
        (b = { video: !0, audio: !0 }),
          (c = {}),
          (d = {}),
  ...
  (MediaPlayer.dependencies.BufferController = function () {
    ...
    var a,
      ...
      t = function (c) {
        ...
        var d = null;
        try {
          (d = this.sourceBufferExt.createSourceBuffer(a, c)),
            d && d.hasOwnProperty("initialize") && d.initialize(b, this);
        } catch (e) {
          this.errHandler.mediaSourceError(
            "Error creating " + b + " source buffer."
          );
        }
        return (
          this.setBuffer(d),
          N.call(
            this,
            this.streamProcessor.getRepresentationInfoForQuality(f)
              .MSETimeOffset
          ),
          d
        );
      ...
      x = function (a) {
        var b,
          c = this;
        a.data.fragmentModel === c.streamProcessor.getFragmentModel() &&
          (c.log("Initialization finished loading"),
          (b = a.data.chunk),
          this.virtualBuffer.append(b),
          b.quality === f && v.call(c) && aa.call(c));
      },
      y = function (a) {
        if (a.data.fragmentModel === this.streamProcessor.getFragmentModel()) {
          ...
          (j.length > 0 || k.length > 0) &&
            ((b = C.call(this, d, g, j, k)),
            this.streamProcessor.getEventController().addInbandEvents(b)),
            (c.bytes = D.call(this, d)),
            this.virtualBuffer.append(c),
            P.call(this);
        }
      },
      z = function (a) {
        ...
        return (c !== f && e) || (c !== g && !e)
          ? (b.log(
              "reject request - required quality = " +
                f +
                " current quality = " +
                g +
                " chunk media type = " +
            ...
            void T.call(b, c, a.index, a.start))
          : void b.sourceBufferExt.append(m, a);
      },
      A = function (b) {
        if (m === b.data.buffer) {
          this.isBufferingCompleted() &&
            this.streamProcessor.getStreamInfo().isLast &&
            this.mediaSourceExt.signalEndOfStream(a);
          var c,
            e = this;
          if (b.error)
            return (
              b.error.code ===
                ...
                (e.virtualBuffer.append(d),
                (j = 0.8 * e.sourceBufferExt.getTotalBufferedTime(m)),
                e.notify(
                  MediaPlayer.dependencies.BufferController.eventList
                    .ENAME_QUOTA_EXCEEDED,
                  { criticalBufferLevel: j }
                ),
                H.call(e, G.call(e))),
              void (q = !1)
            );
          if (
            ...
            E.call(e) ||
              ...
              H.call(e, G.call(e))),
            (c = e.sourceBufferExt.getAllRanges(m)),
            c && c.length > 0)
          ) {
            var f, g;
            for (f = 0, g = c.length; g > f; f += 1)
              e.log("Buffered Range: " + c.start(f) + " - " + c.end(f));
          }
          e.notify(
            MediaPlayer.dependencies.BufferController.eventList
              .ENAME_BYTES_APPENDED,
            { quality: d.quality, index: d.index, bufferedRanges: c }
          ),
            S.call(e, d.quality, d.index);
        }
      },
      B = function () {
        var a = this,
          b = a.playbackController.getTime(),
          c = this.streamProcessor
            .getScheduleController()
            .getFragmentToLoadCount(),
          d =
            this.streamProcessor.getCurrentRepresentationInfo()
              .fragmentDuration;
        return (
          (h = a.sourceBufferExt.getBufferLength(m, b)),
          (i = c > 0 ? c * d + h : i),
          Q.call(this),
          a.notify(
            MediaPlayer.dependencies.BufferController.eventList
      ...
      C = function (a, b, c, d) {
        ...
        for (var m = 0, n = e.length; n > m; m += 1)
          (f = this.adapter.getEvent(e[m], k, j)), f && i.push(f);
        return i;
      },
      D = function (a) {
        if (!s) return a;
        for (
          ...
          if (
            ((b = String.fromCharCode(a[e + 4], a[e + 5], a[e + 6], a[e + 7])),
            (c = a[e] * h + a[e + 1] * g + 256 * a[e + 2] + 1 * a[e + 3]),
            "emsg" != b)
          )
      ...
      E = function () {
        var a = this,
          b = a.sourceBufferExt.getTotalBufferedTime(m);
        return j > b;
      },
      F = function () {
        var b = m.buffered.length ? m.buffered.start(0) : 0,
          c = this.playbackController.getTime(),
          d = c - b - MediaPlayer.dependencies.BufferController.BUFFER_TO_KEEP;
        r ||
          "ended" === a.readyState ||
          ((r = !0), this.sourceBufferExt.remove(m, 0, Math.round(b + d), a));
      },
      G = function () {
        var a,
          b,
          ...
          f = this;
        return m
          ? ((a = f.playbackController.getTime()),
            (e = f.streamProcessor
              .getFragmentModel()
              .getRequests({
                state: MediaPlayer.dependencies.FragmentModel.states.EXECUTED,
            ...
            (c = e && !isNaN(e.startTime) ? e.startTime : Math.floor(a)),
            (d = f.sourceBufferExt.getBufferRange(m, a)),
            null === d &&
              m.buffered.length > 0 &&
              (c = m.buffered.end(m.buffered.length - 1)),
            (b = m.buffered.start(0)),
            { start: b, end: c })
          : null;
      },
      H = function (b) {
        if (b && m) {
          var c = this,
            d = b.start,
            e = b.end;
          c.sourceBufferExt.remove(m, d, e, a);
        }
      },
      I = function (a) {
        m === a.data.buffer &&
          ...
          this.virtualBuffer.updateBufferedRanges(
            { streamId: R.call(this), mediaType: b },
            this.sourceBufferExt.getAllRanges(m)
          ),
          B.call(this),
          this.notify(
            MediaPlayer.dependencies.BufferController.eventList
              .ENAME_BUFFER_CLEARED,
            {
              from: a.data.from,
              to: a.data.to,
              hasEnoughSpaceToAppend: E.call(this),
            }
          ),
          E.call(this) || setTimeout(H.bind(this, G.call(this)), 1e3 * c));
      },
      J = function () {
        var b,
          c,
          d,
          e = 0.15,
          f = this.playbackController.getTime(),
          g = this.playbackController.getIsDynamic();
        if (!m || !m.buffered || 0 === m.buffered.length) return !1;
        if (
          ((b = m.buffered.length - 1),
          !g &&
            m.buffered.start(b) <= f &&
            m.buffered.end(b) >=
              this.playbackController.getStreamDuration() - e)
        )
          return (
            p ||
              ((p = !0),
        ...
        if (!r) {
          for (
            c = b;
            c > 0 &&
            f + MediaPlayer.dependencies.BufferController.BUFFER_AHEAD_TO_KEEP <
              m.buffered.start(c);
            c--
          )
            d = m.buffered.start(c);
          d &&
            ((r = !0), this.sourceBufferExt.remove(m, d, m.buffered.end(b), a));
        }
        return !1;
      },
      K = function () {
        e > h && !this.isBufferingCompleted()
          ? M.call(this, !1)
          : M.call(this, !0);
      },
      L = function () {
        return n
          ? MediaPlayer.dependencies.BufferController.BUFFER_LOADED
          : MediaPlayer.dependencies.BufferController.BUFFER_EMPTY;
      },
      M = function (a) {
        if (
          !(
            n === a ||
            ("fragmentedText" === b &&
              this.textSourceBuffer.getAllTracksAreDisabled())
          )
        ) {
          n = a;
          var c = L(),
            d =
              c === MediaPlayer.dependencies.BufferController.BUFFER_LOADED
                ? MediaPlayer.events.BUFFER_LOADED
                : MediaPlayer.events.BUFFER_EMPTY;
          Q.call(this),
            this.eventBus.dispatchEvent({ type: d, data: { bufferType: b } }),
            this.notify(
              MediaPlayer.dependencies.BufferController.eventList
                .ENAME_BUFFER_LEVEL_STATE_CHANGED,
      ...
      N = function (a) {
        m && m.timestampOffset !== a && !isNaN(a) && (m.timestampOffset = a);
      },
      O = function () {
        if (m) {
          var a = this;
      ...
      P = function () {
        v.call(this) ? aa.call(this) : X.call(this);
      },
      Q = function () {
        if (u.call(this)) {
          this.metricsModel.addBufferState(b, L(), i);
          var a,
            c = h;
          (a = this.virtualBuffer.getTotalBufferLevel(
            this.streamProcessor.getMediaInfo()
          )),
            a && (c += a),
            this.metricsModel.addBufferLevel(b, new Date(), 1e3 * c);
        }
      },
      R = function () {
      ...
      S = function (a, b) {
        (q = !1), isNaN(b) ? U.call(this, a) : V.call(this, b), P.call(this);
      },
      T = function (a, b, c) {
        (q = !1),
          this.notify(
      ...
      V = function (a) {
        this.virtualBuffer.storeAppendedChunk(d, m),
          W.call(this),
          (k = Math.max(a, k)),
          J.call(this);
      },
      W = function () {
        ...
        if (
          (f.forEach(function (a) {
            (c = e.mediaController.isCurrentTrack(a.mediaInfo) ? h : g),
              c.add(a.bufferedRange.start, a.bufferedRange.end);
          }),
          0 !== g.length &&
            0 !== h.length &&
            ((a = this.sourceBufferExt.getBufferLength({ buffered: h }, i)),
            !(j > a)))
        )
          for (var k = 0, l = g.length; l > k; k += 1)
            (d = { start: g.start(k), end: g.end(k) }),
              (e.mediaController.getSwitchMode(b) ===
      ...
      Y = function (a) {
        if (!a.error) {
          var b,
            d = this;
          N.call(d, a.data.currentRepresentation.MSETimeOffset),
            (b = d.streamProcessor.getStreamInfo().manifestInfo.minBufferTime),
            c !== b &&
              (d.setMinBufferTime(b),
              d.notify(
                MediaPlayer.dependencies.BufferController.eventList
                  .ENAME_MIN_BUFFER_TIME_UPDATED,
                { minBufferTime: b }
              ));
        }
      },
      Z = function (a) {
        var b = this;
        a.data.fragmentModel === b.streamProcessor.getFragmentModel() &&
          ((l = a.data.request.index), J.call(b));
      },
      $ = function (a) {
        if (
          b === a.data.mediaType &&
          this.streamProcessor.getStreamInfo().id === a.data.streamInfo.id
        ) {
          var c = this,
            d = a.data.newQuality;
          f !== d &&
            (N.call(
              c,
              c.streamProcessor.getRepresentationInfoForQuality(d).MSETimeOffset
            ),
            (f = d),
            v.call(c) && aa.call(c));
        }
      ...
      ba = function (a) {
        if (m) {
          ...
          if (b === e)
            switch (f) {
              case MediaPlayer.dependencies.MediaController.trackSwitchModes
                .ALWAYS_REPLACE:
                H.call(c, h);
                break;
              case MediaPlayer.dependencies.MediaController.trackSwitchModes
      ...
      ca = function () {
        ...
        P.call(this),
          ...
          (a =
            o *
            (MediaPlayer.dependencies.PlaybackController
              .WALLCLOCK_TIME_UPDATE_INTERVAL /
              1e3)),
          a >=
            MediaPlayer.dependencies.BufferController.BUFFER_PRUNING_INTERVAL &&
            !q &&
            ((o = 0), F.call(this));
      },
      da = function () {
    ...
    return {
      ...
      setup: function () {
        (this[
          ...
          (this[
            MediaPlayer.dependencies.PlaybackController.eventList.ENAME_PLAYBACK_PROGRESS
          ] = O),
          (this[
            MediaPlayer.dependencies.PlaybackController.eventList.ENAME_PLAYBACK_SEEKING
          ] = O),
          (this[
            MediaPlayer.dependencies.PlaybackController.eventList.ENAME_PLAYBACK_SEEKED
          ] = O),
          (this[
          ...
          (I = I.bind(this)),
          (_ = _.bind(this)),
          this.sourceBufferExt.subscribe(
          ...
          this.virtualBuffer.subscribe(
            MediaPlayer.utils.VirtualBuffer.eventList.CHUNK_APPENDED,
            this,
            _
          );
      },
      initialize: function (a, c, d) {
        ...
        (b = a),
          ...
          e.setMediaSource(c),
          (e.streamProcessor = d),
          (e.fragmentController = d.fragmentController),
          (e.scheduleController = d.scheduleController),
          (f = e.abrController.getQualityFor(b, d.getStreamInfo()));
      },
      createBuffer: t,
      ...
      reset: function (b) {
        ...
        (j = Number.POSITIVE_INFINITY),
          ...
          (d = null),
          (p = !1),
          this.virtualBuffer.unsubscribe(
            MediaPlayer.utils.VirtualBuffer.eventList.CHUNK_APPENDED,
            e,
            _
          ),
          ...
          (r = !1),
          b ||
            (e.sourceBufferExt.abort(a, m),
            e.sourceBufferExt.removeSourceBuffer(a, m)),
          (m = null);
      },
    };
  }),
  ...
  (MediaPlayer.dependencies.EventController = function () {
    ...
    var a = {},
      ...
      k = function () {
        var a = this;
        a.log("Start Event Controller"),
          isNaN(e) || (d = setInterval(n.bind(this), e));
      },
      l = function (b) {
        var c = this;
        if (((a = {}), b))
      ...
      m = function (a) {
        for (var c = this, d = 0; d < a.length; d++) {
          var e = a[d];
          e.id in b
            ? c.log("Repeated event with id " + e.id)
            : ((b[e.id] = e), c.log("Add inband event with id " + e.id));
        }
      },
      n = function () {
        ...
        if (a)
          for (var i = Object.keys(a), j = 0; j < i.length; j++) {
            var k = i[j],
              l = a[k];
            void 0 !== l &&
              ((b = l.presentationTime / l.eventStream.timescale),
              (0 === b || (e >= b && b + f > e)) &&
                (d.log("Start Event " + k + " at " + e),
                l.duration > 0 && (c[k] = l),
                l.eventStream.schemeIdUri == g &&
                  l.eventStream.value == h &&
                  q.call(this),
                delete a[k]));
          }
      },
      p = function () {
        ...
        if (c)
          for (
            var b = this.videoModel.getCurrentTime(), d = Object.keys(c), e = 0;
            e < d.length;
            e++
          ) {
            var f = d[e],
              g = c[f];
            null !== g &&
              (g.duration + g.presentationTime) / g.eventStream.timescale < b &&
              (a.log("Remove Event " + f + " at time " + b),
              (g = null),
              delete c[f]);
          }
      },
      q = function () {
        var a = this.manifestModel.getValue(),
          b = a.url;
        a.hasOwnProperty("Location") && (b = a.Location),
          this.log("Refresh manifest @ " + b),
          this.manifestUpdater.getManifestLoader().load(b);
      };
    return {
      manifestModel: void 0,
  ...
  (MediaPlayer.dependencies.FragmentController = function () {
    ...
    var a = [],
      ...
      d = function (b, c) {
        var d = this,
          ...
          g = d.scheduleRulesCollection.getRules(
            MediaPlayer.rules.ScheduleRulesCollection.prototype
              .FRAGMENTS_TO_EXECUTE_RULES
          );
        -1 !== g.indexOf(this.scheduleRulesCollection.sameTimeRequestRule) &&
          this.scheduleRulesCollection.sameTimeRequestRule.setFragmentModels(
            a,
            f
          ),
          d.rulesController.applyRules(g, e, c, b, function (a, b) {
            return b;
          });
      },
      e = function (a, b, c) {
      ...
      f = function (a) {
        var b = this,
          c = a.data.request;
        b.isInitializationRequest(c)
          ? b.notify(
              MediaPlayer.dependencies.FragmentController.eventList
                .ENAME_INIT_FRAGMENT_LOADING_START,
              { request: c, fragmentModel: a.sender }
            )
          : b.notify(
              MediaPlayer.dependencies.FragmentController.eventList
                .ENAME_MEDIA_FRAGMENT_LOADING_START,
      ...
      g = function (a) {
        ...
        return f
          ? ((b = e.call(this, f, d, g)),
            c.notify(i, { chunk: b, fragmentModel: a.sender }),
            void j.call(this))
          : void c.log("No " + d.mediaType + " bytes to push.");
      },
      h = function (a) {
        this.notify(
          MediaPlayer.dependencies.FragmentController.eventList
            .ENAME_STREAM_COMPLETED,
          { request: a.data.request, fragmentModel: a.sender }
        );
      },
      i = function (c) {
        var d,
        ...
        for (g = 0; g < i.length; g += 1)
          if ((e = i[g]))
            for (h = 0; h < a.length; h += 1)
              (f = a[h]),
                (d = f.getContext().streamProcessor.getType()),
                e.mediaType === d &&
                  (e instanceof MediaPlayer.vo.FragmentRequest ||
                    (e = f.getRequests({
                      state:
                        MediaPlayer.dependencies.FragmentModel.states.PENDING,
                      time: e.startTime,
                    })[0]),
                  f.executeRequest(e));
        b = !1;
    ...
    return {
      ...
      setup: function () {
        (this[
          MediaPlayer.dependencies.FragmentModel.eventList.ENAME_FRAGMENT_LOADING_STARTED
        ] = f),
          (this[
            MediaPlayer.dependencies.FragmentModel.eventList.ENAME_FRAGMENT_LOADING_COMPLETED
          ] = g),
          (this[
            MediaPlayer.dependencies.FragmentModel.eventList.ENAME_STREAM_COMPLETED
          ] = h);
      },
      process: function (a) {
        var b = null;
      ...
      getModel: function (b) {
        ...
        return (
          d ||
            ((d = this.system.getObject("fragmentModel")),
            d.setContext(b),
            a.push(d)),
          d
        );
      ...
      isInitializationRequest: function (a) {
        return (
          a &&
          a.type &&
          a.type === MediaPlayer.vo.metrics.HTTPRequest.INIT_SEGMENT_TYPE
        );
      },
      prepareFragmentForLoading: function (a, b) {
        a && b && a.addRequest(b) && j.call(this, b);
      },
      ...
      reset: function () {
        (a = []),
          this.scheduleRulesCollection.sameTimeRequestRule &&
            this.unsubscribe(
              MediaPlayer.dependencies.FragmentController.eventList
                .ENAME_STREAM_COMPLETED,
              this.scheduleRulesCollection.sameTimeRequestRule
  ...
  (MediaPlayer.dependencies.MediaController = function () {
    var a,
      ...
      e = function (a, b) {
        ("video" === a || "audio" === a) &&
          this.DOMStorage.storeLastSettings(
            MediaPlayer.utils.DOMStorage.STORAGE_TYPE_LOCAL,
            a,
            b
          );
        ...
        var b = {
          ...
          c =
            ...
            (b.audioChannelConfiguration &&
              b.audioChannelConfiguration.length > 0);
        return c ? b : null;
      },
      g = function (a, b) {
      ...
      j = function (a) {
        var b = this.getSelectionModeForInitialTrack(),
          ...
          d = function (a) {
            ...
            return (
              a.forEach(function (a) {
                (b = Math.max.apply(Math, a.bitrateList)),
        ...
        switch (b) {
          case MediaPlayer.dependencies.MediaController.trackSelectionModes
            .HIGHEST_BITRATE:
    ...
    return {
      ...
      checkInitialMediaSettings: function (a) {
        ...
        ["audio", "video", "text", "fragmentedText"].forEach(function (c) {
          var d = b.getInitialSettings(c),
            ...
            f = [];
          d ||
            ((d = b.DOMStorage.getSavedMediaSettings(c)),
            b.setInitialSettings(c, d)),
            e &&
              0 !== e.length &&
              (d &&
                e.forEach(function (a) {
                  g.call(b, d, a) && f.push(a);
                }),
              0 === f.length
                ? b.setTrack(j.call(b, e))
                : f.length > 1
                ? b.setTrack(j.call(b, f))
                : b.setTrack(f[0]));
        });
      },
      addTrack: function (a) {
        ...
        return a && this.isMultiTrackSupportedByType(b)
          ? ((d[c] = d[c] || k.call(this)),
            d[c][b].list.indexOf(a) >= 0 ? !1 : (d[c][b].list.push(a), !0))
          : !1;
      },
            ...
            (d[h][b].current = a),
              i &&
                this.notify(
                  MediaPlayer.dependencies.MediaController.eventList
                    .CURRENT_TRACK_CHANGED,
                  { oldMediaInfo: i, newMediaInfo: a, switchMode: c[b] }
                );
            var j = f.call(this, a);
            j &&
              d[h][b].storeLastSettings &&
              (j.roles && ((j.role = j.roles[0]), delete j.roles),
              j.accessibility && (j.accessibility = j.accessibility[0]),
              j.audioChannelConfiguration &&
                (j.audioChannelConfiguration = j.audioChannelConfiguration[0]),
              e.call(this, b, j));
          }
        }
      },
      ...
      setSwitchMode: function (a, b) {
        ...
        return d
          ? void (c[a] = b)
          : void this.log("track switch mode is not supported: " + b);
      },
      ...
      setSelectionModeForInitialTrack: function (a) {
        var c =
          !!MediaPlayer.dependencies.MediaController.trackSelectionModes[a];
        return c
          ? void (b = a)
          : void this.log("track selection mode is not supported: " + a);
      },
      getSelectionModeForInitialTrack: function () {
        return (
          b ||
      ...
      isTracksEqual: function (a, b) {
        var c = a.id === b.id,
          ...
          h =
            a.audioChannelConfiguration.toString() ==
            b.audioChannelConfiguration.toString();
        return c && d && e && f && g && h;
      },
      reset: function () {
  ...
  (MediaPlayer.dependencies.MediaController.DEFAULT_INIT_TRACK_SELECTION_MODE =
    ...
    return {
      ...
      initialize: function (b) {
        ...
        b.forEach(function (b) {
          try {
            var d = c.system.getObject("metricsController");
            d.initialize(b), a.push(d);
          } catch (e) {}
        });
      },
      reset: function () {
  ...
  (MediaPlayer.dependencies.MetricsController = function () {
    ...
    return {
      ...
      initialize: function (d) {
        try {
          (c = this.system.getObject("rangeController")),
            c.initialize(d.Range),
            (b = this.system.getObject("reportingController")),
            b.initialize(d.Reporting, c),
            (a = this.system.getObject("metricsHandlersController")),
            a.initialize(d.metrics, b);
        } catch (e) {
          throw (this.reset(), e);
        }
      },
      reset: function () {
        a && a.reset(), b && b.reset(), c && c.reset();
      },
    };
  }),
  ...
  (MediaPlayer.dependencies.PlaybackController = function () {
    ...
    var a,
      ...
      k = function (a) {
        var b,
          d = parseInt(this.uriQueryFragModel.getURIFragmentData().s, 10);
        return (
          c
            ? (!isNaN(d) &&
                d > 1262304e3 &&
                ((b = d - a.manifestInfo.availableFrom.getTime() / 1e3),
                (b > f || b < f - a.manifestInfo.DVRWindowSize) && (b = null)),
              (b = b || f))
            : (b = !isNaN(d) && d < a.duration && d >= 0 ? d : a.start),
          b
        );
      },
      l = function (a) {
        return b.getCurrentTime() || k.call(this, a);
      },
      m = function (b) {
        var c,
          d = this,
          e =
            d.metricsModel.getReadOnlyMetricsFor("video") ||
            d.metricsModel.getReadOnlyMetricsFor("audio"),
          f = d.metricsExt.getCurrentDVRInfo(e),
          g = f ? f.range : null;
        return g
          ? b >= g.start && b <= g.end
            ? b
            : (c = Math.max(g.end - 2 * a.manifestInfo.minBufferTime, g.start))
          : NaN;
      },
      n = function () {
        if (null === g) {
      ...
      p = function () {
        if (!i[a.id] && !this.isSeeking()) {
          var b = l.call(this, a);
          this.log("Starting playback at offset: " + b),
            this.notify(
              MediaPlayer.dependencies.PlaybackController.eventList
                .ENAME_PLAYBACK_SEEKING,
              { seekTime: b }
      ...
      r = function (b) {
        if (!b.error) {
          var c = this.adapter.convertDataToTrack(
              this.manifestModel.getValue(),
              b.data.currentRepresentation
            ),
      ...
      t = function () {
        b &&
          (b.unlisten("canplay", u),
          b.unlisten("play", v),
          b.unlisten("playing", w),
          b.unlisten("pause", x),
          b.unlisten("error", F),
          b.unlisten("seeking", y),
          b.unlisten("seeked", z),
          b.unlisten("timeupdate", A),
          b.unlisten("progress", B),
          b.unlisten("ratechange", C),
          b.unlisten("loadedmetadata", D),
          b.unlisten("ended", E));
      },
      u = function () {
        this.notify(
          MediaPlayer.dependencies.PlaybackController.eventList.ENAME_CAN_PLAY
        );
      },
      v = function () {
        this.log("<video> play"),
      ...
      A = function () {
        ...
        a !== e &&
          ...
          this.notify(
            MediaPlayer.dependencies.PlaybackController.eventList
              .ENAME_PLAYBACK_TIME_UPDATED,
            { timeToEnd: this.getTimeToStreamEnd(), time: a }
          ));
      },
      B = function () {
        var c,
          d,
          e,
          f = b.getElement().buffered;
        f.length &&
          ((c = f.length - 1),
          (d = f.end(c)),
          (e = k.call(this, a) + a.duration - d)),
          this.notify(
            MediaPlayer.dependencies.PlaybackController.eventList
              .ENAME_PLAYBACK_PROGRESS,
            { bufferedRanges: f, remainingUnbufferedDuration: e }
          );
      },
      C = function () {
        var a = this.getPlaybackRate();
        this.log("<video> ratechange: ", a),
          this.notify(
            MediaPlayer.dependencies.PlaybackController.eventList
              .ENAME_PLAYBACK_RATE_CHANGED,
            { playbackRate: a }
      ...
      D = function () {
        this.log("<video> loadedmetadata"),
          (!c || this.timelineConverter.isTimeSyncCompleted()) && p.call(this),
          this.notify(
            MediaPlayer.dependencies.PlaybackController.eventList
      ...
      G = function () {
        this.notify(
          MediaPlayer.dependencies.PlaybackController.eventList
            .ENAME_WALLCLOCK_TIME_UPDATED,
          { isDynamic: c, time: new Date() }
        );
      },
      H = function (b) {
        var c,
          d = b.data.bufferedRanges,
          e = a.id,
          f = this.getTime(),
          ...
          m = l.call(this, a),
          n = this.adapter.getFragmentRequestForTime(
            g,
            g.getCurrentRepresentationInfo(),
            m,
            { ignoreIsFinished: !0 }
          ),
          o = n ? n.index : null,
        ...
        b.data.index === o &&
          ...
          (i[e][j] = !0),
          (i[e].ready = !(
            (k.hasMedia("audio") && !i[e].audio) ||
            (k.hasMedia("video") && !i[e].video)
          ))),
          !d ||
            !d.length ||
            (i[e] && i[e].seekCompleted) ||
            ((c = Math.max(d.start(0), a.start)),
            (h[e] = void 0 === h[e] ? c : Math.max(h[e], c)),
            (p === h[e] && f === p) ||
              !i[e] ||
              !i[e].ready ||
              f > h[e] ||
              (this.isSeeking()
                ? (h = {})
                : (this.seek(Math.max(h[e], m)), (i[e].seekCompleted = !0))));
      },
      I = function (c) {
      ...
      J = function () {
        b.listen("canplay", u),
          ...
          b.listen("seeking", y),
          b.listen("seeked", z),
          b.listen("timeupdate", A),
          b.listen("progress", B),
          b.listen("ratechange", C),
          b.listen("loadedmetadata", D),
          b.listen("ended", E);
      };
    return {
      system: void 0,
      ...
      setup: function () {
        (this[
          ...
          (this[
            MediaPlayer.dependencies.BufferController.eventList.ENAME_BYTES_APPENDED
          ] = H),
          (this[
      ...
      initialize: function (d) {
        (b = this.videoModel),
          ...
          t.call(this),
          J.call(this),
          (c = a.manifestInfo.isDynamic),
          (f = d.start);
      },
      getStreamStartTime: k,
      getInitialTime: l,
      getTimeToStreamEnd: function () {
        var c = b.getCurrentTime();
        return k.call(this, a) + a.duration - c;
      },
      ...
      getLiveDelay: function (b) {
        var c,
          e = this.manifestExt.getMpd(this.manifestModel.getValue());
        return (c =
          d && e.hasOwnProperty("suggestedPresentationDelay")
            ? e.suggestedPresentationDelay
            : isNaN(b)
            ? 2 * a.manifestInfo.minBufferTime
            : b * j);
      },
      start: function () {
        b.play();
      ...
      seek: function (a) {
        b &&
          a !== this.getTime() &&
          (this.log("Do seek: " + a), b.setCurrentTime(a));
      },
      reset: function () {
        o.call(this),
          t.call(this),
  ...
  (MediaPlayer.dependencies.ProtectionController = function () {
    ...
    var a,
      ...
      h = function (c, d) {
        var f = this,
          g = [],
          h = [];
        b && h.push(new MediaPlayer.vo.protection.MediaCapability(b.codec)),
          a && g.push(new MediaPlayer.vo.protection.MediaCapability(a.codec));
        var i,
          j = new MediaPlayer.vo.protection.KeySystemConfiguration(
            g,
            h,
            "optional",
            "temporary" === f.sessionType ? "optional" : "required",
            [f.sessionType]
          ),
          k = [];
        if (this.keySystem) {
          for (i = 0; i < c.length; i++)
            if (this.keySystem === c[i].ks) {
              ...
              var l = {};
              (l[
                MediaPlayer.models.ProtectionModel.eventList.ENAME_KEY_SYSTEM_ACCESS_COMPLETE
              ] = function (a) {
                a.error
                  ? d ||
                    f.eventBus.dispatchEvent({
                      type: MediaPlayer.dependencies.ProtectionController.events
                        .KEY_SYSTEM_SELECTED,
                      error: "DRM: KeySystem Access Denied! -- " + a.error,
                    })
                  : (f.log("KeySystem Access Granted"),
                    f.eventBus.dispatchEvent({
                      type: MediaPlayer.dependencies.ProtectionController.events
                        .KEY_SYSTEM_SELECTED,
                      data: a.data,
                ...
                this.protectionModel.subscribe(
                  MediaPlayer.models.ProtectionModel.eventList
                    .ENAME_KEY_SYSTEM_ACCESS_COMPLETE,
                  l,
                  void 0,
                  !0
                ),
                this.protectionModel.requestKeySystemAccess(k);
              break;
            }
        } else if (void 0 === this.keySystem) {
          (this.keySystem = null), e.push(c);
          for (var m = 0; m < c.length; m++)
            k.push({ ks: c[m].ks, configs: [j] });
          var n,
            o = {};
          (o[
            MediaPlayer.models.ProtectionModel.eventList.ENAME_KEY_SYSTEM_ACCESS_COMPLETE
            ...
            a.error
              ? ((f.keySystem = void 0),
                f.protectionModel.unsubscribe(
                  MediaPlayer.models.ProtectionModel.eventList
                    .ENAME_KEY_SYSTEM_SELECTED,
                  o
                ),
                d ||
                  f.eventBus.dispatchEvent({
              ...
              : ((n = a.data),
                f.log(
                  "KeySystem Access Granted (" +
                    n.keySystem.systemString +
                    ")!  Selecting key system..."
                ),
                f.protectionModel.selectKeySystem(n));
          }),
            (o[
              MediaPlayer.models.ProtectionModel.eventList.ENAME_KEY_SYSTEM_SELECTED
            ] = function (a) {
              if (a.error)
                (f.keySystem = void 0),
                  d ||
                ...
                (f.keySystem = f.protectionModel.keySystem),
                  f.eventBus.dispatchEvent({
                    type: MediaPlayer.dependencies.ProtectionController.events
                      .KEY_SYSTEM_SELECTED,
                    data: n,
      ...
      j = function (a) {
        ...
        var c = b.messageType ? b.messageType : "license-request",
          ...
          k = i.bind(this),
          l = { sessionToken: e, messageType: c };
        if (!j)
          return (
            this.log(
        ...
        if (this.protectionExt.isClearKey(this.keySystem)) {
          ...
          if (m)
            return (
              ...
              k(l),
              void this.protectionModel.updateKeySession(e, m)
            );
        }
        ...
        if (f)
          if (f.serverURL) {
            ...
            "string" == typeof q && "" !== q
              ? (p = q)
              : "object" == typeof q && q.hasOwnProperty(c) && (p = q[c]);
          } else f.laURL && "" !== f.laURL && (p = f.laURL);
        else
          (p = this.keySystem.getLicenseServerURLFromInitData(
            MediaPlayer.dependencies.protection.CommonEncryption.getPSSHData(
              e.initData
            )
          )),
            p || (p = a.data.laURL);
        if (((p = j.getServerURLFromMessage(p, d, c)), !p))
          return void k(l, "DRM: No license server URL specified!");
        n.open(j.getHTTPMethod(c), p, !0),
          (n.responseType = j.getResponseType(h, c)),
          (n.onload = function () {
            200 == this.status
              ? (k(l),
                o.protectionModel.updateKeySession(
                  e,
                  j.getLicenseMessage(this.response, h, c)
                ))
              : k(
                  l,
                  "DRM: " +
                    h +
                    ' update, XHR status is "' +
                    this.statusText +
                    '" (' +
                    this.status +
                    ...
                    ".  Response is " +
                    (this.response
                      ? j.getErrorResponse(this.response, h, c)
                      : "NONE")
                );
          }),
          (n.onabort = function () {
        ...
        var r = function (a) {
          ...
          if (a)
            for (b in a)
              "authorization" === b.toLowerCase() && (n.withCredentials = !0),
                n.setRequestHeader(b, a[b]);
        };
        f && r(f.httpRequestHeaders),
          r(this.keySystem.getRequestHeadersFromMessage(d)),
          f && f.withCredentials && (n.withCredentials = !0),
          n.send(this.keySystem.getLicenseRequestFromMessage(d));
      },
      k = function (a) {
        if ("cenc" !== a.data.initDataType)
        ...
        return 0 === c.length
          ? void this.log(
              "Received needkey event with initData, but we don't support any of the key systems!"
            )
          : void h.call(this, c, !1);
      },
      l = function (a) {
        a.error
          ? this.eventBus.dispatchEvent({
              ...
              data: null,
              error:
                "DRM: Failed to update license server certificate. -- " +
                a.error,
            })
      ...
      m = function (a) {
        a.error
          ...
          : (this.log(
              "DRM: Session created.  SessionID = " + a.data.getSessionID()
            ),
            this.eventBus.dispatchEvent({
              type: MediaPlayer.dependencies.ProtectionController.events
                .KEY_SESSION_CREATED,
      ...
      o = function (a) {
        this.eventBus.dispatchEvent({
          ...
          error:
            ...
            a.data.sessionToken.getSessionID() +
            ".  " +
            a.data.error,
        });
      },
      p = function (a) {
        a.error
          ...
          : (this.log("DRM: Session closed.  SessionID = " + a.data),
            this.eventBus.dispatchEvent({
              type: MediaPlayer.dependencies.ProtectionController.events
                .KEY_SESSION_CLOSED,
              data: a.data,
      ...
      q = function (a) {
        a.error
          ...
          : (this.log("DRM: Session removed.  SessionID = " + a.data),
            this.eventBus.dispatchEvent({
              type: MediaPlayer.dependencies.ProtectionController.events
                .KEY_SESSION_REMOVED,
              data: a.data,
    ...
    return {
      ...
      setup: function () {
        (this[MediaPlayer.models.ProtectionModel.eventList.ENAME_KEY_MESSAGE] =
          j.bind(this)),
          (this[MediaPlayer.models.ProtectionModel.eventList.ENAME_NEED_KEY] =
            k.bind(this)),
          (this[
            MediaPlayer.models.ProtectionModel.eventList.ENAME_SERVER_CERTIFICATE_UPDATED
          ] = l.bind(this)),
          (this[MediaPlayer.models.ProtectionModel.eventList.ENAME_KEY_ADDED] =
            n.bind(this)),
          (this[MediaPlayer.models.ProtectionModel.eventList.ENAME_KEY_ERROR] =
            o.bind(this)),
          (this[
            MediaPlayer.models.ProtectionModel.eventList.ENAME_KEY_SESSION_CREATED
          ] = m.bind(this)),
          (this[
            MediaPlayer.models.ProtectionModel.eventList.ENAME_KEY_SESSION_CLOSED
          ] = p.bind(this)),
          (this[
            MediaPlayer.models.ProtectionModel.eventList.ENAME_KEY_SESSION_REMOVED
          ] = q.bind(this)),
          (this[
            MediaPlayer.models.ProtectionModel.eventList.ENAME_KEY_STATUSES_CHANGED
          ] = r.bind(this)),
          (d = this.protectionExt.getKeySystems()),
          ...
          this.protectionModel.subscribe(
            MediaPlayer.models.ProtectionModel.eventList.ENAME_KEY_ADDED,
            this
          ),
          this.protectionModel.subscribe(
            MediaPlayer.models.ProtectionModel.eventList.ENAME_KEY_ERROR,
            this
          ),
          this.protectionModel.subscribe(
            MediaPlayer.models.ProtectionModel.eventList
              .ENAME_KEY_SESSION_CREATED,
            this
          ),
          this.protectionModel.subscribe(
            MediaPlayer.models.ProtectionModel.eventList
              .ENAME_KEY_SESSION_CLOSED,
            this
          ),
          this.protectionModel.subscribe(
            MediaPlayer.models.ProtectionModel.eventList
              .ENAME_KEY_SESSION_REMOVED,
            this
          ),
          this.protectionModel.subscribe(
            MediaPlayer.models.ProtectionModel.eventList.ENAME_KEY_MESSAGE,
            this
          ),
          this.protectionModel.subscribe(
            MediaPlayer.models.ProtectionModel.eventList
      ...
      init: function (c, d, e) {
        if (!f) {
          ...
          d ||
            e ||
            ((g = this.system.getObject("adapter")),
            (i = g.getStreamsInfo(c)[0])),
            (a = d || (i ? g.getMediaInfoForType(c, i, "audio") : null)),
            (b = e || (i ? g.getMediaInfoForType(c, i, "video") : null));
          var j = b ? b : a,
            k = this.protectionExt.getSupportedKeySystemsFromContentProtection(
              j.contentProtection
            );
      ...
      teardown: function () {
        this.setMediaElement(null),
          this.protectionModel.unsubscribe(
            MediaPlayer.models.ProtectionModel.eventList.ENAME_KEY_MESSAGE,
            this
          ),
          this.protectionModel.unsubscribe(
          ...
          (this.protectionModel = void 0);
      },
      createKeySession: function (a) {
        var b =
          MediaPlayer.dependencies.protection.CommonEncryption.getPSSHForKeySystem(
            this.keySystem,
            a
          );
        if (b) {
          for (
            var c = this.protectionModel.getAllInitData(), d = 0;
            d < c.length;
            d++
          )
            if (this.protectionExt.initDataEquals(b, c[d]))
              return void this.log(
                "Ignoring initData because we have already seen it!"
              );
          try {
      ...
      setMediaElement: function (a) {
        a
          ? (this.protectionModel.setMediaElement(a),
            this.protectionModel.subscribe(
              MediaPlayer.models.ProtectionModel.eventList.ENAME_NEED_KEY,
              this
            ))
          : null === a &&
            (this.protectionModel.setMediaElement(a),
  ...
  (MediaPlayer.dependencies.ScheduleController = function () {
    ...
    var a,
      ...
      p = function (a) {
        i || ((i = !0), this.log("stop"), a && c.cancelPendingRequests());
      },
      q = function (a) {
        var b = this,
          c = b.scheduleRulesCollection.getRules(
            MediaPlayer.rules.ScheduleRulesCollection.prototype
              .NEXT_FRAGMENT_RULES
          );
        b.rulesController.applyRules(
          c,
          b.streamProcessor,
          a,
          null,
      ...
      r = function (a) {
        var b,
          d = this;
        return (
          (b = d.adapter.getInitRequest(d.streamProcessor, a)),
          null !== b && d.fragmentController.prepareFragmentForLoading(c, b),
          b
        );
      },
      s = function (a) {
      ...
      t = function (a) {
        ...
        for (f = 0; g > f; f += 1)
          (b = a[f]),
            (d = b.startTime + b.duration / 2 + h),
            (b = this.adapter.getFragmentRequestForTime(
              this.streamProcessor,
              e,
              d,
              { timeThreshold: 0, ignoreIsFinished: !0 }
            )),
      ...
      u = function (a) {
        ...
        return (
          (f = a.value),
          0 >= f
            ? void b.fragmentController.executePendingRequests()
      ...
      v = function (a) {
        var b = a.value;
        null === b ||
          b instanceof MediaPlayer.vo.FragmentRequest ||
          (b = this.adapter.getFragmentRequestForTime(
            this.streamProcessor,
            e,
            b.startTime
          ...
          b
            ? (f--, this.fragmentController.prepareFragmentForLoading(c, b))
      ...
      w = function () {
        ...
        this.abrController.getPlaybackQuality(this.streamProcessor),
          !b ||
            i ||
            (this.playbackController.isPaused() &&
              this.playbackController.getPlayedRanges().length > 0 &&
              (!this.scheduleWhilePaused || d)) ||
            ((h = a), s.call(this, u.bind(this)));
      },
      x = function (a) {
        a.error ||
          (e = this.adapter.convertDataToTrack(
            this.manifestModel.getValue(),
            a.data.currentRepresentation
          ));
      },
      y = function (a) {
        a.error ||
          ((e = this.streamProcessor.getCurrentRepresentationInfo()),
          (d && null === this.liveEdgeFinder.getLiveEdge()) || (b = !0),
          b && o.call(this));
      },
      z = function (a) {
        a.data.fragmentModel === this.streamProcessor.getFragmentModel() &&
      ...
      E = function (a) {
        c.removeExecutedRequestsBeforeTime(a.data.to),
          a.data.hasEnoughSpaceToAppend && w.call(this);
      },
      F = function (a) {
        var b = this;
        a.data.hasSufficientBuffer ||
          b.playbackController.isSeeking() ||
          (b.log("Stalling Buffer"),
          m.call(
            this,
            new Date(),
      ...
      I = function (b) {
        if (
          a === b.data.mediaType &&
          this.streamProcessor.getStreamInfo().id === b.data.streamInfo.id
        ) {
          var d,
            f = this;
          if (
            ((d = c.cancelPendingRequests(b.data.oldQuality)),
            (e = f.streamProcessor.getRepresentationInfoForQuality(
              b.data.newQuality
            )),
            null === e || void 0 === e)
          )
      ...
      J = function () {
        j &&
          ...
          e &&
          ((l = !1),
          (k = new MediaPlayer.vo.metrics.PlayList.Trace()),
          (k.representationid = e.id),
          (k.start = new Date()),
          (k.mstart = 1e3 * this.playbackController.getTime()),
          (k.playbackspeed = this.playbackController
            .getPlaybackRate()
            .toString()));
      },
      K = function (a) {
      ...
      M = function (a) {
        ...
        this.log("seek: " + a.data.seekTime),
          this.metricsModel.updateManifestUpdateInfo(d, {
            latency: e.DVRWindow.end - this.playbackController.getTime(),
          });
      },
      N = function (a) {
        k && (k.playbackspeed = a.data.playbackRate.toString());
      },
      O = function () {
        w.call(this);
      },
        ...
        if (!a.error) {
          var c,
            ...
            i =
              g -
              Math.min(
                f.playbackController.getLiveDelay(e.fragmentDuration),
                h.DVRWindowSize / 2
              ),
          ...
          (c = f.adapter.getFragmentRequestForTime(f.streamProcessor, e, i, {
            ...
            (d = c.startTime),
            (isNaN(l) || d > l) && f.playbackController.setLiveStartTime(d),
            f.metricsModel.updateManifestUpdateInfo(k, {
              currentTime: d,
    ...
    return {
      ...
      setup: function () {
        (this[
          ...
          (this[
            Dash.dependencies.RepresentationController.eventList.ENAME_DATA_UPDATE_STARTED
          ] = C),
          (this[
            Dash.dependencies.RepresentationController.eventList.ENAME_DATA_UPDATE_COMPLETED
          ] = x),
          ...
          (this[
            MediaPlayer.dependencies.BufferController.eventList.ENAME_BUFFER_CLEARED
          ] = E),
          (this[
            MediaPlayer.dependencies.BufferController.eventList.ENAME_BUFFER_LEVEL_STATE_CHANGED
          ] = F),
          ...
          (this[
            MediaPlayer.dependencies.BufferController.eventList.ENAME_INIT_REQUESTED
          ] = D),
          (this[
            MediaPlayer.dependencies.BufferController.eventList.ENAME_QUOTA_EXCEEDED
          ] = H),
          (this[
            MediaPlayer.dependencies.TextController.eventList.ENAME_CLOSED_CAPTIONING_REQUESTED
          ] = K),
          (this[
            MediaPlayer.dependencies.PlaybackController.eventList.ENAME_PLAYBACK_STARTED
          ] = L),
      ...
      initialize: function (b, e) {
        ...
        (a = b),
          f.setMediaType(a),
          (f.streamProcessor = e),
          (f.fragmentController = e.fragmentController),
          (f.liveEdgeFinder = e.liveEdgeFinder),
          (f.bufferController = e.bufferController),
          (d = e.isDynamic()),
          (c = this.fragmentController.getModel(this)),
          (MediaPlayer.dependencies.ScheduleController.LOADING_REQUEST_THRESHOLD =
            f.numOfParallelRequestAllowed),
          f.scheduleRulesCollection.bufferLevelRule &&
            f.scheduleRulesCollection.bufferLevelRule.setScheduleController(f),
          f.scheduleRulesCollection.pendingRequestsRule &&
            f.scheduleRulesCollection.pendingRequestsRule.setScheduleController(
              f
            ),
          f.scheduleRulesCollection.playbackTimeRule &&
            f.scheduleRulesCollection.playbackTimeRule.setScheduleController(f);
      },
      getFragmentModel: function () {
        return c;
      },
      ...
      reset: function () {
        ...
        p.call(a, !0),
          c.abortRequests(),
          a.fragmentController.detachModel(c),
          (f = 0),
          (j = null);
      },
      ...
      finalisePlayList: function (a, b) {
        m.call(this, a, b), (j = null);
      },
      start: n,
      stop: p,
    };
    ...
    var a,
      ...
      r = function (b, c) {
        (c = c || new Date()),
          q &&
            (a &&
              a.getProcessors().forEach(function (a) {
                var d = a.getScheduleController();
                d && d.finalisePlayList(c, b);
              }),
            this.metricsModel.addPlayList(q),
            (q = null));
      },
      s = function (b) {
        (q = new MediaPlayer.vo.metrics.PlayList()),
          (q.start = new Date()),
          (q.mstart = 1e3 * this.playbackController.getTime()),
          (q.starttype = b),
          a &&
            a.getProcessors().forEach(function (a) {
      ...
      w = function () {
        a.isActivated() &&
          k &&
          0 === a.getStreamInfo().index &&
          (a.startEventController(), j && this.playbackController.start());
      },
      x = function () {
        k = !0;
      },
      y = function (a) {
        ...
        if (-1 !== b) {
          ...
          (n = !0),
            this.log("Video Element Error: " + c),
            a.error && this.log(a.error),
      ...
      z = function (a) {
        ...
        c && b.metricsModel.addDroppedFrames("video", c),
          b.playbackController.isSeeking() ||
            (a.data.timeToEnd < i && this.mediaSourceExt.signalEndOfStream(d));
      },
      A = function () {
        var b = F();
        H.call(this, a, b),
      ...
      B = function (b) {
        var c = G(b.data.seekTime);
        c && c !== a
          ? (r.call(
              this,
              MediaPlayer.vo.metrics.PlayList.Trace.END_OF_PERIOD_STOP_REASON
            ),
            H.call(this, a, c, b.data.seekTime))
          : r.call(
              this,
              MediaPlayer.vo.metrics.PlayList.Trace.USER_REQUEST_STOP_REASON
            ),
          s.call(this, MediaPlayer.vo.metrics.PlayList.SEEK_START_REASON);
      },
      C = function () {
        o
          ? ((o = !1),
            s.call(
              this,
              MediaPlayer.vo.metrics.PlayList.INITIAL_PLAYOUT_START_REASON
            ))
          : p &&
            ((p = !1),
            s.call(
              this,
              MediaPlayer.vo.metrics.PlayList.RESUME_FROM_PAUSE_START_REASON
            ));
      },
      D = function (a) {
        a.data.ended ||
      ...
      H = function (b, c, d) {
        if (!l && b && c && b !== c) {
          v.call(this, MediaPlayer.events.STREAM_SWITCH_STARTED, b, c),
            (l = !0);
          var e = this,
            f = function () {
              void 0 !== d && e.playbackController.seek(d),
                e.playbackController.start(),
                a.startEventController(),
                (l = !1),
                v.call(e, MediaPlayer.events.STREAM_SWITCH_COMPLETED, b, c);
            };
          setTimeout(function () {
            u.call(e, b),
              b.deactivate(),
              (a = c),
              t.call(e, c),
              e.playbackController.initialize(a.getStreamInfo()),
              I.call(e, f);
          }, 0);
        }
      },
      I = function (b) {
        var c,
          e = this,
          f = function (g) {
            e.log("MediaSource is open!"),
              e.log(g),
              window.URL.revokeObjectURL(c),
              d.removeEventListener("sourceopen", f),
              d.removeEventListener("webkitsourceopen", f),
              J.call(e),
              a.activate(d),
              b && b();
          };
        d
          ? e.mediaSourceExt.detachMediaSource(e.videoModel)
          : (d = e.mediaSourceExt.createMediaSource()),
          d.addEventListener("sourceopen", f, !1),
          d.addEventListener("webkitsourceopen", f, !1),
          (c = e.mediaSourceExt.attachMediaSource(d, e.videoModel));
      },
      J = function () {
        var b,
          c,
          e = this;
        (b = a.getStreamInfo().manifestInfo.duration),
          (c = e.mediaSourceExt.setDuration(d, b)),
          e.log("Duration successfully set to: " + c);
      },
      K = function () {
        var e,
          f,
          ...
          n,
          o = this,
          p = o.manifestModel.getValue(),
          q = o.metricsModel.getMetricsFor("stream"),
          r = o.metricsExt.getCurrentManifestUpdate(q),
          s = [];
        if (p) {
          (l = o.adapter.getStreamsInfo(p)),
            this.capabilities.supportsEncryptedMedia() &&
              (b ||
                ((b = this.system.getObject("protectionController")),
                this.eventBus.dispatchEvent({
                  type: MediaPlayer.events.PROTECTION_CREATED,
                  data: { controller: b, manifest: p },
                }),
                (h = !0)),
              b.setMediaElement(this.videoModel.getElement()),
              c && b.setProtectionData(c));
          try {
            if (0 === l.length) throw new Error("There are no streams");
            for (
              o.metricsModel.updateManifestUpdateInfo(r, {
                currentTime: o.videoModel.getCurrentTime(),
                buffered: o.videoModel.getElement().buffered,
                presentationStartTime: l[0].start,
                clientTimeOffset: o.timelineConverter.getClientTimeOffset(),
              }),
                m = !0,
                j = 0,
                f = l.length;
              ...
              for (e = l[j], k = 0, i = g.length; i > k; k += 1)
                g[k].getId() === e.id &&
                  ((n = g[k]), s.push(n), n.updateData(e));
              n ||
                ((n = o.system.getObject("stream")),
                n.initialize(e, b, c),
                n.subscribe(
                  MediaPlayer.dependencies.Stream.eventList
                    .ENAME_STREAM_UPDATED,
                  o
                ),
                s.push(n),
                a && n.updateData(e)),
                o.metricsModel.addManifestUpdateStreamInfo(
                  r,
                  e.id,
                  e.index,
                  e.start,
            ...
            (g = s),
              a ||
                ((a = g[0]),
                v.call(o, MediaPlayer.events.STREAM_SWITCH_STARTED, null, a),
                o.playbackController.initialize(a.getStreamInfo()),
                t.call(o, a),
                v.call(o, MediaPlayer.events.STREAM_SWITCH_COMPLETED, null, a)),
              d || I.call(this),
              (m = !1),
              L.call(o);
          } catch (u) {
            o.errHandler.manifestError(u.message, "nostreamscomposed", p),
              o.reset(!0);
          }
        }
      },
      L = function () {
        if (!m) {
          var a = this,
            b = g.length,
            c = 0;
          for (w.call(this), c; b > c; c += 1)
            if (!g[c].isInitialized()) return;
          a.notify(
            MediaPlayer.dependencies.StreamController.eventList
              .ENAME_STREAMS_COMPOSED
          );
        }
      },
      M = function () {
      ...
      O = function (a) {
        var b = this;
        if (a.error) this.reset(!0);
        else {
          var c = a.data.manifest;
          if ("dynamic" === a.data.manifest.type) {
            var d,
              g,
              h = b.adapter.getStreamsInfo(c)[0],
              i =
                b.adapter.getMediaInfoForType(c, h, "video") ||
                b.adapter.getMediaInfoForType(c, h, "audio");
            i &&
              ((d = b.adapter.getDataForMedia(i)),
              (g = b.manifestExt.getRepresentationsForAdaptation(c, d)[0]
            ...
            var j = b.manifestExt.getUTCTimingSources(a.data.manifest),
              k = !b.manifestExt.getIsDynamic(c) || g ? j : j.concat(e),
              l = b.uriQueryFragModel.isManifestHTTPS();
            k.forEach(function (a) {
              a.value.replace(/.*?:\/\//g, "") ===
                MediaPlayer.UTCTimingSources["default"].value.replace(
                  /.*?:\/\//g,
                  ""
                ) &&
          ...
          this.metricsCollectionController.initialize(
            this.manifestExt.getMetrics(c)
          );
        }
      };
    return {
      ...
      unsubscribe: void 0,
      uriQueryFragModel: void 0,
      metricsCollectionController: void 0,
      setup: function () {
        (this[
          MediaPlayer.dependencies.ManifestUpdater.eventList.ENAME_MANIFEST_UPDATED
        ] = O),
          (this[
            MediaPlayer.dependencies.Stream.eventList.ENAME_STREAM_UPDATED
          ] = M),
          (this[
            MediaPlayer.dependencies.Stream.eventList.ENAME_STREAM_BUFFERING_COMPLETED
          ] = E),
          (this[
            MediaPlayer.dependencies.PlaybackController.eventList.ENAME_PLAYBACK_SEEKING
          ] = B),
          ...
          (this[
            MediaPlayer.dependencies.PlaybackController.eventList.ENAME_PLAYBACK_ENDED
          ] = A),
          (this[
            MediaPlayer.dependencies.TimeSyncController.eventList.ENAME_TIME_SYNCHRONIZATION_COMPLETED
          ] = N),
          ...
          (this[
            MediaPlayer.dependencies.PlaybackController.eventList.ENAME_PLAYBACK_ERROR
          ] = y),
          (this[
            MediaPlayer.dependencies.PlaybackController.eventList.ENAME_PLAYBACK_STARTED
          ] = C),
      ...
      initialize: function (a, d, e) {
        (j = a),
          (b = d),
          (c = e),
          this.timeSyncController.subscribe(
            MediaPlayer.dependencies.TimeSyncController.eventList
              .ENAME_TIME_SYNCHRONIZATION_COMPLETED,
            this.timelineConverter
          ),
          ...
          this.playbackController.subscribe(
            MediaPlayer.dependencies.PlaybackController.eventList
              .ENAME_PLAYBACK_STARTED,
            this.manifestUpdater
          ),
          this.playbackController.subscribe(
            MediaPlayer.dependencies.PlaybackController.eventList
              .ENAME_PLAYBACK_PAUSED,
          ...
          this.manifestUpdater.subscribe(
            MediaPlayer.dependencies.ManifestUpdater.eventList
              .ENAME_MANIFEST_UPDATED,
            this
          ),
      ...
      reset: function (e) {
        ...
        var f,
          i = this.system.getObject("mediaController");
        this.timeSyncController.unsubscribe(
          MediaPlayer.dependencies.TimeSyncController.eventList
            .ENAME_TIME_SYNCHRONIZATION_COMPLETED,
          this.timelineConverter
        ),
        ...
        (g = []),
          ...
          this.playbackController.unsubscribe(
            MediaPlayer.dependencies.PlaybackController.eventList
              .ENAME_PLAYBACK_STARTED,
            this.manifestUpdater
          ),
        ...
        var s = this.manifestModel.getValue()
          ? this.manifestModel.getValue().url
          : null;
        if (
          ...
          if (h) {
            var t = {},
              v = this;
            (t[
              MediaPlayer.models.ProtectionModel.eventList.ENAME_TEARDOWN_COMPLETE
            ] = function () {
              (h = !1),
                (b = null),
                (c = null),
                s &&
                  v.eventBus.dispatchEvent({
  ...
  (MediaPlayer.dependencies.TextController = function () {
    var a = !1,
      ...
      f = function (a) {
        ...
        a.data.fragmentModel === b.streamProcessor.getFragmentModel() &&
          a.data.chunk.bytes &&
          b.sourceBufferExt.append(c, a.data.chunk);
      };
    return {
      sourceBufferExt: void 0,
      log: void 0,
      ...
      initialize: function (a, b, c) {
        ...
        (d = a),
          e.setMediaSource(b),
          (e.representationController = c.representationController),
          (e.streamProcessor = c);
      },
      createBuffer: function (e) {
        try {
          (c = this.sourceBufferExt.createSourceBuffer(b, e)),
            a ||
              (c.hasOwnProperty("initialize") && c.initialize(d, this),
              (a = !0));
        } catch (f) {
          this.errHandler.mediaSourceError(
            "Error creating " + d + " source buffer."
          );
        }
        return c;
      },
      ...
      reset: function (a) {
        a ||
          (this.sourceBufferExt.abort(b, c),
          this.sourceBufferExt.removeSourceBuffer(b, c));
      },
    };
  }),
    ...
    var a,
      ...
      l = function (a, b, c) {
        ...
        for (
          h.elements = a,
            h.type = b,
            h.resolveType = c,
            0 === h.elements.length && n.call(g, h),
            f = 0;
          f < h.elements.length;
          f += 1
        )
          (d = h.elements[f]),
            (e =
              -1 !== d.url.indexOf("http://")
                ? d.url
                : d.originalContent.BaseURL + d.url),
            g.xlinkLoader.load(e, d, h);
      },
      m = function (a) {
        var b,
          c,
          ...
          h = "";
        (b = a.data.element),
          (c = a.data.resolveObject),
          b.resolvedContent &&
            ((e = b.resolvedContent.indexOf(">") + 1),
            (h =
              b.resolvedContent.substr(0, e) +
              f +
              b.resolvedContent.substr(e) +
              g),
            (b.resolvedContent = d.xml_str2json(h))),
          r.call(this, c) && n.call(this, c);
      },
      n = function (a) {
        var b,
          d,
        ...
        if (
          ...
          switch (a.type) {
            case g:
              for (b = 0; b < c[g + "_asArray"].length; b++)
                (d = c[g + "_asArray"][b]),
                  d.hasOwnProperty(h + "_asArray") &&
                    (j = j.concat(o.call(this, d[h + "_asArray"], d, h, e))),
                  d.hasOwnProperty(i + "_asArray") &&
                    (j = j.concat(o.call(this, d[i + "_asArray"], d, i, e)));
              l.call(this, j, h, e);
              break;
            case h:
              this.notify(
      ...
      o = function (a, b, c, d) {
        ...
        for (f = a.length - 1; f >= 0; f -= 1)
          (e = a[f]),
            e.hasOwnProperty("xlink:href") &&
              e["xlink:href"] === j &&
              a.splice(f, 1);
        for (f = 0; f < a.length; f++)
          (e = a[f]),
            e.hasOwnProperty("xlink:href") &&
              e.hasOwnProperty("xlink:actuate") &&
              e["xlink:actuate"] === d &&
              ((g = q(e["xlink:href"], b, c, f, d, e)), h.push(g));
        return h;
      },
      p = function (a) {
        var d,
        ...
        for (g = a.elements.length - 1; g >= 0; g--) {
          if (
            ...
            delete d.originalContent["xlink:actuate"],
              delete d.originalContent["xlink:href"],
              j.push(d.originalContent);
          else if (d.resolvedContent)
            for (h = 0; h < d.resolvedContent[e].length; h++)
              (f = d.resolvedContent[e][h]), j.push(f);
          for (d.parentElement[e].splice(d.index, 1), i = 0; i < j.length; i++)
            d.parentElement[e].splice(d.index + i, 0, j[i]);
          j = [];
        }
  ...
  (MediaPlayer.dependencies.ProtectionExtensions = function () {
    ...
    (this.system = void 0),
      ...
      (this.clearkeyKeySystem = void 0);
  }),
  (MediaPlayer.dependencies.ProtectionExtensions.prototype = {
    constructor: MediaPlayer.dependencies.ProtectionExtensions,
    setup: function () {
      var a;
      (a = this.system.getObject("ksPlayReady")),
        this.keySystems.push(a),
        (a = this.system.getObject("ksWidevine")),
        this.keySystems.push(a),
        (a = this.system.getObject("ksClearKey")),
        this.keySystems.push(a),
        (this.clearkeyKeySystem = a);
    },
    ...
    initDataEquals: function (a, b) {
      if (a.byteLength === b.byteLength) {
        for (
          var c = new Uint8Array(a), d = new Uint8Array(b), e = 0;
          e < c.length;
          e++
        )
          if (c[e] !== d[e]) return !1;
    ...
    getSupportedKeySystems: function (a) {
      var b,
        c = [],
        d =
          MediaPlayer.dependencies.protection.CommonEncryption.parsePSSHList(a);
      for (b = 0; b < this.keySystems.length; ++b)
        this.keySystems[b].uuid in d &&
          c.push({
    ...
    getLicenseServer: function (a, b, c) {
      if ("license-release" === c || "individualization-request" == c)
        return null;
      var d = null;
      return (
        b && b.hasOwnProperty("drmtoday")
          ? (d = this.system.getObject("serverDRMToday"))
          : "com.widevine.alpha" === a.systemString
          ? (d = this.system.getObject("serverWidevine"))
          : "com.microsoft.playready" === a.systemString
          ? (d = this.system.getObject("serverPlayReady"))
          : "org.w3.clearkey" === a.systemString &&
            (d = this.system.getObject("serverClearKey")),
        d
      );
    },
    processClearKeyLicenseRequest: function (a, b) {
      try {
        return MediaPlayer.dependencies.protection.KeySystem_ClearKey.getClearKeysFromProtectionData(
          a,
          b
        );
      } catch (c) {
        return (
          this.log("Failed to retrieve clearkeys from ProtectionData"), null
        );
      }
    },
  }),
  ...
  (MediaPlayer.dependencies.SourceBufferExtensions.prototype = {
    ...
    createSourceBuffer: function (a, b) {
      ...
      var c = this,
        ...
        e = null;
      try {
        if (d.match(/application\/mp4;\s*codecs="stpp"/i))
    ...
    getRangeDifference: function (a, b) {
      ...
      var c,
        ...
        j,
        k,
        l = this.getAllRanges(b);
      if (!l) return null;
      for (var m = 0, n = l.length; n > m; m += 1) {
        if (
          ((j = a.length > m),
          (g = j ? { start: a.start(m), end: a.end(m) } : null),
          (c = l.start(m)),
          (d = l.end(m)),
          !g)
        )
          return (k = { start: c, end: d });
        if (((e = g.start === c), (f = g.end === d), !e || !f)) {
          if (e) k = { start: g.end, end: d };
          else {
          ...
          return (
            (h =
              a.length > m + 1
                ? { start: a.start(m + 1), end: a.end(m + 1) }
                : null),
            (i =
              n > m + 1 ? { start: l.start(m + 1), end: l.end(m + 1) } : null),
            !h ||
              (i && i.start === h.start && i.end === h.end) ||
              (k.end = h.start),
            k
          );
        }
  ...
  (MediaPlayer.utils.TextTrackExtensions = function () {
    ...
    return {
      ...
      setup: function () {
        (a = window.VTTCue || window.TextTrackCue),
          ...
          void 0 !== document.fullscreenElement
            ...
            : document.mozFullScreen && (n = "mozFullScreen");
      },
      ...
      addTextTrack: function (a, f) {
        if ((c.push(a), void 0 === b && (b = a.video), c.length === f)) {
          ...
          for (var g = 0, h = 0; h < c.length; h++) {
            ...
            (e = h),
              d.push(i),
              c[h].defaultTrack && ((i["default"] = !0), (g = h)),
              l || b.appendChild(i);
            var k = b.textTracks[h];
            j && c[h].isTTML
              ? (k.renderingType = "html")
              : (k.renderingType = "default"),
              this.addCaptions(0, c[h].captionData),
              this.eventBus.dispatchEvent({
                type: MediaPlayer.events.TEXT_TRACK_ADDED,
              });
          }
          this.setCurrentTrackIdx(g),
            this.eventBus.dispatchEvent({
      ...
      getVideoVisibleVideoSize: function (a, b, c, d) {
        ...
        return (
          e > f
            ? ((j = b), (i = (j / d) * c), (g = (a - i) / 2), (h = 0))
            : ((i = a), (j = (i / c) * d), (g = 0), (h = (b - j) / 2)),
          { x: g, y: h, w: i, h: j }
        );
      },
      checkVideoSize: function () {
        ...
        if (a && "html" === a.renderingType) {
          if ("showing" !== a.mode) return;
          var c = b.clientWidth,
            d = b.clientHeight,
            e = this.getVideoVisibleVideoSize(
              b.clientWidth,
              b.clientHeight,
              b.videoWidth,
              b.videoHeight
        ...
        if (a.linePadding)
          for (b in a.linePadding)
            if (a.linePadding.hasOwnProperty(b)) {
              ...
              c = (j * g[0]).toString();
              for (
                var k = document.getElementsByClassName("spanPadding"), l = 0;
                l < k.length;
                l++
              )
                (k[l].style.cssText = k[l].style.cssText.replace(
          ...
          for (b in a.fontSize)
            if (a.fontSize.hasOwnProperty(b)) {
              ...
              for (var n = 0; n < d.length; n++)
                d[n].style.cssText = d[n].style.cssText.replace(
        ...
        if (a.lineHeight)
          for (b in a.lineHeight)
            if (a.lineHeight.hasOwnProperty(b)) {
              ...
              (c = (o * g[1]).toString()),
                (d = document.getElementsByClassName(b));
              for (var p = 0; p < d.length; p++)
                d[p].style.cssText = d[p].style.cssText.replace(
      ...
      addCaptions: function (d, l) {
        ...
        if (m) {
          ...
          for (var n in l) {
            ...
            k ||
              "html" != p.type ||
              (k = setInterval(this.checkVideoSize.bind(this), 500)),
              "image" == p.type
                ? ((o = new a(p.start - d, p.end - d, "")),
                  (o.image = p.data),
                  (o.id = p.id),
                  (o.size = 0),
                  (o.type = "image"),
                  (o.onenter = function () {
                    var a = new Image();
                    (a.id = "ttmlImage_" + this.id),
                      (a.src = this.image),
                      (a.className = "cue-image"),
                      j ? j.appendChild(a) : b.parentNode.appendChild(a);
                  }),
                  (o.onexit = function () {
                    var a, c, d;
                    for (
                      a = j ? j : b.parentNode, d = a.childNodes, c = 0;
                      c < d.length;
                      c++
                    )
                      d[c].id == "ttmlImage_" + this.id && a.removeChild(d[c]);
                  }))
                : "html" === p.type
                ? ((o = new a(p.start - d, p.end - d, "")),
                  (o.cueHTMLElement = p.cueHTMLElement),
                  (o.regions = p.regions),
                  (o.regionID = p.regionID),
                  (o.cueID = p.cueID),
                  (o.videoWidth = p.videoWidth),
                  (o.videoHeight = p.videoHeight),
                  (o.cellResolution = p.cellResolution),
                  (o.fontSize = p.fontSize),
                  (o.lineHeight = p.lineHeight),
                  (o.linePadding = p.linePadding),
                  (o.scaleCue = this.scaleCue),
                  (j.style.left = f + "px"),
                  (j.style.top = g + "px"),
                  (j.style.width = h + "px"),
                  (j.style.height = i + "px"),
                  (o.onenter = function () {
                    "showing" == m.mode &&
                      (j.appendChild(this.cueHTMLElement), this.scaleCue(this));
                  }),
                  (o.onexit = function () {
                    for (var a = j.childNodes, b = 0; b < a.length; ++b)
                      a[b].id == "subtitle_" + this.cueID &&
                        j.removeChild(a[b]);
                  }))
                : ((o = new a(p.start - d, p.end - d, p.data)),
                  p.styles &&
                    (void 0 !== p.styles.align &&
                      o.hasOwnProperty("align") &&
                      (o.align = p.styles.align),
                    void 0 !== p.styles.line &&
                      o.hasOwnProperty("line") &&
                      (o.line = p.styles.line),
                    void 0 !== p.styles.position &&
                      o.hasOwnProperty("position") &&
                      (o.position = p.styles.position),
                    void 0 !== p.styles.size &&
                      o.hasOwnProperty("size") &&
                      (o.size = p.styles.size))),
              m.addCue(o);
          }
          c[e].isFragmented ||
            (m.mode = c[e].defaultTrack ? "showing" : "hidden");
        }
      },
      ...
      deleteTrackCues: function (a) {
        if (a.cues) {
          for (var b = a.cues, c = b.length - 1, d = c; d >= 0; d--)
            a.removeCue(b[d]);
          a.mode = "disabled";
        }
      },
      deleteAllTextTracks: function () {
        for (var a = d.length, e = 0; a > e; e++)
          l ? this.deleteTrackCues(this.getTextTrack(e)) : b.removeChild(d[e]);
        (d = []),
          (c = []),
      ...
      setNativeCueStyle: function () {
        if (m) {
          ...
          if (!a) {
            ...
            var c = a.sheet;
            b.id
              ? c.insertRule("#" + b.id + "::cue {background: transparent}", 0)
              : 0 !== b.classList.length
              ? c.insertRule(
                  "." + b.className + "::cue {background: transparent}",
                  0
                )
              : c.insertRule("video::cue {background: transparent}", 0);
          }
        }
      },
  ...
  (MediaPlayer.dependencies.MetricsHandlersController = function () {
    ...
    var a = [],
      b = function (b) {
        var c = b.data;
        a.forEach(function (a) {
          a.handleNewMetric(c.metric, c.value);
        });
      };
    return {
      metricsHandlerFactory: void 0,
      eventBus: void 0,
      initialize: function (c, d) {
        var e = this;
        c.split(",").forEach(function (b, c, f) {
          var g, h;
          -1 !== b.indexOf("(") &&
            -1 === b.indexOf(")") &&
            ((h = f[c + 1]),
            h &&
              ...
              -1 !== h.indexOf(")") &&
              ((b += "," + h), delete f[c + 1])),
            (g = e.metricsHandlerFactory.create(b, d)),
            g && a.push(g);
        }),
          this.eventBus.addEventListener(MediaPlayer.events.METRIC_ADDED, b),
          this.eventBus.addEventListener(MediaPlayer.events.METRIC_UPDATED, b);
      },
      reset: function () {
        this.eventBus.removeEventListener(MediaPlayer.events.METRIC_ADDED, b),
    ...
    return {
      ...
      initialize: function (c) {
        c &&
          ...
          (b = !!c[0].useWallClockTime));
      },
      reset: function () {
        a.clear();
      },
      setup: function () {
        a = this.system.getObject("customTimeRanges");
      },
      isEnabled: function () {
        var c,
          d,
        ...
        if (!g) return !0;
        for (
          d = b ? new Date().getTime() / 1e3 : this.videoModel.getCurrentTime(),
            c = 0;
          g > c;
          c += 1
        )
          if (((e = a.start(c)), (f = a.end(c)), d >= e && f > d)) return !0;
        return !1;
      },
    };
  }),
  ...
  (MediaPlayer.dependencies.ReportingController = function () {
    ...
    var a = [];
    return {
      reportingFactory: void 0,
      initialize: function (b, c) {
        var d = this;
        b.some(function (b) {
          var e = d.reportingFactory.create(b, c);
          return e ? (a.push(e), !0) : void 0;
        });
      },
      reset: function () {
        a.forEach(function (a) {
  ...
  (MediaPlayer.metrics.MetricsHandlerFactory = function () {
    ...
    return {
      ...
      create: function (c, d) {
        ...
        if (f) {
          try {
            (e = this.system.getObject(b[f[1]])),
              e.initialize(f[1], d, f[3], f[5]);
          } catch (g) {
            (e = null),
              this.log(
  ...
  (MediaPlayer.metrics.handlers.BufferLevel = function () {
    ...
    var a,
      ...
      e = function () {
        var a = this;
        return ["video", "audio", "fragmentedText"]
          .map(function (b) {
            return a.metricsExt.getCurrentBufferLevel(
              a.metricsModel.getReadOnlyMetricsFor(b)
            );
          }, this)
          .filter(function (a) {
            return a;
      ...
      f = function () {
        a.report(c, e.call(this));
      };
    return {
      metricsModel: void 0,
      metricsExt: void 0,
      handlerHelpers: void 0,
      setup: function () {
        f = f.bind(this);
      },
      initialize: function (e, g, h) {
        g &&
          ((b = this.handlerHelpers.validateN(h)),
          (a = g),
          (c = this.handlerHelpers.getMetricName(e, h)),
          (d = setInterval(f, b)));
      },
      reset: function () {
        clearInterval(d), (d = null), (b = 0), (a = null);
      },
  ...
  (MediaPlayer.metrics.handlers.DVBErrors = function () {
    ...
    var a,
      b = function (b) {
        var c,
          d = this.manifestModel.getValue(),
          e = new MediaPlayer.vo.metrics.DVBErrors();
        for (c in b) b.hasOwnProperty(c) && (e[c] = b[c]);
        e.mpdurl || (e.mpdurl = d.url),
          e.servicelocation || (e.servicelocation = d.BaseURL.serviceLocation),
          e.terror || (e.terror = new Date()),
          a && a.report("DVBErrors", e);
      },
      c = function (a) {
        (0 === a.responsecode ||
          a.responsecode >= 400 ||
          ...
          b.call(this, {
            errorcode:
              a.responsecode ||
              MediaPlayer.vo.metrics.DVBErrors.CONNECTION_ERROR,
            url: a.url,
            terror: a.tresponse,
          });
      },
  ...
  (MediaPlayer.metrics.handlers.HttpList = function () {
    ...
    return {
      ...
      initialize: function (f, h, i, j) {
        h &&
          ((b = this.handlerHelpers.validateN(i)),
          (a = h),
          j && j.length && (c = j),
          (d = this.handlerHelpers.getMetricName(f, i, j)),
          (e = setInterval(g, b)));
      },
      reset: function () {
        clearInterval(e),
      ...
      handleNewMetric: function (a, b) {
        "HttpList" === a && ((c && c !== b.type) || f.push(b));
      },
    };
  }),
  ...
  (MediaPlayer.metrics.handlers.PlayList = function () {
    ...
    return {
      ...
      handleNewMetric: function (b, c) {
        switch (b) {
          case "PlayList":
            a && a.report("PlayList", c);
        }
      },
    };
  }),
  ...
  (MediaPlayer.metrics.ReportingFactory = function () {
    "use strict";
    var a = { "urn:dvb:dash:reporting:2014": "dvbReporting" };
    return {
      system: void 0,
      create: function (b, c) {
        var d;
        try {
          (d = this.system.getObject(a[b.schemeIdUri])), d.initialize(b, c);
        } catch (e) {
          (d = null),
            this.log(
  ...
  (MediaPlayer.metrics.reporting.DVBReporting = function () {
      ...
      h = function (a, b, c) {
        var d = new XMLHttpRequest(),
          e = function () {
            ...
            -1 !== a &&
              (g.splice(a, 1),
              d.status >= 200 && d.status < 300 ? b && b() : c && c());
          };
        g.push(d);
        try {
        ...
        Array.isArray(f) || (f = [f]),
          b &&
            ...
            f.forEach(function (e) {
              var f = g.metricSerialiser.serialise(e);
              a && "DVBErrors" !== c && (f = "metricname=" + c + "&" + f),
                (f = d + "?" + f),
                h(f, null, function () {
                  b = !1;
                });
    ...
    return {
      log: void 0,
      eventBus: void 0,
      metricSerialiser: void 0,
      randomNumberGenerator: void 0,
      initialize: function (a, f) {
        var g;
        if (((e = f), (d = a["dvb:reportingUrl"]), !d))
          throw new Error("required parameter missing (dvb:reportingUrl)");
        c ||
          ((g = a["dvb:probability"] || a["dvb:priority"] || 0),
          g &&
            (1e3 === g || g / 1e3 >= this.randomNumberGenerator.random()) &&
            (this.log("DVBReporting: became a reporting player!"), (b = !0)),
          (c = !0));
      },
      reset: function () {
        f ||
  ...
  (MediaPlayer.metrics.utils.HandlerHelpers = function () {
    "use strict";
    return {
      getMetricName: function (a, b, c) {
        var d = a;
        return (
          b && ((d += "(" + b), c && c.length && (d += "," + c), (d += ")")), d
        );
      },
          ...
          if (
            ...
            (f = []),
              d.forEach(function (b) {
                var c =
                  "Object" !== Object.prototype.toString.call(b).slice(8, -1);
                f.push(c ? b : a(b));
              }),
            ...
            "string" == typeof d
              ...
              : d instanceof Date
              ? (d = d.toISOString())
              : "number" == typeof d && (d = Math.round(d));
          e.push(c + "=" + d);
        }
      return e.join("&");
    };
      ...
      i = function (a, b) {
        return b
          ? b.hasOwnProperty("time")
            ? [h.call(this, a, b.time, b.threshold)]
            : a.filter(function (a) {
                for (var c in b)
                  if ("state" !== c && b.hasOwnProperty(c) && a[c] != b[c])
                    return !1;
                return !0;
              })
          : a;
      ...
      k = function (a, f) {
        if (a) {
          var g = a.mediaType,
            ...
            m = a.quality,
            n = a.range;
          this.metricsModel.addSchedulingInfo(g, h, i, j, k, l, m, n, f),
            this.metricsModel.addRequestsQueue(g, c, d, b, e);
        }
      },
      l = function (a) {
        ...
        d.splice(d.indexOf(c), 1),
          ...
          k.call(
            ...
            c,
            f
              ? MediaPlayer.dependencies.FragmentModel.states.FAILED
              : MediaPlayer.dependencies.FragmentModel.states.EXECUTED
          ),
          this.notify(
            MediaPlayer.dependencies.FragmentModel.eventList
              .ENAME_FRAGMENT_LOADING_COMPLETED,
        ...
        c &&
          ...
          isNaN(a.data.index) ||
            ...
            k.call(
              this,
              c,
              MediaPlayer.dependencies.FragmentModel.states.REJECTED
            )));
      };
    return {
      system: void 0,
      ...
      setup: function () {
        (this[
          MediaPlayer.dependencies.BufferController.eventList.ENAME_BYTES_REJECTED
        ] = m),
          (this[
            MediaPlayer.dependencies.FragmentLoader.eventList.ENAME_LOADING_COMPLETED
          ] = l);
      },
      ...
      addRequest: function (a) {
        return this.manifestExt.getIsTextTrack(a.mediaType) ||
          (a && !this.isFragmentLoadedOrPendingAndNotDiscarded(a))
          ? (c.push(a),
            k.call(
              this,
              a,
      ...
      isFragmentLoadedOrPendingAndNotDiscarded: function (a) {
        var e = function (a, b) {
            return "complete" === a.action && a.action === b.action;
          },
          f = function (a, b) {
            return a.mediaType === b.mediaType && a.startTime === b.startTime;
          },
          g = function (a, b) {
          ...
          h = function () {
            var c,
              ...
              g = null !== this.sourceBufferExt.getBufferRange(e, a.startTime);
            if (!g) {
              (d = new Date()), d.setSeconds(d.getSeconds() - 3);
              for (var h = 0; h < b.length; h += 1)
                if (((c = b[h]), f(a, c) && c.requestEndDate >= d)) return !1;
              this.eventBus.dispatchEvent({
        ...
        return i(c) || i(d) || (i(b) && !h.call(this));
      },
      getRequests: function (a) {
        ...
        a.state instanceof Array
          ? ((e = a.state.length), (b = a.state))
          : (b = [a.state]);
        for (var f = 0; e > f; f += 1)
          (c = j.call(this, b[f])), (d = d.concat(i.call(this, c, a)));
        return d;
      },
      getLoadingTime: function () {
        ...
        for (c = b.length - 1; c >= 0; c -= 1)
          if (
            ((a = b[c]),
            a.requestEndDate instanceof Date && a.firstByteDate instanceof Date)
          ) {
      ...
      removeExecutedRequestsBeforeTime: function (a) {
        ...
        for (c = d; c >= 0; c -= 1)
          (f = b[c]),
            (e = f.startTime),
            !isNaN(e) && a > e && g.call(this, b, f);
      },
      cancelPendingRequests: function (a) {
        for (var b = this, d = [], e = [], f = c.length, g = 0; f > g; g++) {
          var h = c[g];
          void 0 !== a && h.quality == a ? d.push(h) : e.push(h);
        }
        return (
          (c = d),
          e.forEach(function (a) {
            k.call(
              b,
              a,
              MediaPlayer.dependencies.FragmentModel.states.CANCELED
            );
          }),
          e
        );
      ...
      abortRequests: function () {
        var a = [];
        for (this.fragmentLoader.abort(); d.length > 0; )
          a.push(d[0]), g.call(this, d, d[0]);
        return (d = []), a;
      },
    ...
    return {
      ...
      setValue: function (b) {
        (a = b),
          ...
          this.notify(
            MediaPlayer.models.ManifestModel.eventList.ENAME_MANIFEST_UPDATED,
            { manifest: b }
          );
      },
    };
    ...
    return {
      ...
      addTcpConnection: function (a, b, c, d, e, f) {
        ...
        return (
          ...
          this.metricAdded(a, this.adapter.metricsList.TCP_CONNECTION, g),
          g
        );
      },
      addHttpRequest: function (b, c, d, e, f, g, h, i, j, k, l, m, n) {
        var o = new MediaPlayer.vo.metrics.HTTPRequest();
        if (
          (f &&
            f !== e &&
            (this.addHttpRequest(
          ...
          n.forEach(function (b) {
            (p += b.b[0]), a(o, b.s, b.d, b.b);
          }),
            (o._bytes = p);
        } else delete o.interval, delete o.trace;
        return (
          this.getMetricsFor(b).HttpList.push(o),
          this.metricAdded(b, this.adapter.metricsList.HTTP_REQUEST, o),
          o
        );
      },
      addRepresentationSwitch: function (a, b, c, d, e) {
        ...
        return (
          ...
          this.metricAdded(a, this.adapter.metricsList.TRACK_SWITCH, f),
          f
        );
      },
      addBufferLevel: function (a, b, c) {
        ...
        return (
          (d.t = b),
          (d.level = c),
          this.getMetricsFor(a).BufferLevel.push(d),
          this.metricAdded(a, this.adapter.metricsList.BUFFER_LEVEL, d),
          d
        );
      },
      addBufferState: function (a, b, c) {
        ...
        return (
          (d.target = c),
          (d.state = b),
          this.getMetricsFor(a).BufferState.push(d),
          this.metricAdded(a, this.adapter.metricsList.BUFFER_STATE, d),
          d
        );
      },
      addDVRInfo: function (a, b, c, d) {
        ...
        return (
          ...
          (e.range = d),
          (e.manifestInfo = c),
          this.getMetricsFor(a).DVRInfo.push(e),
          this.metricAdded(a, this.adapter.metricsList.DVR_INFO, e),
          e
        );
      },
      addDroppedFrames: function (a, b) {
        ...
        return (
          ...
          d.length > 0 && d[d.length - 1] == c
            ? d[d.length - 1]
            : (d.push(c),
              this.metricAdded(a, this.adapter.metricsList.DROPPED_FRAMES, c),
              c)
        );
      },
      addSchedulingInfo: function (a, b, c, d, e, f, g, h, i) {
        ...
        return (
          ...
          (j.type = c),
          (j.startTime = d),
          (j.availabilityStartTime = e),
          (j.duration = f),
          (j.quality = g),
          (j.range = h),
          (j.state = i),
          this.getMetricsFor(a).SchedulingInfo.push(j),
          this.metricAdded(a, this.adapter.metricsList.SCHEDULING_INFO, j),
          j
        );
      },
      addRequestsQueue: function (a, b, c, d, e) {
        ...
        (f.pendingRequests = b),
          (f.loadingRequests = c),
          (f.executedRequests = d),
          (f.rejectedRequests = e),
          (this.getMetricsFor(a).RequestsQueue = f),
          this.metricAdded(a, this.adapter.metricsList.REQUESTS_QUEUE, f);
      },
      addManifestUpdate: function (a, b, c, d, e, f, g, h, i, j) {
        ...
        return (
          ...
          (k.presentationStartTime = f),
          (k.clientTimeOffset = g),
          (k.currentTime = h),
          (k.buffered = i),
          (k.latency = j),
          l.ManifestUpdate.push(k),
          this.metricAdded(a, this.adapter.metricsList.MANIFEST_UPDATE, k),
          k
        );
      },
      updateManifestUpdateInfo: function (a, b) {
        if (a) {
          ...
          this.metricUpdated(
            a.mediaType,
            this.adapter.metricsList.MANIFEST_UPDATE,
            a
          );
        }
      },
      ...
      addManifestUpdateRepresentationInfo: function (a, b, c, d, e, f, g, h) {
        if (a) {
          ...
          return (
            ...
            (i.mediaType = e),
            (i.startNumber = g),
            (i.fragmentInfoType = h),
            (i.presentationTimeOffset = f),
            a.trackInfo.push(i),
            this.metricUpdated(
              a.mediaType,
        ...
        return (
          a.trace
            ? a.trace.forEach(function (a) {
                a.hasOwnProperty("subreplevel") &&
                  !a.subreplevel &&
                  delete a.subreplevel;
              })
            : delete a.trace,
          this.getMetricsFor(b).PlayList.push(a),
          this.metricAdded(b, this.adapter.metricsList.PLAY_LIST, a),
          a
        );
      },
    };
  ...
  (MediaPlayer.models.ProtectionModel_01b = function () {
    var a,
      ...
      f = function () {
        ...
        return {
          handleEvent: function (f) {
            ...
            switch (f.type) {
              case c.needkey:
                var i = ArrayBuffer.isView(f.initData)
                  ? f.initData.buffer
                  : f.initData;
                b.notify(
                  MediaPlayer.models.ProtectionModel.eventList.ENAME_NEED_KEY,
                  new MediaPlayer.vo.protection.NeedKey(i, "cenc")
                );
                break;
              case c.keyerror:
                if (
                  ((g = h(e, f.sessionId)), g || (g = h(d, f.sessionId)), g)
                ) {
                  var j = "";
                  ...
                  (j += "  System Code = " + f.systemCode),
                    b.notify(
                      MediaPlayer.models.ProtectionModel.eventList
                        .ENAME_KEY_ERROR,
                      new MediaPlayer.vo.protection.KeyError(g, j)
                    );
              ...
              case c.keyadded:
                (g = h(e, f.sessionId)),
                  ...
                  g
                    ...
                    : b.log("No session token found for key added");
                break;
              case c.keymessage:
                if (
                  ((a = null !== f.sessionId && void 0 !== f.sessionId),
                  a
                    ? ((g = h(e, f.sessionId)),
                      !g &&
                        d.length > 0 &&
                  ...
                  (g.keyMessage = k),
                    b.notify(
                      MediaPlayer.models.ProtectionModel.eventList
                        .ENAME_KEY_MESSAGE,
                      new MediaPlayer.vo.protection.KeyMessage(
                        g,
                        k,
                        f.defaultURL
                      )
      ...
      i = function () {
        b.removeEventListener(c.keyerror, g),
          b.removeEventListener(c.needkey, g),
          b.removeEventListener(c.keymessage, g),
          b.removeEventListener(c.keyadded, g);
      };
    return {
      system: void 0,
      log: void 0,
          ...
          for (
            ...
            if (k && 0 !== k.length) {
              ...
              for (var l = 0; l < k.length; l++)
                "" !== c.canPlayType(k[l].contentType, f) && i.push(k[l]);
            }
            if (
              !((!h && !i) || (h && 0 === h.length) || (i && 0 === i.length))
            ) {
              d = !0;
              var m = new MediaPlayer.vo.protection.KeySystemConfiguration(
                  h,
                  i
                ),
      ...
      setMediaElement: function (a) {
        b !== a &&
          ...
          (b = a),
          b &&
            (b.addEventListener(c.keyerror, g),
            b.addEventListener(c.needkey, g),
            b.addEventListener(c.keymessage, g),
            b.addEventListener(c.keyadded, g),
            this.notify(
              MediaPlayer.models.ProtectionModel.eventList
      ...
      updateKeySession: function (a, d) {
        var e = a.sessionID;
        if (this.protectionExt.isClearKey(this.keySystem))
          for (var f = 0; f < d.keyPairs.length; f++)
            b[c.addKey](
              this.keySystem.systemString,
              d.keyPairs[f].key,
              d.keyPairs[f].keyID,
  ...
  (MediaPlayer.models.ProtectionModel_01b.detect = function (a) {
    for (
      var b = MediaPlayer.models.ProtectionModel_01b.APIs, c = 0;
      c < b.length;
      c++
    ) {
      var d = b[c];
      if (
        "function" == typeof a[d.generateKeyRequest] &&
        "function" == typeof a[d.addKey] &&
        "function" == typeof a[d.cancelKeyRequest]
      )
        return d;
    }
    return null;
  ...
  (MediaPlayer.models.ProtectionModel_21Jan2015 = function () {
    var a = null,
      ...
      d = function (a, b) {
        ...
        !(function (b) {
          var e = a[b].ks,
            f = a[b].configs;
          navigator
            .requestMediaKeySystemAccess(e.systemString, f)
            .then(function (a) {
              var b =
                  "function" == typeof a.getConfiguration
                    ? a.getConfiguration()
                    : null,
        ...
        return {
          handleEvent: function (b) {
            switch (b.type) {
              case "encrypted":
                if (b.initData) {
                  var c = ArrayBuffer.isView(b.initData)
                    ? b.initData.buffer
                    : b.initData;
                  a.notify(
                    MediaPlayer.models.ProtectionModel.eventList.ENAME_NEED_KEY,
                    new MediaPlayer.vo.protection.NeedKey(c, b.initDataType)
                  );
                }
            }
          },
      ...
      i = function (a, b, d) {
            ...
            handleEvent: function (a) {
              switch (a.type) {
                case "keystatuseschange":
                  ...
                  break;
                case "message":
                  var b = ArrayBuffer.isView(a.message)
                    ? a.message.buffer
                    : a.message;
                  e.notify(
                    MediaPlayer.models.ProtectionModel.eventList
        ...
        return (
          a.addEventListener("keystatuseschange", f),
    ...
    return {
          ...
          for (
            var i = function (b) {
                h(b),
                  0 === c.length &&
                    (a
                      ? (a.removeEventListener("encrypted", g),
                        a.setMediaKeys(null).then(function () {
                          f.notify(
                            MediaPlayer.models.ProtectionModel.eventList
                              .ENAME_TEARDOWN_COMPLETE
                          );
      ...
      setMediaElement: function (c) {
        a !== c &&
          (a && (a.removeEventListener("encrypted", g), a.setMediaKeys(null)),
          (a = c),
          a && (a.addEventListener("encrypted", g), b && a.setMediaKeys(b)));
      },
      setServerCertificate: function (a) {
        if (!this.keySystem || !b)
          throw new Error(
          ...
          ["catch"](function (a) {
            c.notify(
              MediaPlayer.models.ProtectionModel.eventList
                .ENAME_SERVER_CERTIFICATE_UPDATED,
              null,
              "Error updating server certificate -- " + a.name
            );
          });
      },
            ...
            h(e),
              f.notify(
                MediaPlayer.models.ProtectionModel.eventList
                  .ENAME_KEY_SESSION_CREATED,
                null,
                "Error generating key request -- " + a.name
              );
          });
      },
      updateKeySession: function (a, b) {
        var c = a.session,
          d = this;
        this.protectionExt.isClearKey(this.keySystem) && (b = b.toJWK()),
          c.update(b)["catch"](function (b) {
            d.notify(
              MediaPlayer.models.ProtectionModel.eventList.ENAME_KEY_ERROR,
              new MediaPlayer.vo.protection.KeyError(
                a,
                "Error sending update() message! " + b.name
              )
            );
          });
      },
          ...
          ["catch"](function (b) {
            d.notify(
              MediaPlayer.models.ProtectionModel.eventList
                .ENAME_KEY_SESSION_CREATED,
              null,
              "Could not load session (" + a + ")! " + b.name
            );
          });
      },
      removeKeySession: function (a) {
          ...
          function (b) {
            c.notify(
              MediaPlayer.models.ProtectionModel.eventList
                .ENAME_KEY_SESSION_REMOVED,
              null,
              "Error removing session (" + a.getSessionID() + "). " + b.name
            );
          }
        );
      },
          ...
          h(a),
            b.notify(
              MediaPlayer.models.ProtectionModel.eventList
                .ENAME_KEY_SESSION_CLOSED,
              null,
              "Error closing session (" + a.getSessionID() + ") " + c.name
            );
        });
      },
    };
  ...
  (MediaPlayer.models.ProtectionModel_21Jan2015.detect = function (a) {
    return void 0 === a.onencrypted || void 0 === a.mediaKeys
      ? !1
  ...
  (MediaPlayer.models.ProtectionModel_3Feb2014 = function () {
    var a = null,
            ...
            switch (b.type) {
              case d.needkey:
                if (b.initData) {
                  ...
                  a.notify(
                    MediaPlayer.models.ProtectionModel.eventList.ENAME_NEED_KEY,
                    new MediaPlayer.vo.protection.NeedKey(c, "cenc")
                  );
                }
            }
          },
      ...
      h = function () {
        ...
        a.readyState >= 1
          ? e.call(this)
          : ((c = e.bind(this)), a.addEventListener("loadedmetadata", c));
      },
      i = function (a, b) {
        var c = this;
        return {
          ...
          handleEvent: function (a) {
            switch (a.type) {
              case d.error:
                ...
                c.notify(
                  MediaPlayer.models.ProtectionModel.eventList.ENAME_KEY_ERROR,
                  new MediaPlayer.vo.protection.KeyError(this, b)
                );
                break;
              case d.message:
                var e = ArrayBuffer.isView(a.message)
                  ? a.message.buffer
                  : a.message;
                c.notify(
                  MediaPlayer.models.ProtectionModel.eventList
    ...
    return {
      ...
      teardown: function () {
        try {
          ...
          a && a.removeEventListener(d.needkey, g),
            this.notify(
              MediaPlayer.models.ProtectionModel.eventList
                .ENAME_TEARDOWN_COMPLETE
            );
          ...
          this.notify(
            MediaPlayer.models.ProtectionModel.eventList
              .ENAME_TEARDOWN_COMPLETE,
            null,
            "Error tearing down key sessions and MediaKeys! -- " + c.message
          );
        }
      },
      getAllInitData: function () {
          ...
          for (
            ...
            if (j && 0 !== j.length) {
              ...
              for (var l = 0; l < j.length; l++)
                window[d.MediaKeys].isTypeSupported(e, j[l].contentType) &&
                  g.push(j[l]);
            }
            if (k && 0 !== k.length) {
              h = [];
              for (var m = 0; m < k.length; m++)
                window[d.MediaKeys].isTypeSupported(e, k[m].contentType) &&
                  h.push(k[m]);
            }
            if (
              !((!g && !h) || (g && 0 === g.length) || (h && 0 === h.length))
            ) {
              b = !0;
              var n = new MediaPlayer.vo.protection.KeySystemConfiguration(
                  g,
                  h
                ),
      ...
      selectKeySystem: function (e) {
        try {
          (b = e.mediaKeys = new window[d.MediaKeys](e.keySystem.systemString)),
      ...
      setMediaElement: function (c) {
        a !== c &&
          (a && a.removeEventListener(d.needkey, g),
          (a = c),
          a && (a.addEventListener(d.needkey, g), b && h.call(this)));
      },
      createKeySession: function (a) {
        if (!this.keySystem || !b || !c)
          throw new Error(
            "Can not create sessions until you have selected a key system"
          );
        ...
        g.addEventListener(d.error, h),
          g.addEventListener(d.message, h),
          g.addEventListener(d.ready, h),
          g.addEventListener(d.close, h),
          e.push(h),
          this.notify(
            MediaPlayer.models.ProtectionModel.eventList
              .ENAME_KEY_SESSION_CREATED,
      ...
      updateKeySession: function (a, b) {
        var c = a.session;
        this.protectionExt.isClearKey(this.keySystem)
          ? c.update(new Uint8Array(b.toJWK()))
          : c.update(new Uint8Array(b));
      },
      closeKeySession: function (a) {
        var b = a.session;
        b.removeEventListener(d.error, a),
          b.removeEventListener(d.message, a),
          b.removeEventListener(d.ready, a),
          b.removeEventListener(d.close, a);
  ...
  (MediaPlayer.models.ProtectionModel_3Feb2014.detect = function (a) {
    for (
      var b = MediaPlayer.models.ProtectionModel_3Feb2014.APIs, c = 0;
      c < b.length;
      c++
    ) {
      var d = b[c];
      if (
        "function" == typeof a[d.setMediaKeys] &&
        "function" == typeof window[d.MediaKeys]
      )
        return d;
    }
    return null;
      ...
      g = function (b) {
        ...
        a.seeking ||
          ...
          1 === e.length &&
            ...
            c.initEvent("waiting", !0, !1),
            (d = this.getPlaybackRate()),
      ...
      h = function (b) {
        ...
        -1 !== g && e.splice(g, 1),
          f() === !1 &&
            ...
            this.setPlaybackRate(d || 1),
            a.dispatchEvent(c));
      },
      i = function (a, b) {
        null !== a && (b ? g.call(this, a) : h.call(this, a));
      };
    return {
      system: void 0,
      play: function () {
  ...
  (MediaPlayer.dependencies.protection.CommonEncryption = {
    ...
    getPSSHData: function (a) {
      var b = 8,
        ...
        d = c.getUint8(b);
      return (
        (b += 20), d > 0 && (b += 4 + 16 * c.getUint32(b)), (b += 4), a.slice(b)
      );
    },
    getPSSHForKeySystem: function (a, b) {
      var c =
        MediaPlayer.dependencies.protection.CommonEncryption.parsePSSHList(b);
      return c.hasOwnProperty(a.uuid.toLowerCase())
        ? c[a.uuid.toLowerCase()]
        : null;
    },
    ...
    parsePSSHList: function (a) {
      ...
      for (var b = new DataView(a), c = !1, d = {}, e = 0; !c; ) {
        ...
        if (
          ...
          (g = e + f),
          (e += 4),
          1886614376 === b.getUint32(e))
        )
          if (((e += 4), (h = b.getUint8(e)), 0 === h || 1 === h)) {
            (e += 1), (e += 3), (i = "");
            var l, m;
            for (l = 0; 4 > l; l++)
              (m = b.getUint8(e + l).toString(16)),
                (i += 1 === m.length ? "0" + m : m);
            for (e += 4, i += "-", l = 0; 2 > l; l++)
              (m = b.getUint8(e + l).toString(16)),
                (i += 1 === m.length ? "0" + m : m);
  ...
  (MediaPlayer.dependencies.protection.KeySystem_ClearKey.getClearKeysFromProtectionData =
    function (a, b) {
      var c = null;
      if (a) {
        for (
          ...
          if (!h)
            throw new Error("DRM: ClearKey keyID (" + g + ") is not known!");
    ...
    var a = "com.microsoft.playready",
      ...
      d = function (a) {
        ...
        (b = String.fromCharCode.apply(null, g)),
          (d = f.parseFromString(b, "application/xml"));
        for (
          var h = d.getElementsByTagName("name"),
            i = d.getElementsByTagName("value"),
            j = 0;
          j < h.length;
          j++
        )
          e[h[j].childNodes[0].nodeValue] = i[j].childNodes[0].nodeValue;
        return (
          e.hasOwnProperty("Content") &&
            ((e["Content-Type"] = e.Content), delete e.Content),
          e
        );
      },
      e = function (a) {
        ...
        if (
          ((b = String.fromCharCode.apply(null, g)),
          (d = e.parseFromString(b, "application/xml")),
          ...
          for (
            ...
            if (((d += 2), 1 === g)) {
              ...
              if (k.getElementsByTagName("LA_URL")[0]) {
                var l =
                  k.getElementsByTagName("LA_URL")[0].childNodes[0].nodeValue;
                if (l) return l;
              }
              if (k.getElementsByTagName("LUI_URL")[0]) {
                var m =
                  k.getElementsByTagName("LUI_URL")[0].childNodes[0].nodeValue;
                if (m) return m;
              }
            } else d += h;
          }
  ...
  (MediaPlayer.rules.ABRRulesCollection = function () {
    ...
    return {
      ...
      getRules: function (c) {
        switch (c) {
          case MediaPlayer.rules.ABRRulesCollection.prototype
            .QUALITY_SWITCH_RULES:
            return a;
          case MediaPlayer.rules.ABRRulesCollection.prototype
            .ABANDON_FRAGMENT_RULES:
      ...
      setup: function () {
        a.push(this.insufficientBufferRule),
          a.push(this.throughputRule),
          b.push(this.abandonRequestRule);
      },
    };
  }),
  (MediaPlayer.rules.ABRRulesCollection.prototype = {
    ...
    return {
      ...
      execute: function (f, g) {
        var h,
          ...
          p = new MediaPlayer.rules.SwitchRequest(
            MediaPlayer.rules.SwitchRequest.prototype.NO_CHANGE,
            MediaPlayer.rules.SwitchRequest.prototype.WEAK
          );
        if (!isNaN(n.index)) {
          if (
            (e(k, n.index),
            (h = c[k][n.index]),
            null === h || null === n.firstByteDate || d.hasOwnProperty(h.id))
          )
            return void g(p);
          if (
            (void 0 === h.firstByteTime &&
              ((h.firstByteTime = n.firstByteDate.getTime()),
              (h.segmentDuration = n.duration),
              (h.bytesTotal = n.bytesTotal),
              (h.id = n.index)),
            (h.bytesLoaded = n.bytesLoaded),
            (h.elapsedTime = i - h.firstByteTime),
            h.bytesLoaded < h.bytesTotal && h.elapsedTime >= a)
          ) {
            if (
              ((h.measuredBandwidthInKbps = Math.round(
                (8 * h.bytesLoaded) / h.elapsedTime
              )),
              (h.estimatedTimeOfDownload = (
                (8 * h.bytesTotal * 0.001) /
                h.measuredBandwidthInKbps
              ).toFixed(2)),
              h.estimatedTimeOfDownload < h.segmentDuration * b ||
                0 === m.quality)
            )
              return void g(p);
            if (!d.hasOwnProperty(h.id)) {
              var q = o.getQualityForBitrate(
                j,
                h.measuredBandwidthInKbps *
                  MediaPlayer.dependencies.AbrController.BANDWIDTH_SAFETY
              );
              (p = new MediaPlayer.rules.SwitchRequest(
                q,
                MediaPlayer.rules.SwitchRequest.prototype.STRONG
    ...
    return {
      ...
      execute: function (e, f) {
        var g = this,
          ...
          l =
            k.BufferState.length > 0
              ? k.BufferState[k.BufferState.length - 1]
              : null,
          m = new MediaPlayer.rules.SwitchRequest(
            MediaPlayer.rules.SwitchRequest.prototype.NO_CHANGE,
            MediaPlayer.rules.SwitchRequest.prototype.WEAK
          );
        return c > h - b || null === l
          ...
          : (d(i, l.state),
            l.state ===
              MediaPlayer.dependencies.BufferController.BUFFER_EMPTY &&
              void 0 !== a[i].firstBufferLoadedEvent &&
              (m = new MediaPlayer.rules.SwitchRequest(
                0,
                MediaPlayer.rules.SwitchRequest.prototype.STRONG
              )),
            m.value !== MediaPlayer.rules.SwitchRequest.prototype.NO_CHANGE &&
              m.value !== j &&
              g.log(
                "InsufficientBufferRule requesting switch to index: ",
                m.value,
                "type: ",
                i,
                " Priority: ",
    ...
    return {
      ...
      execute: function (c, d) {
        var e = this,
          ...
          g = f.type,
          h = c.getCurrentValue(),
          i = e.metricsModel.getReadOnlyMetricsFor(g),
          j = c.getStreamProcessor(),
          k = j.getABRController(),
          l = j.isDynamic(),
          m = new MediaPlayer.rules.SwitchRequest(
            MediaPlayer.rules.SwitchRequest.prototype.NO_CHANGE,
            MediaPlayer.rules.SwitchRequest.prototype.WEAK
          );
        if (0 === i.BufferState.length || 0 === i.BufferLevel.length)
          return void d(m);
        var n = i.BufferState[i.BufferState.length - 1],
          o = i.BufferLevel[i.BufferLevel.length - 1],
          p = e.metricsExt.getRecentThroughput(i, l ? a : b);
        if (0 > p) return void d(m);
        if (
          ((p = Math.round(
            (p * MediaPlayer.dependencies.AbrController.BANDWIDTH_SAFETY) / 1e3
          )),
          n.state === MediaPlayer.dependencies.BufferController.BUFFER_LOADED &&
            (o.level >=
              2 *
                MediaPlayer.dependencies.BufferController
                  .LOW_BUFFER_THRESHOLD_MS ||
              l))
        ) {
          var q = k.getQualityForBitrate(f, p);
          m = new MediaPlayer.rules.SwitchRequest(
            q,
  ...
  (MediaPlayer.rules.RulesController = function () {
    ...
    var b = {},
      ...
      e = function (a) {
        var b = c.length,
          d = 0;
        for (d; b > d; d += 1) if (!a.hasOwnProperty(c[d])) return !1;
        return !0;
      },
      f = function (a, b) {
        ...
        return (
          (a.execute = function (c, d) {
            var e = function (b) {
              d.call(
                a,
                new MediaPlayer.rules.SwitchRequest(b.value, b.priority)
              );
            };
            b(c, e);
          }),
    ...
    return {
      ...
      SYNC_RULE: 2,
      initialize: function () {
        (b[this.ABR_RULE] = this.system.getObject("abrRulesCollection")),
          (b[this.SCHEDULING_RULE] = this.system.getObject(
            "scheduleRulesCollection"
          )),
          (b[this.SYNC_RULE] = this.system.getObject(
            "synchronizationRulesCollection"
          ));
      },
      setRules: function (a, c) {
        d.call(this, a) && c && h.call(this, b[a], c, !0);
      },
      addRules: function (a, c) {
        d.call(this, a) && c && h.call(this, b[a], c, !1);
      },
      applyRules: function (b, c, d, g, h) {
        var i,
          j,
          k = this,
          l = b.length,
          ...
          p = function (b) {
            var c, e;
            b.value !== MediaPlayer.rules.SwitchRequest.prototype.NO_CHANGE &&
              (n[b.priority] = h(n[b.priority], b.value)),
              b.value &&
                ((b.value && b.value.length > 0) || b.value.ACTION_DOWNLOAD) &&
                k.log("[RULES]:", i.getName(), a(b.value), b.formatPriority()),
              --l ||
                (n[MediaPlayer.rules.SwitchRequest.prototype.WEAK] !==
                  MediaPlayer.rules.SwitchRequest.prototype.NO_CHANGE &&
                  ((e = MediaPlayer.rules.SwitchRequest.prototype.WEAK),
                  (c = n[MediaPlayer.rules.SwitchRequest.prototype.WEAK])),
                n[MediaPlayer.rules.SwitchRequest.prototype.DEFAULT] !==
                  MediaPlayer.rules.SwitchRequest.prototype.NO_CHANGE &&
                  ((e = MediaPlayer.rules.SwitchRequest.prototype.DEFAULT),
                  (c = n[MediaPlayer.rules.SwitchRequest.prototype.DEFAULT])),
                n[MediaPlayer.rules.SwitchRequest.prototype.STRONG] !==
                  MediaPlayer.rules.SwitchRequest.prototype.NO_CHANGE &&
                  ((e = MediaPlayer.rules.SwitchRequest.prototype.STRONG),
                  (c = n[MediaPlayer.rules.SwitchRequest.prototype.STRONG])),
                e != MediaPlayer.rules.SwitchRequest.prototype.STRONG &&
                  e != MediaPlayer.rules.SwitchRequest.prototype.WEAK &&
                  (e = MediaPlayer.rules.SwitchRequest.prototype.DEFAULT),
                d({ value: void 0 !== c ? c : g, confidence: e }));
          };
        for (
          n[MediaPlayer.rules.SwitchRequest.prototype.STRONG] =
            MediaPlayer.rules.SwitchRequest.prototype.NO_CHANGE,
          ...
          (i = b[j]), e.call(this, i) ? i.execute(o, p) : l--;
      },
      reset: function () {
        var a,
          c,
          d = b[this.ABR_RULE],
          e = b[this.SCHEDULING_RULE],
          f = b[this.SYNC_RULE],
          g = (
            d.getRules(
              MediaPlayer.rules.ABRRulesCollection.prototype
          ...
          h = g.length;
        for (c = 0; h > c; c += 1)
          (a = g[c]), "function" == typeof a.reset && a.reset();
        b = {};
      },
    };
  }),
  ...
  (MediaPlayer.rules.BufferLevelRule = function () {
    ...
    var a = {},
      ...
      c = function (a, b, c) {
        var d;
        return (d = c
          ? this.playbackController.getLiveDelay()
          : isNaN(b) ||
            (MediaPlayer.dependencies.BufferController.DEFAULT_MIN_BUFFER_TIME <
              b &&
              b > a)
          ? Math.max(
              MediaPlayer.dependencies.BufferController.DEFAULT_MIN_BUFFER_TIME,
      ...
      d = function (a, d, e) {
        var f = this,
          g = e.bufferController.getCriticalBufferLevel(),
          h = f.metricsModel.getReadOnlyMetricsFor("video"),
          i = f.metricsModel.getReadOnlyMetricsFor("audio"),
          j = c.call(this, e.bufferController.getMinBufferTime(), d, a),
          k = j,
          l = e.bufferController.bufferMax,
          m = 0;
        if (l === MediaPlayer.dependencies.BufferController.BUFFER_SIZE_MIN)
          m = j;
        else if (
          l === MediaPlayer.dependencies.BufferController.BUFFER_SIZE_INFINITY
        )
          m = d;
        else if (
          l === MediaPlayer.dependencies.BufferController.BUFFER_SIZE_REQUIRED
        ) {
          !a &&
            f.abrController.isPlayingAtTopQuality(
              e.streamProcessor.getStreamInfo()
            ) &&
            (k =
              MediaPlayer.dependencies.BufferController
                .BUFFER_TIME_AT_TOP_QUALITY);
          var n = h ? f.metricsExt.getRecentLatency(h, 4) : 0,
            o = i ? f.metricsExt.getRecentLatency(i, 4) : 0,
            p = Math.max(Math.max(n, o), b);
          m = k + p;
        }
        return Math.min(m, g);
      };
    return {
      ...
      virtualBuffer: void 0,
      videoModel: void 0,
      setScheduleController: function (b) {
        var c = b.streamProcessor.getStreamInfo().id;
        (a[c] = a[c] || {}), (a[c][b.streamProcessor.getType()] = b);
      },
      execute: function (b, c) {
        var e,
          ...
          h = b.getMediaInfo(),
          i = h.type,
          j = this.metricsModel.getReadOnlyMetricsFor(i),
          k = this.mediaController.getSwitchMode(),
          l = this.metricsExt.getCurrentBufferLevel(j),
          m = this.playbackController.getTime(),
          n = this.virtualBuffer.getChunks({
            streamId: g,
            mediaType: i,
            appended: !0,
            mediaInfo: h,
            forRange: { start: m, end: m + l },
          }),
          o = n && n.length > 0 ? n[n.length - 1].bufferedRange.end - m : null,
          p =
            k ===
            MediaPlayer.dependencies.MediaController.trackSwitchModes
              .NEVER_REPLACE
              ...
              : o || 0,
          q = a[g][i],
          r = q.streamProcessor.getCurrentRepresentationInfo(),
          s = q.streamProcessor.isDynamic(),
          t = this.videoModel.getPlaybackRate(),
          u = f.manifestInfo.duration,
          v = p / Math.max(Math.abs(t), 1),
          w = r.fragmentDuration,
          x = s ? Number.POSITIVE_INFINITY : u - m,
          y = Math.min(d.call(this, s, u, q), x),
          z = Math.max(y - v, 0);
        (e = Math.ceil(z / w)),
          c(
    ...
    return {
      ...
      execute: function (c, d) {
        ...
        if (
          ...
          return void d(new MediaPlayer.rules.SwitchRequest(null, q));
        if (
          (r && k.getFragmentModel().removeRejectedRequest(r),
          isNaN(f) ||
            ("fragmentedText" === i &&
              this.textSourceBuffer.getAllTracksAreDisabled()))
        )
        ...
        for (
          x &&
            ((y = this.sourceBufferExt.getBufferRange(
              m.bufferController.getBuffer(),
              f
            )),
            null !== y &&
              ((e = this.virtualBuffer.getChunks({
                streamId: j,
                mediaType: i,
                appended: !0,
                mediaInfo: h,
              ...
              e && e.length > 0 && (f = e[e.length - 1].bufferedRange.end))),
            g = this.adapter.getFragmentRequestForTime(m, n, f, { keepIdx: s }),
            w &&
              g &&
              g.index !== r.index &&
              (g = this.adapter.getFragmentRequestForTime(
                m,
                n,
                r.startTime + r.duration / 2 + l,
                { keepIdx: s, timeThreshold: 0 }
              ));
          g && m.getFragmentModel().isFragmentLoadedOrPendingAndNotDiscarded(g);

        )
          g = this.adapter.getNextFragmentRequest(m, n);
        g && !w && m.setIndexHandlerTime(g.startTime + g.duration),
          g && p && (a[i] = null),
          d(new MediaPlayer.rules.SwitchRequest(g, q));
      },
      reset: function () {
        (a = {}), (b = {});
      },
    ...
    var a = function (a, b) {
        ...
        for (i; j > i; i += 1)
          for (
            ...
            (d = f[g]),
              d.startTime > b && (!e || d.startTime < e.startTime) && (e = d);
        return e || d ? [e || d] : null;
      },
      b = function (a, b) {
        var c,
        ...
        for (d = 0; e > d; d += 1) {
          for (
            ...
            (c = h[i]),
              c.type == MediaPlayer.vo.metrics.HTTPRequest.INIT_SEGMENT_TYPE &&
                f.push(c);
          (c = a[d].getRequests({
            state: MediaPlayer.dependencies.FragmentModel.states.PENDING,
            time: b,
        ...
        return f.length > 0 ? f : g.length > 0 ? g : null;
      },
      c = function (a, b) {
        var c = function (a, c) {
          return a[b] < c[b] || (isNaN(a[b]) && "complete" !== a.action)
            ? -1
            : a[b] > c[b]
            ? 1
            : 0;
    ...
    return {
      ...
      execute: function (c, d) {
        var e,
          ...
          k = j.id,
          l = c.getCurrentValue(),
          m = MediaPlayer.rules.SwitchRequest.prototype.DEFAULT,
          n = this.playbackController,
          o = this.fragmentModels[k],
          p = new Date(),
          q = o ? o.length : null,
          r = [];
        if (!o || !q) return void d(new MediaPlayer.rules.SwitchRequest([], m));
        if (
          ((g = n.isPlaybackStarted() ? n.getTime() : n.getStreamStartTime(j)),
          (h = b(o, g)),
          (f = h || a(o, g) || l),
          !f || 0 === f.length)
        )
          return void d(new MediaPlayer.rules.SwitchRequest([], m));
        for (var s = 0; s < f.length; s++) r.push(f[s]);
        for (s = 0; q > s; s++)
          if (
            ((e = o[s]),
            (i = e.getRequests({
        ...
        (r = r.filter(function (a) {
          return (
            "complete" === a.action ||
            p.getTime() >= a.availabilityStartTime.getTime()
          );
        })),
          d(new MediaPlayer.rules.SwitchRequest(r, m));
      },
    };
  }),
  ...
  (MediaPlayer.rules.ScheduleRulesCollection = function () {
    ...
    return {
      ...
      getRules: function (d) {
        switch (d) {
          case MediaPlayer.rules.ScheduleRulesCollection.prototype
            .FRAGMENTS_TO_SCHEDULE_RULES:
            return a;
          case MediaPlayer.rules.ScheduleRulesCollection.prototype
            .NEXT_FRAGMENT_RULES:
      ...
      setup: function () {
        a.push(this.bufferLevelRule),
          a.push(this.pendingRequestsRule),
          c.push(this.playbackTimeRule),
          b.push(this.sameTimeRequestRule);
      },
    };
  }),
  (MediaPlayer.rules.ScheduleRulesCollection.prototype = {
  ...
  (MediaPlayer.rules.SwitchRequest = function (a, b) {
    ...
    (this.value = a),
      (this.priority = b),
      void 0 === this.value && (this.value = 999),
  ...
  (MediaPlayer.rules.SwitchRequest.prototype = {
    ...
    formatPriority: function () {
      return this.priority == this.WEAK
        ? "Weak"
        : this.priority == this.STRONG
        ? "Strong"
        : this.priority == this.DEFAULT
        ? "Default"
        : this.priority == this.NO_CHANGE
        ? "No Change"
        : this.priority;
    },
  }),
  (MediaPlayer.rules.LiveEdgeBinarySearchRule = function () {
    ...
    var a,
      ...
      l = function (a, d, e, f) {
        var g,
          i = this;
        if (null === f)
          (g = i.adapter.generateFragmentRequestForTime(c, h, a)),
            l.call(i, a, d, e, g);
        else {
          var j = function (c) {
            b.unsubscribe(
              ...
              c.data.exists
                ? d.call(i, c.data.request, a)
                : e.call(i, c.data.request, a);
          };
          b.subscribe(
            MediaPlayer.dependencies.FragmentLoader.eventList
              .ENAME_CHECK_FOR_EXISTENCE_COMPLETED,
            ...
            b.checkForExistence(f);
        }
      },
      m = function (b, d) {
        var j, p, q;
        return i
          ? void o.call(this, !1, d)
          : ((q = d - e),
            (j = q > 0 ? e - q : e + Math.abs(q) + g),
            void (j < f.start && j > f.end
              ? a(new MediaPlayer.rules.SwitchRequest(null, k))
              : ((p = this.adapter.getFragmentRequestForTime(c, h, j, {
                  ignoreIsFinished: !0,
                })),
                l.call(this, j, n, m, p))));
      },
      n = function (b, d) {
        var m,
          ...
          q = this;
        if (!i) {
          if (!h.fragmentDuration)
            return void a(new MediaPlayer.rules.SwitchRequest(p, k));
          if (((i = !0), (f.end = p + 2 * g), d === e))
            return (
              (n = d + j),
              (m = q.adapter.getFragmentRequestForTime(c, h, n, {
                ignoreIsFinished: !0,
              })),
              void l.call(
                q,
      ...
      o = function (b, d) {
        var e, g, i;
        b ? (f.start = d) : (f.end = d),
          (e = Math.floor(f.end - f.start) <= j),
          e
            ? a(new MediaPlayer.rules.SwitchRequest(b ? d : d - j, k))
            : ((i = (f.start + f.end) / 2),
              (g = this.adapter.getFragmentRequestForTime(c, h, i, {
                ignoreIsFinished: !0,
              })),
              l.call(this, i, n, m, g));
      };
    return {
      ...
      execute: function (i, o) {
        ...
        if (
          ((a = o),
          (c = i.getStreamProcessor()),
          (b = c.getFragmentLoader()),
          (h = i.getTrackInfo()),
          (j = h.fragmentDuration),
          (q = h.DVRWindow),
          (e = q.end),
          h.useCalculatedLiveEdgeTime)
        ) {
          var s = r.timelineConverter.getExpectedLiveEdge();
          return (
            r.timelineConverter.setExpectedLiveEdge(e),
            void a(new MediaPlayer.rules.SwitchRequest(s, k))
          );
        }
        (f = { start: Math.max(0, e - d), end: e + d }),
          (g = Math.floor((q.end - q.start) / 2)),
          (p = r.adapter.getFragmentRequestForTime(c, h, e, {
            ignoreIsFinished: !0,
          })),
          l.call(r, e, n, m, p);
      },
    ...
    return {
      ...
      execute: function (a, b) {
        ...
        if (c.useCalculatedLiveEdgeTime) {
          ...
          this.timelineConverter.setExpectedLiveEdge(d),
            b(new MediaPlayer.rules.SwitchRequest(f, e));
  ...
  (MediaPlayer.rules.SynchronizationRulesCollection = function () {
    ...
    return {
      ...
      getRules: function (c) {
        switch (c) {
          case MediaPlayer.rules.SynchronizationRulesCollection.prototype
            .TIME_SYNCHRONIZED_RULES:
            return a;
          case MediaPlayer.rules.SynchronizationRulesCollection.prototype
            .BEST_GUESS_RULES:
      ...
      setup: function () {
        a.push(this.liveEdgeWithTimeSynchronizationRule),
          b.push(this.liveEdgeBinarySearchRule);
      },
    };
  }),
  (MediaPlayer.rules.SynchronizationRulesCollection.prototype = {
  ...
  (MediaPlayer.utils.CustomTimeRanges = function () {
    return {
      ...
      add: function (a, b) {
        ...
        for (
          c = 0;
          c < this.customTimeRangeArray.length &&
      ...
      remove: function (a, b) {
        for (var c = 0; c < this.customTimeRangeArray.length; c++)
          if (
            ...
            a > this.customTimeRangeArray[c].start &&
            a < this.customTimeRangeArray[c].end
              ? (this.customTimeRangeArray[c].end = a)
      ...
      mergeRanges: function (a, b) {
        ...
        return c.start <= d.start && d.start <= c.end && c.end <= d.end
          ...
          : c.start <= d.start && d.start <= c.end && d.end <= c.end
  ...
  (MediaPlayer.utils.DOMStorage = function () {
    var a,
      ...
      d = function (a, b) {
        void 0 === b ||
          isNaN(b) ||
          "number" != typeof b ||
          (MediaPlayer.utils.DOMStorage[a] = b);
      },
      e = function (a) {
        if (
          !this.isSupported(MediaPlayer.utils.DOMStorage.STORAGE_TYPE_LOCAL) ||
          !c
        )
          return null;
        var b =
            MediaPlayer.utils.DOMStorage[
              "LOCAL_STORAGE_" + a.toUpperCase() + "_SETTINGS_KEY"
            ],
          d = JSON.parse(localStorage.getItem(b)) || {},
          e =
            new Date().getTime() - parseInt(d.timestamp) >=
              MediaPlayer.utils.DOMStorage
                .LOCAL_STORAGE_MEDIA_SETTINGS_EXPIRATION || !1,
          f = d.settings;
        ...
        ["video", "audio"].forEach(function (a) {
          if (void 0 === this.abrController.getInitialBitrateFor(a)) {
            if (
              ...
              var c =
                  MediaPlayer.utils.DOMStorage[
                    "LOCAL_STORAGE_" + a.toUpperCase() + "_BITRATE_KEY"
                  ],
                d = JSON.parse(localStorage.getItem(c)) || {},
                e =
                  new Date().getTime() - parseInt(d.timestamp) >=
                    MediaPlayer.utils.DOMStorage
                      .LOCAL_STORAGE_BITRATE_EXPIRATION || !1,
                f = parseInt(d.bitrate);
              isNaN(f) || e
                ? e && localStorage.removeItem(c)
                : (this.abrController.setInitialBitrateFor(a, f),
                  this.log("Last bitrate played for " + a + " was " + f));
            }
            void 0 === this.abrController.getInitialBitrateFor(a) &&
              this.abrController.setInitialBitrateFor(
                a,
                MediaPlayer.dependencies.AbrController[
                  "DEFAULT_" + a.toUpperCase() + "_BITRATE"
                ]
              );
          }
        }, this);
    ...
    return {
      ...
      storeBitrate: function (a, c, d) {
        var e = window[a];
        if (e && b) {
          var f =
            MediaPlayer.utils.DOMStorage[
              "LOCAL_STORAGE_" + c.toUpperCase() + "_BITRATE_KEY"
            ];
          e.setItem(f, JSON.stringify({ bitrate: d, timestamp: g() }));
        }
      },
      storeLastSettings: function (a, b, d) {
        var e = window[a];
        if (e && c) {
          var f =
            MediaPlayer.utils.DOMStorage[
              "LOCAL_STORAGE_" + b.toUpperCase() + "_SETTINGS_KEY"
            ];
          e.setItem(f, JSON.stringify({ settings: d, timestamp: g() }));
        }
      },
      isSupported: function (b) {
        ...
        if (
          !c ||
          (b !== MediaPlayer.utils.DOMStorage.STORAGE_TYPE_LOCAL &&
            b !== MediaPlayer.utils.DOMStorage.STORAGE_TYPE_SESSION)
        )
          return a;
        try {
          ...
          this.log(
            "Warning: DOMStorage is supported, but cannot be used: " + f.message
          );
        }
        return a;
      },
  ...
  (MediaPlayer.utils.DOMStorage.LOCAL_STORAGE_VIDEO_BITRATE_KEY =
    "dashjs_vbitrate"),
  (MediaPlayer.utils.DOMStorage.LOCAL_STORAGE_AUDIO_BITRATE_KEY =
    "dashjs_abitrate"),
  (MediaPlayer.utils.DOMStorage.LOCAL_STORAGE_AUDIO_SETTINGS_KEY =
    "dashjs_asettings"),
  (MediaPlayer.utils.DOMStorage.LOCAL_STORAGE_VIDEO_SETTINGS_KEY =
    "dashjs_vsettings"),
  ...
  (MediaPlayer.utils.Debug = function () {
    ...
    return {
      ...
      log: function () {
        var f = "",
          g = null;
        c && ((g = new Date().getTime()), (f += "[" + (g - e) + "]")),
          d && this.getName && (f += "[" + this.getName() + "]"),
          this.getMediaType &&
            this.getMediaType() &&
            (f += "[" + this.getMediaType() + "]"),
          f.length > 0 && (f += " "),
          Array.apply(null, arguments).forEach(function (a) {
            f += a + " ";
          }),
          b && console.log(f),
          a.dispatchEvent({ type: "log", message: f });
      },
    };
  }),
  ...
  (MediaPlayer.utils.IsoFile = function () {
    "use strict";
    var a,
      b = { offset: "_offset", size: "size", type: "type" },
      c = {
      ...
      l = function (a) {
        ...
        var l,
          m,
          n = new MediaPlayer.vo.IsoBox();
        switch (
          (k(a, n, b),
          a.hasOwnProperty("_incomplete") && (n.isComplete = !a._incomplete),
          n.type)
        ) {
          case "sidx":
            if ((k(a, n, c), n.references))
              for (l = 0, m = n.references.length; m > l; l += 1)
                k(a.references[l], n.references[l], d);
            break;
          case "emsg":
            k(a, n, e);
            break;
          ...
          case "trun":
            if ((k(a, n, i), n.samples))
              for (l = 0, m = n.samples.length; m > l; l += 1)
                k(a.samples[l], n.samples[l], j);
        }
        return n;
      },
      m = function (b) {
        return b && a && a.boxes && 0 !== a.boxes.length
          ? l.call(this, a.fetch(b))
          : null;
      },
      n = function (b) {
        for (
          var c, d = a.fetchAll(b), e = [], f = 0, g = d.length;
          g > f;
          f += 1
        )
          (c = l.call(this, d[f])), c && e.push(c);
        return e;
      };
    return {
      getBox: m,
  ...
  (MediaPlayer.utils.RNG = function () {
    ...
    var a,
      ...
      f = 10,
      g = function () {
        c && (a || (a = new d(f)), c.getRandomValues(a), (b = 0));
      },
      h = function (d, f) {
        var h;
        return (
          ...
          f || (f = 1),
          c
            ? (b === a.length && g(), (h = a[b] / e), (b += 1))
            : (h = Math.random()),
          h * (f - d) + d
        );
      };
    return { random: h, setup: g };
  }),
  (MediaPlayer.utils.RNG.prototype = { constructor: MediaPlayer.utils.RNG }),
  (MediaPlayer.utils.VirtualBuffer = function () {
    var a = {},
      ...
      d = function (a, b, c) {
        ...
        return (
          a.forEach(function (a) {
            (d = a.bufferedRange.start),
              (e = a.bufferedRange.end),
              (f = d >= i && j > d),
              (g = e > i && j >= e),
              (f || g) &&
                (h.push(a),
                c &&
                  ((a.bufferedRange.start = f ? d : i),
                  (a.bufferedRange.end = g ? e : j)));
          }),
          h
        );
      },
      e = function () {
        ...
        return (
          ...
          (a.audio[MediaPlayer.vo.metrics.HTTPRequest.MEDIA_SEGMENT_TYPE] = []),
          (a.audio[MediaPlayer.vo.metrics.HTTPRequest.INIT_SEGMENT_TYPE] = []),
          (a.video = {
            calculatedBufferedRanges: new MediaPlayer.utils.CustomTimeRanges(),
            actualBufferedRanges: new MediaPlayer.utils.CustomTimeRanges(),
            appended: [],
          }),
          (a.video[MediaPlayer.vo.metrics.HTTPRequest.MEDIA_SEGMENT_TYPE] = []),
          (a.video[MediaPlayer.vo.metrics.HTTPRequest.INIT_SEGMENT_TYPE] = []),
          (a.fragmentedText = {
            calculatedBufferedRanges: new MediaPlayer.utils.CustomTimeRanges(),
            actualBufferedRanges: new MediaPlayer.utils.CustomTimeRanges(),
            appended: [],
          ...
          (a.fragmentedText[
            MediaPlayer.vo.metrics.HTTPRequest.INIT_SEGMENT_TYPE
          ] = []),
          a
        );
      };
    return {
      ...
      append: function (c) {
        ...
        (a[d] = a[d] || e()),
          ...
          isNaN(h) ||
            isNaN(i) ||
            (a[d][f].calculatedBufferedRanges.add(h, i),
            this.notify(
              MediaPlayer.utils.VirtualBuffer.eventList.CHUNK_APPENDED,
              { chunk: c }
            ));
      ...
      storeAppendedChunk: function (c, d) {
        if (c && d) {
          ...
          (c.bufferedRange = { start: c.start, end: c.end }),
            h
              ? ((e = a[f][g].appended.indexOf(h)), (a[f][g].appended[e] = c))
              : a[f][g].appended.push(c),
            b(a[f][g].appended, "start");
        }
      },
      updateBufferedRanges: function (b, c) {
        if (b) {
          var e,
            ...
            g = b.streamId,
            h = b.mediaType,
            i = this.getChunks({ streamId: g, mediaType: h, appended: !0 }),
            j = [];
          if (
            ((a[g][h].actualBufferedRanges =
              new MediaPlayer.utils.CustomTimeRanges()),
            !c || 0 === c.length)
          )
            return void (a[g][h].appended = []);
          for (var k = 0, l = c.length; l > k; k += 1)
            (e = c.start(k)),
              (f = c.end(k)),
              a[g][h].actualBufferedRanges.add(e, f),
              (j = j.concat(d.call(this, i, { start: e, end: f }, !0)));
          a[g][h].appended = j;
        }
      },
      getChunks: function (a) {
        ...
        return e
          ? (delete a.streamId,
            ...
            delete a.removeOrigin,
            delete a.limit,
            delete a.appended,
            (b = g ? e.appended : f ? e[f] : []),
            (l = b.filter(function (b, c, d) {
              if (k >= i) return !1;
              for (var f in a) {
              ...
              return (
                h &&
                  (e.calculatedBufferedRanges.remove(b.start, b.end),
                  d.splice(c, 1)),
                (k += 1),
                !0
              );
            })),
            a.forRange && (l = d.call(this, l, a.forRange, !1)),
            l)
          : l;
      },
      extract: function (a) {
      ...
      getTotalBufferLevel: function (b) {
        ...
        for (var e in a)
          a.hasOwnProperty(e) &&
            (d += this.sourceBufferExt.getTotalBufferedTime({
  ...
  (MediaPlayer.vo.Error.prototype = { constructor: MediaPlayer.vo.Error }),
  ...
  (MediaPlayer.vo.Event.prototype = { constructor: MediaPlayer.vo.Event }),
  ...
  (MediaPlayer.vo.IsoBox.prototype = { constructor: MediaPlayer.vo.IsoBox }),
  ...
  (MediaPlayer.vo.metrics.HTTPRequest.BITSTREAM_SWITCHING_SEGMENT_TYPE =
  ...
  (MediaPlayer.vo.metrics.PlayList.METRICS_COLLECTION_START_REASON =
  ...
  (MediaPlayer.vo.metrics.PlayList.Trace.END_OF_CONTENT_STOP_REASON =
    "end_of_content"),
  (MediaPlayer.vo.metrics.PlayList.Trace.METRICS_COLLECTION_STOP_REASON =
  ...
  (MediaPlayer.vo.protection.KeyMessage = function (a, b, c, d) {
    ...
    (this.sessionToken = a),
      (this.message = b),
      (this.defaultURL = c),
      (this.messageType = d ? d : "license-request");
  }),
  ...
  (MediaPlayer.vo.protection.KeySystemConfiguration = function (a, b, c, d, e) {
    (this.initDataTypes = ["cenc"]),
      (this.audioCapabilities = a),
      (this.videoCapabilities = b),
      (this.distinctiveIdentifier = c),
      (this.persistentState = d),
      (this.sessionTypes = e);
  }),
  ...
  (MediaPlayer.vo.protection.LicenseRequestComplete = function (a, b, c) {
    ...
    (this.message = a),
      (this.sessionToken = b),
      (this.messageType = c ? c : "license-request");
  }),
